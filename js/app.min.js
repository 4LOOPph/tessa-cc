...
!function(){"use strict";function e(e,t,r,a,o,i,n,c,s,l,u,p,d){function h(e){return o.map(e,function(e){if("location"==e.type){var t=e.label.replace(/[\s]/g,"");return{label:t.toLowerCase(),type:e.type,index:e.sortindex}}if("configuration"==e.type){var r=e.label.replace(/[\s]/g,"");return{label:r.toLowerCase(),type:e.type,index:e.sortindex}}return e})}function y(t,r,a,i){e.index=[];var n=[];return"Hardware"==e.prodTypeLabel?o.isEmpty(a)?t:o.isEmpty(t)?t:r>0?(o.each(a,function(e,r){return n=o.filter(t,function(t){return o.some(t.attributes,function(t){return t.value==e.value})}),a.splice(r,1),!1}),r-=1,y(n,r,a,i)):i:o.isEmpty(a)?t:o.isEmpty(t)&&!o.isEmpty(a)?t:r>0?(o.each(a,function(e,r){var i=o.filter(t,function(t){return t.hardware.some(function(t){return o.some(t.attributes,function(t){return t.value==e.value})})}),c=o.filter(t,function(t){return o.some(t.tags,{tags:e.label})});return o.isEmpty(i)?o.isEmpty(c)||(n=c):n=i,a.splice(r,1),!1}),r-=1,y(n,r,a,i)):i}function f(t,r){o.map(t,function(t,a){a==r?e.lam=o.uniqBy(t,function(e){return e.value}):"Orientation"==r?e.boleanorient=!0:e.boleanorient=!1})}e.prodTypeLabel=o.isEmpty(s.get("label"))?"Solution":JSON.parse(s.get("label")),e.solutionTypes=o.isEmpty(s.get("solutiontype"))?"EzeImpress":JSON.parse(s.get("solutiontype")),e.hardwareType=o.isEmpty(s.get("hardtype"))?"Screens":JSON.parse(s.get("hardtype")),e.filterhide=!1,e.datas=[],e.loadMore=function(){t.getProducts(0,10,function(t,r){200==r.statusCode&&r.response.success&&(e.datas=[],console.log("data:",r))})},e.loadMore(),e.count=0,e.txtSearch="",e.bundles=[],e.productDetails=[],e.seemore=!0,e.solutions=[],e.SolutionCategory=[],e.productscopy=[],e.ezewificopy=[],e.screens=[],e.Screens=[],e.ScreenSize=[],e.media=[],e.MediaPlayer=[],e.Mediacopy=[],e.bundleTags=[],e.searchcopy=[],e.filtercopy=[],e.pageNumber=1,e.limitWithPage=10,e.totalPages=0,e.typeselected=[],e.tagselected=[],e.productsAttributesValue=[],e.showdisplay=!0,e.location=[{_id:8,label:"Indoor",type:"location"},{_id:9,label:"Outdoor",type:"location"},{_id:10,label:"Semi Outdoor",type:"location"}],e.config=[{_id:11,label:"Wall Mounted",type:"configuration"},{_id:12,label:"Floor Mounted",type:"configuration"}],e.usages=[{_id:13,label:"24/7",type:"usages"},{_id:14,label:"16/7",type:"usages"}],e.orient=[{_id:15,label:"Landscape",type:"orientation"},{_id:16,label:"Portrait",type:"orientation"},{_id:17,label:"Custom",type:"orientation"}],e.loadmore=!1,e.showLoadMore=!1,e.dynamicPopover={vesa:"vesa.html",bezel:"bezel.html",usage:"usage.html",weight:"weight.html",mounting:"configuration.html",location:"location.html",dimensions:"dimensions.html",screensize:"screens.html",brightness:"brightness.html",screentype:"screentype.html",resolution:"resolution.html",orientation:"orientation.html",templateUrl7:"wifi.html",templateUrl8:"ram.html",orientation1:"ori.html",templateUrl9:"displaytechno.html",displaytechno:"displaytechno.html",displayinterface:"displayinterface.html",templateUrlStorage:"storage.html",templateUrlGraphics:"graphics.html",templateUrlResolution:"resolutions.html",cablelength:"cablelength.html",framerate:"framerate.html",opticalreso:"opticalreso.html",usbprotocol:"usbprotocol.html",usbspeed:"usbspeed.html"},e.sample={sam:"screens.html"},e.infiniteScrollData={},e.infiniteScrollData.numToAdd=10,e.infiniteScrollData.currentItems=10,e.resetInfScroll=function(){e.infiniteScrollData.currentItems=e.infiniteScrollData.numToAdd},e.addMoreItems=function(){e.infiniteScrollData.currentItems+=e.infiniteScrollData.numToAdd};var g=function(){async.waterfall([function(r){t.getProductBundle(function(t,i){if(200==i.statusCode&&i.response.success){var n=[],c=[];e.solutions=o.filter(i.response.result,function(e){if(1==e.is_published&&0==e.is_archived)return e}),c=o.flattenDeep(o.map(e.solutions,function(e){return void 0!=e.product_bundle_category[0]&&n.push(e.product_bundle_category[0]),e.products.length>0||(e.weekly=0),e.products})),e.bundlecategory=o.sortBy(n,"category_label"),o.each(c,function(e){e.product_detail&&(e.productType_id=e.product_detail.productType_id,e.sell_price=e.product_detail.sell_price,e.product_detail.product_category.length>0&&(e.category_id=e.product_detail.product_category[0].category_id,e.category_label=e.product_detail.product_category[0].category_label))});var s=o.groupBy(c,"pb_id");o.map(s,function(t,r){var i=a("filter")(t,{productType_id:18}),n=a("filter")(t,{productType_id:17}),c=a("filter")(t,{productType_id:20});if(parseInt(r)==parseInt(r)){if((n.length>0||i.length>0)&&(e.resulthardwaresum=o.sum(o.map(n,function(e){return e.sell_price*e.quantity})),e.softwaresum=o.sum(o.map(i,function(e){return e.sell_price*e.quantity}))),c.length>0){var s=a("filter")(c,{category_id:87}),l=a("filter")(c,{category_id:90});(s.length>0||l.length>0)&&(e.deploymentservice=o.sum(o.map(s,function(e){return e.sell_price*e.quantity})),e.supportservice=o.sum(o.map(l,function(e){return e.sell_price*e.quantity}))),e.servicesum=o.sum(o.map(c,function(e){return e.sell_price*e.quantity}))}void 0==e.deploymentservice&&void 0==e.supportservice?(e.deploymentservice=0,e.supportservice=0):(e.deploymentservice,e.supportservice);var u=e.deploymentservice+e.softwaresum+e.resulthardwaresum;e.weekly=12*(31.111*u/1e3+e.supportservice)/52}o.each(e.solutions,function(t){t.pb_id==parseInt(r)&&(t.weekly=e.weekly,t.software=i,t.hardware=n,t.support=l,t.upfront=u,t.spPrice=o.sum(o.map(l,function(e){return e.sell_price*e.quantity})))})}),o.each(e.solutions,function(e){e.product_bundle_category.length>0&&(e.category_label=e.product_bundle_category[0].category_label,e.category_id=e.product_bundle_category[0].category_id)}),r(null,e.solutions)}})},function(e,t){var r=[];o.each(e,function(e){o.each(e.hardware,function(e){r.push(e)})}),t(null,e,r)},function(e,r,a){var o=[];async.each(r,function(e,r){t.getProductAttribute(e.product_id,function(e,t){t?200==t.statusCode&&t.response.success&&(o.push(t.response.result),r()):r()})},function(t,i){a(null,e,r,o)})},function(t,r,a,i){var n=o.groupBy(a,"p_id");o.each(r,function(e){o.map(n,function(t,r){r&&o.each(t,function(t){if(t.attribute_values.length>0){var a=o.find(t.attribute_values,{is_comparable:1});o.isUndefined(a)&&r?parseInt(r)==e.product_id&&(e.comparable=0,e.attributes=t.attribute_values):parseInt(r)==e.product_id&&(e.comparable=1,e.attributes=t.attribute_values)}else parseInt(r)==e.product_id&&(e.comparable=0)})})});var c=o.groupBy(r,"pb_id");o.each(t,function(e){o.map(c,function(t,r){if(e.pb_id==r&&e.hardware){var a=o.filter(t,{comparable:1});a.length>0?e.comparable=1:e.comparable=0,e.hardware=t}})}),e.EzeImpress=t,e.productscopy=angular.copy(e.EzeImpress)}])},m=function(){async.waterfall([function(r){t.getProducts().then(function(t){if(200==t.statusCode&&t.response.success){e.allproducts=t.response.result,e.hardware=o.filter(e.allproducts,function(e){return"Hardware"===e.product_type}),e.hardwarecategory=[];var a=o.filter(e.hardware,function(e){if(1==e.is_published&&0==e.is_archived)return e});o.each(a,function(t){t.product_category.length>0&&e.hardwarecategory.push(t.product_category)}),e.hardwarecategory=o.flattenDeep(e.hardwarecategory),console.log("$scope.hardwarecategory:",e.hardwarecategory),r(null,a)}})},function(r,a){async.each(r,function(e,r){t.getProductAttribute(e.p_id,function(t,a){if(a){if(200==a.statusCode&&a.response.success&&e.p_id==a.response.result.p_id){var o=a.response.result.attribute_values;o&&o.length>0?e.attributes=a.response.result.attribute_values:e.attributes=[],r()}}else r()})},function(t,i){e.hardwares=r,e.hardwarecopy=angular.copy(e.hardwares),o.each(e.hardwares,function(e){var t=o.filter(e.attributes,{is_comparable:1});o.filter(e.attributes,{is_visible:1});t.length>0?e.comparable=1:e.comparable=0}),a(null,r,e.hardwares,a)})},function(t,r,a){var i=[];e.displayattrib=[],o.each(r,function(e){e.attributes.length>0&&i.push(e.attributes)}),e.allattributes=o.flattenDeep(i),o.each(e.allattributes,function(t){e.displayattrib.push(t.attribute),"Screen Size"==t.attribute&&e.displayattrib.unshift("Screen Size")}),e.displayattrib=o.uniqBy(e.displayattrib),e.displayattrib.length>5&&(e.limitnumber=Math.ceil(e.displayattrib.length/2))}])};e.repeatEnd=function(){e.showLoadMore=!0},e.toggleSelectedType=function(t){console.log("type:",t);var r=t,a=[];if("Hardware"==e.prodTypeLabel)e.tagselected.indexOf(r)==-1?e.tagselected.push(r):e.tagselected=o.filter(e.tagselected,function(e){return e._id!=r._id}),a=h(e.tagselected),!o.isEmpty(e.txtSearch)&&e.searchmedia?e.hardwares=y(e.searchmedia,a.length,a,e.searchmedia):e.hardwares=y(e.copy_hardware,a.length,a,e.copy_hardware),e.filterhardware=angular.copy(e.hardwares);else{console.log("DIRI");var i=[],n=[];if(o.each(e.productscopy,function(e){e.hardware?e.hardware.length>0&&o.each(e.hardware,function(e){i.push(e)}):e.hardware=[]}),o.each(e.copyscreen,function(e){o.isNull(e.attributes)||n.push(e.attributes)}),n=o.flattenDeep(n),e.ezehards=angular.copy(i),e.attrib=angular.copy(n),"Eze Impress"==e.solutionTypes){e.typeselected.indexOf(r)==-1?e.typeselected.push(r):e.typeselected=o.filter(e.typeselected,function(e){return e._id!=r._id}),o.map(e.productscopy,function(t){o.each(t.tags,function(t){o.isEmpty(t.tags)||e.bundleTags.push(t)})});e.typeselected.length;a=h(e.typeselected),o.each(e.EzeImpress,function(e){o.each(e.tags,function(e){e.tags=e.tags.replace(/[\[\](){}?*+\^$\\.|\-|\s]/g,"")})}),!o.isEmpty(e.txtSearch)&&e.searchcopy?e.EzeImpress=y(e.searchcopy,a.length,a,e.searchcopy):e.EzeImpress=y(e.solutionscopy,a.length,a,e.solutionscopy),e.filtercopy=angular.copy(e.EzeImpress)}}},e.refresh=function(){c.$broadcast("loading:progress"),l(function(){m(),g()},200),c.$broadcast("loading:finish")},e.uncheck=function(t,r){t.checked&&("Hardware"==e.prodTypeLabel?(o.each(e.tagselected,function(e){e._id==t._id&&(e.checked=!1)}),"MediaPlayer"==e.hardwareType?e.toggleSelectedType(t):e.toggleSelectedType(t)):(o.each(e.typeselected,function(e){e._id==t._id&&(e.checked=!1)}),e.toggleSelectedType(t)))},e.searchData=function(){if(c.$broadcast("loading:progress"),"Solution"==e.prodTypeLabel){l(function(){t(),c.$broadcast("loading:finish")},600);var t=function(){o.isEmpty(e.txtSearch)?o.isEmpty(e.filtercopy)?e.EzeImpress=e.solutionscopy:e.EzeImpress=e.filtercopy:(o.isEmpty(e.typeselected)?l(function(){console.log("$scope.solutionscopy;",e.solutionscopy),e.EzeImpress=a("filter")(e.solutionscopy,e.txtSearch),console.log("$scope.EzeImpress:",e.EzeImpress),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300):o.isEmpty(e.typeselected)||l(function(){e.EzeImpress=a("filter")(e.filtercopy,e.txtSearch),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300),e.searchcopy=angular.copy(e.EzeImpress))}}else{l(function(){t(),c.$broadcast("loading:finish")},600);var t=function(){o.isEmpty(e.txtSearch)?o.isEmpty(e.filterhardware)?(e.hardwares=e.copy_hardware,console.log("DIRI")):e.hardwares=e.filterhardware:o.isEmpty(e.tagselected)?l(function(){e.hardwares=a("filter")(e.copy_hardware,e.txtSearch),e.searchcopyhardware=angular.copy(e.hardwares),u.trackEvent("Category Search","search",e.txtSearch,e.hardwares.length)},300):o.isEmpty(e.tagselected)||l(function(){e.hardwares=a("filter")(e.filterhardware,e.txtSearch),e.searchcopyhardware=angular.copy(e.hardwares),u.trackEvent("Category Search","search",e.txtSearch,e.hardwares.length)},300)}}},e.showmore=function(){e.limitnumber=e.limitnumber+e.limitnumber,(e.limitnumber>=e.displayattrib.length||e.limitnumber>=e.hardwaredisplayatt.length)&&(e.showdisplay=!1)},e.showless=function(){e.limitnumber=Math.ceil(e.displayattrib.length/2),e.limitnumber=Math.ceil(e.hardwaredisplayatt.length/2),(e.limitnumber<=e.displayattrib.length||e.limitnumber>=e.hardwaredisplayatt.length)&&(e.showdisplay=!0)},e.clearfilter=function(){"Solution"==e.prodTypeLabel?(o.isEmpty(e.txtSearch)&&o.isEmpty(e.typeselected)||(e.txtSearch="",o.forEach(e.typeselected,function(e){e.checked=!1}),e.typeselected.splice(e.typeselected)),e.activateTab(e.solutionTypes)):o.isEmpty(e.txtSearch)&&o.isEmpty(e.tagselected)||(e.txtSearch="",o.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.activeHard(e.hardwareType))},e.$on("$stateChangeSuccess",function(t,r,a,o,i){"main.productCatalogue"==r.name&&e.refresh()}),e.activeProd=function(t){e.filterhide=!1,e.count++,e.prodTypeLabel=t,"Hardware"==t?(e.count>=1&&(e.hardwares=angular.copy(e.hardwarecopy)),o.isEmpty(e.txtSearch)&&o.isEmpty(e.typeselected)||(e.txtSearch="",o.forEach(e.typeselected,function(e){e.checked=!1}),e.typeselected.splice(e.typeselected),e.EzeImpress=e.productscopy),e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.hardwareType)):(console.log("Solution"),1==e.count?e.refresh():e.count>1&&(e.EzeImpress=angular.copy(e.productscopy)),o.isEmpty(e.txtSearch)&&o.isEmpty(e.tagselected)||(e.txtSearch="",o.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.hardwares=angular.copy(e.copy_hardware)),e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.solutionTypes)),s.set("label",JSON.stringify(e.prodTypeLabel))},e.activateTab=function(t){e.solutionTypes=t,"Eze Wifi"==t?e.filterhide=!1:e.filterhide=!0,console.log("name:",t),e.EzeImpress=o.filter(e.productscopy,function(e){return e.category_label==t}),e.solutionscopy=angular.copy(e.EzeImpress),e.attributegroup=o.groupBy(e.allattributes,"attribute"),o.forEach(e.attributegroup,function(e,t){});o.each(e.attributegroup,function(e,t){var r=o.filter(e,{is_visible:1});o.isEmpty(r)}),e.seemore=!0},e.activeHard=function(t){e.hardwaredisplayatt=[];var r=[];e.filterhide=!0,e.hardwareType=t,e.hardwares=o.filter(e.hardwarecopy,function(e){return o.some(e.product_category,function(e){return e.category_label==t})}),e.copy_hardware=angular.copy(e.hardwares),o.each(e.hardwares,function(e){e.attributes.length>0&&r.push(e.attributes)}),r=o.flattenDeep(r),o.each(r,function(t){e.hardwaredisplayatt.push(t.attribute),"Screen Size"==t.attribute&&e.hardwaredisplayatt.unshift("Screen Size")}),e.hardwaredisplayatt=o.uniqBy(e.hardwaredisplayatt),e.hardwaredisplayatt.length>5&&(e.limitnumber=Math.ceil(e.hardwaredisplayatt.length/2)),e.groupall=o.groupBy(e.allattributes,"attribute")},e.sams=function(t){"Solution"==e.prodTypeLabel?f(e.attributegroup,t):f(e.groupall,t)},e.solutionsEzeImpress=function(e){u.trackEvent("Productcatalogue","click","Solution",o.toString(e.pb_id))},e.solutionsEzeWifi=function(e){u.trackEvent("Productcatalogue","click","Solution",o.toString(e.pb_id))},e.hardwareScreens=function(e){u.trackEvent("Productcatalogue","click","Hardware",o.toString(e.p_id))},e.hardwareMediaplayer=function(e){u.trackEvent("Productcatalogue","click","Hardware",o.toString(e.p_id))},e.togglemodal=function(e){var t=i.open({animation:!0,templateUrl:"./views/share.modal.html",controller:"articleCtrl",size:"sm",resolve:{article:function(){return e}}});t.result.then(function(){n.reload()},function(){console.info("Modal dismissed")})}}angular.module("tessaApp").controller("productCtrl",e),e.$inject=["$scope","APIFactory","$location","$filter","_","$uibModal","$state","$rootScope","localStorageService","$timeout","$frontierAnalytics","$templateCache","serviceTest"]}();
