!function(){"use strict";angular.module("tessaApp",["ksSwiper","ui.router","restangular","ngSanitize","ui.bootstrap","ui.select","ngTouch","ngAnimate","angularjs-dropdown-multiselect","toastr","LocalStorageModule","angucomplete-alt","ngFrontier","angularMoment","ngDialog","angularSpinner","angular-loading-bar","angular.filter","textAngular","com.2fdevs.videogular","com.2fdevs.videogular.plugins.controls","com.2fdevs.videogular.plugins.overlayplay","com.2fdevs.videogular.plugins.poster","com.2fdevs.videogular.plugins.buffering","angular-jwt","infinite-scroll","io.dennis.contextmenu","bootstrapLightbox","angularTreeview","angularFileUpload","btford.socket-io","tessa-presentation","angular-carousel","angular-gestures","satellizer","ngFileUpload","swipe","ngclipboard","ngIOS9UIWebViewPatch","angularGrid","infinite-scroll","LocalForageModule"]).constant("ACCESSKEY","jeJMH2vWAQocOrat0bu1yqLJg1X0xdYZ").constant("API_URL","http://54.206.38.223:5002").constant("API_VERSION","/api/1.0/").constant("EXT_ID","abggimbnoanedfgibfmkilplcmehkfln")}();
!function(){"use strict";angular.module("tessaApp").run(["$location","APIFactory","$rootScope","$window","$state","localStorageService","$frontierAnalytics","usSpinnerService","AuthFactory","jwtHelper","API_URL","EXT_ID","toastr","$filter","$timeout","$localForage",function(e,t,n,s,r,i,a,c,o,u,l,d,p,g,f,m){n.count=1,n._=window._,window.API_URL=l,window.EXT_ID=d,n.compareproducts=[],n.allproducts=[],n.compareproducts=_.isEmpty(i.get("ProductsCompare"))?[]:JSON.parse(i.get("ProductsCompare")),a.debugMode(!1),a.allowPageTracking(!0),a.allowEventTracking(!0),a.allowViewTracking(!0),a.allowAppTracking(!0),a.allowDeviceTracking(!0),a.Initialize({accessCode:"958441082755103",trackerName:"project-tessa",encoding:"utf-8"});var h=function(){async.waterfall([function(e){t.getArticles({},function(t,n){var s=_.filter(n.response.result,function(e){return 1==e.is_active});_.each(s,function(e){e.type="Experience",e.name=e.title,e.id=e.article_id}),e(null,s)})},function(e,n){t.getProductBundleStatus("publish").then(function(t){200==t.statusCode&&t.response.success&&(_.each(t.response.result,function(e){e.type="Solutions"}),_.each(t.response.result,function(e){e.name=e.bundle_name,e.id=e.pb_id}),n(null,e,t.response.result))})},function(e,n,s){var r=[];t.getProductStatus("publish").then(function(t){200==t.statusCode&&t.response.success&&(r=_.filter(t.response.result,function(e){return"Hardware"==e.product_type}),_.each(r,function(e){e.type="Hardware"}),_.each(r,function(e){e.name=e.item_name,e.id=e.p_id}),s(null,e,n,r))})},function(e,n,s,r){async.each(s,function(e,n){t.getProductAttribute(e.p_id,function(t,s){if(200==s.statusCode&&s.response.success&&e.p_id==s.response.result.p_id){var r=s.response.result.attribute_values;r&&r.length>0?e.attributes=s.response.result.attribute_values:e.attributes=null,n()}})},function(t,i){r(null,e,n,s)})},function(e,t,s,r){var i=[];_.each(s,function(e){_.isNull(e.attributes)||i.push(e.attributes)}),i=_.flattenDeep(i),n.Brightness=g("filter")(i,{attribute:"Brightness"}),n.Bezel=g("filter")(i,{attribute:"Bezel Size"}),n.Usage=g("filter")(i,{attribute:"Usage"}),n.Brightness=_.uniqBy(n.Brightness,"value"),n.Bezel=_.uniqBy(n.Bezel,"value"),n.Usage=_.uniqBy(n.Usage,"value");var a=[];a.push(e),a.push(t),a.push(s),a=_.flattenDeep(a),n.allproducts=angular.copy(a),r(null,e,t,s,a),m.getItem("Articles").then(function(t){(_.isEmpty(t)||_.isUndefined(t))&&(console.log("DIRI"),m.setItem("Articles",e))}),m.getItem("Bundles").then(function(e){(_.isEmpty(e)||_.isUndefined(e))&&m.setItem("Bundles",t)}),m.getItem("Products").then(function(e){(_.isEmpty(e)||_.isUndefined(e))&&m.setItem("Products",s)})}])};if(o.getCurrentUser()){var y=JSON.parse(i.get("appuser"));a.setUserId(_.toString(y.uc_id))}n.$on("loading:progress",function(){c.spin("spinner-1")}),n.$on("loading:finish",function(){c.stop("spinner-1")}),n.$on("app:reload",function(){f(function(){s.location.reload()},1e3)}),n.goBack=function(){s.history.back()},o.getCurrentUser()&&h(),n.$on("$stateChangeStart",function(t,s,a,c,l){if(console.log("WALA PA:",s.name),n.compareIs=!0,_.isNull(o.getCurrentUser()))"login"!==s.name&&"forget-password"!==s.name&&"publicshare"!==s.name&&(n.requested=e.$$absUrl,t.preventDefault(),r.go("login"));else{var d=o.getUserToken();JSON.parse(i.get("appuser"));u.isTokenExpired(d)?o.logout().then(function(){e.path("/login")}):"login"==s.name&&(t.preventDefault(),r.go("main.experience"))}n.isHide=!1,n.toggleShow=function(){n.isHide=!n.isHide},n.width=Math.max(document.documentElement.clientWidth,window.innerWidth||0),n.height=Math.max(document.documentElement.clientHeight,window.innerHeight||0),n.hideNav=function(){n.isHide=!1},n.compare=function(e){console.log("items:",e);var t={},s=0;if(s=n.width<=500&&n.height<=975?2:n.width<=975&&n.height<=500?2:4,_.isEmpty(n.compareproducts))p.success("Successfully Added","Success"),n.compareIs=!1,n.compareproducts.push(e);else if(n.compareproducts.length>=1&&n.compareproducts.length<s){var r=_.filter(n.compareproducts,{_id:e._id});r.length>0?p.error("Oops. The selected item has already been added.","Warning"):(_.each(n.compareproducts,function(e,n){0==n&&(t=e)}),t.category_id==e.category_id?(p.success("Successfully Added","Success"),n.compareIs=!1,n.compareproducts.push(e)):p.error("Oops. The selected item is incomparable to the existing item(s).","Error"))}else p.error("Oops. You can not compare more than "+s+" items.","Error")}}),n.addToCart=function(e,t){if(console.log("type:",t),console.log("selectedItem:",e),"Solution"==t){if(a.trackEvent("Productcatalogue","click","addtocart",_.toString(e.pb_id)),0==e.upfront)p.error("Cannot add product when the values are 0","Error");else if(e.quantity=1,n.cartItems.length>=0){var s=_.filter(n.cartItems,{pb_id:e.pb_id});s.length>0?(s[0].quantity++,_.each(n.cartItems,function(e){e.pb_id==s[0].pb_id&&(e.quantity=s[0].quantity)}),p.success("Quantity Added","Success"),i.set("Cart",JSON.stringify(n.cartItems))):(p.success("Successfully Added","Success"),n.cartItems.push(e),i.set("Cart",JSON.stringify(n.cartItems)))}}else if("Hardware"==t&&(a.trackEvent("Productcatalogue","click","addtocart",_.toString(e.p_id)),e.upfront=e.sell_price,e.quantity=1,n.cartItems.length>=0)){var s=_.filter(n.cartItems,{p_id:e.p_id});s.length>0?(s[0].quantity++,_.each(n.cartItems,function(e){e.p_id==s[0].p_id&&(e.quantity=s[0].quantity)}),p.success("Quantity Added","Success"),i.set("Cart",JSON.stringify(n.cartItems))):(p.success("Successfully Added","Success"),n.cartItems.push(e),i.set("Cart",JSON.stringify(n.cartItems)))}},n.$on("$stateChangeSuccess",function(e,t,s,r,i){n.appuser=JSON.parse(o.getCurrentUser("appuser")),"login"==r.name&&"main.experience"==t.name?h():"main.search"==t.name,n.currentUser=o.getCurrentUser(),n.label="Solutions",a.trackPage(t.name,t.url,t.templateUrl)})}])}();
...
!function(){"use strict";function e(e,t,r,a,i,o,n,s,c,l,u,p,d,h){function y(e){return i.map(e,function(e){if("location"==e.type){var t=e.label.replace(/[\s]/g,"");return{label:t.toLowerCase(),type:e.type,index:e.sortindex}}if("configuration"==e.type){var r=e.label.replace(/[\s]/g,"");return{label:r.toLowerCase(),type:e.type,index:e.sortindex}}return e})}function f(t,r,a,o){e.index=[];var n=[];return"Hardware"==e.prodTypeLabel?i.isEmpty(a)?t:i.isEmpty(t)?t:r>0?(i.each(a,function(e,r){return n=i.filter(t,function(t){return i.some(t.attributes,function(t){return t.value==e.value})}),a.splice(r,1),!1}),r-=1,f(n,r,a,o)):o:i.isEmpty(a)?t:i.isEmpty(t)&&!i.isEmpty(a)?t:r>0?(i.each(a,function(e,r){var o=i.filter(t,function(t){return t.hardware.some(function(t){return i.some(t.attributes,function(t){return t.value==e.value})})}),s=i.filter(t,function(t){return i.some(t.tags,{tags:e.label})});return i.isEmpty(o)?i.isEmpty(s)||(n=s):n=o,a.splice(r,1),!1}),r-=1,f(n,r,a,o)):o}function m(t,r){i.map(t,function(t,a){a==r&&(e.lam=i.uniqBy(t,function(e){return e.value}))})}e.prodTypeLabel=i.isEmpty(c.get("label"))?"Solution":JSON.parse(c.get("label")),e.solutionTypes=i.isEmpty(c.get("solutiontype"))?"Eze Impress":JSON.parse(c.get("solutiontype")),e.hardwareType=i.isEmpty(c.get("hardtype"))?"Screen":JSON.parse(c.get("hardtype")),e.filterhide=!1,e.datas=[],e.loadMore=function(){t.getProducts(0,10,function(t,r){200==r.statusCode&&r.response.success&&(e.datas=[])})},e.loadMore(),e.count=0,e.txtSearch="",e.bundles=[],e.productDetails=[],e.seemore=!0,e.solutions=[],e.SolutionCategory=[],e.productscopy=[],e.ezewificopy=[],e.screens=[],e.Screens=[],e.ScreenSize=[],e.media=[],e.MediaPlayer=[],e.Mediacopy=[],e.bundleTags=[],e.searchcopy=[],e.filtercopy=[],e.pageNumber=1,e.limitWithPage=10,e.totalPages=0,e.typeselected=[],e.tagselected=[],e.productsAttributesValue=[],e.showdisplay=!0,e.location=[{_id:8,label:"Indoor",type:"location"},{_id:9,label:"Outdoor",type:"location"},{_id:10,label:"Semi Outdoor",type:"location"}],e.config=[{_id:11,label:"Wall Mounted",type:"configuration"},{_id:12,label:"Floor Mounted",type:"configuration"}],e.usages=[{_id:13,label:"24/7",type:"usages"},{_id:14,label:"16/7",type:"usages"}],e.orient=[{_id:15,label:"Landscape",type:"orientation"},{_id:16,label:"Portrait",type:"orientation"},{_id:17,label:"Custom",type:"orientation"}],e.loadmore=!1,e.showLoadMore=!1,e.dynamicPopover={vesa:"vesa.html",bezel:"bezel.html",usage:"usage.html",weight:"weight.html",mounting:"configuration.html",location:"location.html",dimensions:"dimensions.html",screensize:"screens.html",brightness:"brightness.html",screentype:"screentype.html",resolution:"resolution.html",orientation:"orientation.html",templateUrl7:"wifi.html",templateUrl8:"ram.html",orientation1:"ori.html",templateUrl9:"displaytechno.html",displaytechno:"displaytechno.html",displayinterface:"displayinterface.html",templateUrlStorage:"storage.html",templateUrlGraphics:"graphics.html",templateUrlResolution:"resolutions.html",cablelength:"cablelength.html",framerate:"framerate.html",opticalreso:"opticalreso.html",usbprotocol:"usbprotocol.html",usbspeed:"usbspeed.html"},e.sample={sam:"screens.html"},e.infiniteScrollData={},e.infiniteScrollData.numToAdd=10,e.infiniteScrollData.currentItems=10,e.resetInfScroll=function(){e.infiniteScrollData.currentItems=e.infiniteScrollData.numToAdd},e.addMoreItems=function(){e.infiniteScrollData.currentItems+=e.infiniteScrollData.numToAdd};var g=function(){async.waterfall([function(r){t.getProductBundleStatus("publish").then(function(t){if(200==t.statusCode&&t.response.success){var o=[],n=[];e.solutions=i.filter(t.response.result,function(e){return e}),n=i.flattenDeep(i.map(e.solutions,function(e){return void 0!=e.product_bundle_category[0]&&o.push(e.product_bundle_category[0]),e.products.length>0||(e.weekly=0),e.products})),e.bundlecategory=i.sortBy(o,"category_label"),i.each(n,function(e){e.product_detail&&(e.productType_id=e.product_detail.productType_id,e.sell_price=e.product_detail.sell_price,e.product_detail.product_category.length>0&&(e.category_id=e.product_detail.product_category[0].category_id,e.category_label=e.product_detail.product_category[0].category_label))});var s=i.groupBy(n,"pb_id");i.map(s,function(t,r){var o=a("filter")(t,{productType_id:18}),n=a("filter")(t,{productType_id:17}),s=a("filter")(t,{productType_id:20});if(parseInt(r)==parseInt(r)){if((n.length>0||o.length>0)&&(e.resulthardwaresum=i.sum(i.map(n,function(e){return e.sell_price*e.quantity})),e.softwaresum=i.sum(i.map(o,function(e){return e.sell_price*e.quantity}))),s.length>0){var c=a("filter")(s,{category_id:87}),l=a("filter")(s,{category_id:90});(c.length>0||l.length>0)&&(e.deploymentservice=i.sum(i.map(c,function(e){return e.sell_price*e.quantity})),e.supportservice=i.sum(i.map(l,function(e){return e.sell_price*e.quantity}))),e.servicesum=i.sum(i.map(s,function(e){return e.sell_price*e.quantity}))}void 0==e.deploymentservice&&void 0==e.supportservice?(e.deploymentservice=0,e.supportservice=0):(e.deploymentservice,e.supportservice);var u=e.deploymentservice+e.softwaresum+e.resulthardwaresum;e.weekly=12*(31.111*u/1e3+e.supportservice)/52}i.each(e.solutions,function(t){t.pb_id==parseInt(r)&&(t.weekly=e.weekly,t.software=o,t.hardware=n,t.support=l,t.upfront=u,t.spPrice=i.sum(i.map(l,function(e){return e.sell_price*e.quantity})))})}),i.each(e.solutions,function(e){e.product_bundle_category.length>0&&(e.category_label=e.product_bundle_category[0].category_label,e.category_id=e.product_bundle_category[0].category_id)}),r(null,e.solutions)}})},function(e,t){var r=[];i.each(e,function(e){i.each(e.hardware,function(e){r.push(e)})}),t(null,e,r)},function(e,r,a){var i=[];async.each(r,function(e,r){t.getProductAttribute(e.product_id,function(e,t){t?200==t.statusCode&&t.response.success&&(i.push(t.response.result),r()):r()})},function(t,o){a(null,e,r,i)})},function(t,r,a,o){var n=i.groupBy(a,"p_id");i.each(r,function(e){i.map(n,function(t,r){r&&i.each(t,function(t){if(t.attribute_values.length>0){var a=i.find(t.attribute_values,{is_comparable:1});i.isUndefined(a)&&r?parseInt(r)==e.product_id&&(e.comparable=0,e.attributes=t.attribute_values):parseInt(r)==e.product_id&&(e.comparable=1,e.attributes=t.attribute_values)}else parseInt(r)==e.product_id&&(e.comparable=0,e.attributes=[])})})});var s=i.groupBy(r,"pb_id");i.each(t,function(e){i.map(s,function(t,r){if(e.pb_id==r&&e.hardware){var a=i.filter(t,{comparable:1});a.length>0?e.comparable=1:e.comparable=0,e.hardware=t}})}),e.EzeImpress=t,console.log("$scope.EzeImpress:",e.EzeImpress),e.productscopy=angular.copy(e.EzeImpress),i.isEmpty(e.solutionTypes)||l(function(){e.$apply(function(){e.activateTab(e.solutionTypes)})},500)}])},b=function(){async.waterfall([function(r){t.getProducts().then(function(t){if(200==t.statusCode&&t.response.success){e.allproducts=t.response.result,e.hardware=i.filter(e.allproducts,function(e){return"Hardware"===e.product_type}),e.hardwarecategory=[];var a=i.filter(e.hardware,function(e){if(1==e.is_published&&0==e.is_archived)return e});i.each(a,function(t){t.product_category.length>0&&e.hardwarecategory.push(t.product_category)}),e.hardwarecategory=i.flattenDeep(e.hardwarecategory),r(null,a)}})},function(e,r){async.each(e,function(e,r){t.getProductAttribute(e.p_id,function(t,a){if(a){if(200==a.statusCode&&a.response.success&&e.p_id==a.response.result.p_id){var i=a.response.result.attribute_values;i&&i.length>0?e.attributes=a.response.result.attribute_values:e.attributes=[],r()}}else r()})},function(t,a){i.each(e,function(e){var t=i.filter(e.attributes,{is_comparable:1});i.filter(e.attributes,{is_visible:1});t.length>0?e.comparable=1:e.comparable=0}),r(null,e,r)})},function(t,r){e.hardwares=t,e.hardwarecopy=angular.copy(e.hardwares);var a=[];e.displayattrib=[],i.each(t,function(e){e.attributes.length>0&&a.push(e.attributes)}),e.allattributes=i.flattenDeep(a),i.each(e.allattributes,function(t){e.displayattrib.push(t.attribute),"Screen Size"==t.attribute&&e.displayattrib.unshift("Screen Size")}),e.displayattrib=i.uniqBy(e.displayattrib),e.displayattrib.length>5&&(e.limitnumbers=Math.ceil(e.displayattrib.length/2)),i.isEmpty(e.hardwareType)||e.activeHard(e.hardwareType)}])};e.repeatEnd=function(){e.showLoadMore=!0},e.toggleSelectedType=function(t){var r=t,a=[];if("Hardware"==e.prodTypeLabel)e.tagselected.indexOf(r)==-1?e.tagselected.push(r):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=r._id}),a=y(e.tagselected),!i.isEmpty(e.txtSearch)&&e.searchmedia?e.hardwares=f(e.searchmedia,a.length,a,e.searchmedia):e.hardwares=f(e.copy_hardware,a.length,a,e.copy_hardware),e.filterhardware=angular.copy(e.hardwares);else{var o=[],n=[];if(i.each(e.productscopy,function(e){e.hardware?e.hardware.length>0&&i.each(e.hardware,function(e){o.push(e)}):e.hardware=[]}),i.each(e.copyscreen,function(e){i.isNull(e.attributes)||n.push(e.attributes)}),n=i.flattenDeep(n),e.ezehards=angular.copy(o),e.attrib=angular.copy(n),"Eze Impress"==e.solutionTypes){e.typeselected.indexOf(r)==-1?e.typeselected.push(r):e.typeselected=i.filter(e.typeselected,function(e){return e._id!=r._id}),i.map(e.productscopy,function(t){i.each(t.tags,function(t){i.isEmpty(t.tags)||e.bundleTags.push(t)})});e.typeselected.length;a=y(e.typeselected),i.each(e.EzeImpress,function(e){i.each(e.tags,function(e){e.tags=e.tags.replace(/[\[\](){}?*+\^$\\.|\-|\s]/g,"")})}),!i.isEmpty(e.txtSearch)&&e.searchcopy?e.EzeImpress=f(e.searchcopy,a.length,a,e.searchcopy):e.EzeImpress=f(e.solutionscopy,a.length,a,e.solutionscopy),e.filtercopy=angular.copy(e.EzeImpress)}}},e.refresh=function(){s.$broadcast("loading:progress"),l(function(){b(),g()},200),s.$broadcast("loading:finish")},e.uncheck=function(t,r){t.checked&&("Hardware"==e.prodTypeLabel?(i.each(e.tagselected,function(e){e._id==t._id&&(e.checked=!1)}),"MediaPlayer"==e.hardwareType?e.toggleSelectedType(t):e.toggleSelectedType(t)):(i.each(e.typeselected,function(e){e._id==t._id&&(e.checked=!1)}),e.toggleSelectedType(t)))},e.searchData=function(){if(s.$broadcast("loading:progress"),"Solution"==e.prodTypeLabel){l(function(){t(),s.$broadcast("loading:finish")},600);var t=function(){i.isEmpty(e.txtSearch)?i.isEmpty(e.filtercopy)?e.EzeImpress=e.solutionscopy:e.EzeImpress=e.filtercopy:(i.isEmpty(e.typeselected)?l(function(){e.EzeImpress=a("filter")(e.solutionscopy,e.txtSearch),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300):i.isEmpty(e.typeselected)||l(function(){e.EzeImpress=a("filter")(e.filtercopy,e.txtSearch),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300),e.searchcopy=angular.copy(e.EzeImpress))}}else{l(function(){t(),s.$broadcast("loading:finish")},600);var t=function(){i.isEmpty(e.txtSearch)?i.isEmpty(e.filterhardware)?e.hardwares=e.copy_hardware:e.hardwares=e.filterhardware:i.isEmpty(e.tagselected)?l(function(){e.hardwares=a("filter")(e.copy_hardware,e.txtSearch),e.searchcopyhardware=angular.copy(e.hardwares),u.trackEvent("Category Search","search",e.txtSearch,e.hardwares.length)},300):i.isEmpty(e.tagselected)||l(function(){e.hardwares=a("filter")(e.filterhardware,e.txtSearch),e.searchcopyhardware=angular.copy(e.hardwares),u.trackEvent("Category Search","search",e.txtSearch,e.hardwares.length)},300)}}},e.showmore=function(){"Solution"==e.prodTypeLabel?e.limitnumbers=e.limitnumbers+e.limitnumbers:e.limitnumber=e.limitnumber+e.limitnumber,(e.limitnumbers>=e.displayattrib.length||e.limitnumber>=e.hardwaredisplayatt.length)&&(e.showdisplay=!1)},e.showless=function(){"Solution"==e.prodTypeLabel?e.limitnumbers=Math.ceil(e.displayattrib.length/2):e.limitnumber=Math.ceil(e.hardwaredisplayatt.length/2),(e.limitnumbers<=e.displayattrib.length||e.limitnumber>=e.hardwaredisplayatt.length)&&(e.showdisplay=!0)},e.clearfilter=function(){"Solution"==e.prodTypeLabel?(i.isEmpty(e.txtSearch)&&i.isEmpty(e.typeselected)||(e.txtSearch="",i.forEach(e.typeselected,function(e){e.checked=!1}),e.typeselected.splice(e.typeselected)),e.EzeImpress=angular.copy(e.solutionscopy),e.filtercopy=[]):i.isEmpty(e.txtSearch)&&i.isEmpty(e.tagselected)||(e.txtSearch="",i.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.hardwares=angular.copy(e.copy_hardware),e.filterhardware=[])},e.$on("$stateChangeSuccess",function(t,r,a,i,o){"main.productCatalogue"==r.name&&e.refresh()}),e.activeProd=function(t){e.showdisplay=!0,e.filtercopy=[],e.filterhide=!1,e.count++,e.prodTypeLabel=t,"Hardware"==t?(e.count>=1&&(e.hardwares=angular.copy(e.hardwarecopy)),i.isEmpty(e.txtSearch)&&i.isEmpty(e.typeselected)||(e.txtSearch="",i.forEach(e.typeselected,function(e){e.checked=!1}),e.typeselected.splice(e.typeselected),e.EzeImpress=e.solutionscopy),e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.hardwareType),i.isEmpty(e.hardwareType)||e.activeHard(e.hardwareType)):(e.limitnumbers=Math.ceil(e.displayattrib.length/2),1==e.count?e.refresh():e.count>1&&(e.EzeImpress=angular.copy(e.solutionscopy)),i.isEmpty(e.txtSearch)&&i.isEmpty(e.tagselected)||(e.txtSearch="",i.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.hardwares=angular.copy(e.copy_hardware)),i.isEmpty(e.solutionTypes)||e.activateTab(e.solutionTypes),e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.solutionTypes)),c.set("label",JSON.stringify(e.prodTypeLabel))},e.activateTab=function(t){e.clearfilter(),e.solutionTypes=t,"Eze Wifi"==t?e.filterhide=!1:e.filterhide=!0,e.EzeImpress=i.filter(e.productscopy,function(e){return e.category_label==t}),e.solutionscopy=angular.copy(e.EzeImpress),e.attributegroup=i.groupBy(e.allattributes,"attribute"),i.forEach(e.attributegroup,function(e,t){});i.each(e.attributegroup,function(e,t){var r=i.filter(e,{is_visible:1});i.isEmpty(r)}),e.seemore=!0},e.activeHard=function(t){e.clearfilter(),e.hardwaredisplayatt=[];var r=[];e.filterhide=!0,e.hardwareType=t,e.hardwares=i.filter(e.hardwarecopy,function(e){return i.some(e.product_category,function(e){return e.category_label==t})}),e.copy_hardware=angular.copy(e.hardwares),i.each(e.hardwares,function(e){e.attributes.length>0&&r.push(e.attributes)}),r=i.flattenDeep(r),i.each(r,function(t){e.hardwaredisplayatt.push(t.attribute),"Screen Size"==t.attribute&&e.hardwaredisplayatt.unshift("Screen Size")}),e.hardwaredisplayatt=i.uniqBy(e.hardwaredisplayatt),e.hardwaredisplayatt.length>5&&(e.limitnumber=Math.ceil(e.hardwaredisplayatt.length/2)),e.groupall=i.groupBy(e.allattributes,"attribute")},e.solutionCount=function(e){return function(t){return i.some(t.hardware,function(t){return t.attributes.some(function(t){return t.value==e})})}},e.hardwareCount=function(e){return function(t){return i.some(t.attributes,function(t){return t.value==e})}},e.sams=function(t){"Solution"==e.prodTypeLabel?m(e.attributegroup,t):m(e.groupall,t)},e.solutionsEzeImpress=function(e){u.trackEvent("Productcatalogue","click","Solution",i.toString(e.pb_id))},e.solutionsEzeWifi=function(e){u.trackEvent("Productcatalogue","click","Solution",i.toString(e.pb_id))},e.hardwareScreens=function(e){u.trackEvent("Productcatalogue","click","Hardware",i.toString(e.p_id))},e.hardwareMediaplayer=function(e){u.trackEvent("Productcatalogue","click","Hardware",i.toString(e.p_id))},e.togglemodal=function(e){var t=o.open({animation:!0,templateUrl:"./views/share.modal.html",controller:"articleCtrl",size:"sm",resolve:{article:function(){return e}}});t.result.then(function(){n.reload()},function(){console.info("Modal dismissed")})}}angular.module("tessaApp").controller("productCtrl",e),e.$inject=["$scope","APIFactory","$location","$filter","_","$uibModal","$state","$rootScope","localStorageService","$timeout","$frontierAnalytics","$templateCache","serviceTest","$localForage"]}();
!function(){"use strict";function e(e,t,r,o,a,s,c,i,d,l,n,u,p){e.slides=[],e.allproduct=[],e.hardware_category=[],e.service_category=[],e.hardwarecategories=[],e.servicecategories=[],e.service=[],e.hardwares=[],e.softwares=[],e.relatedProductHardware=[],e.relatedProductSoftware=[],e.alltags=[],e.cproducts=[],e.cproducts.titles=[],e.cproducts.images=[],e.cproducts.softwares=[],e.cproducts.hardwares=[],e.cproducts.ids=[],e.cproducts.supports=[],e.cproducts.prices=[],o.selected_id&&async.waterfall([function(r){t.getProduct(function(t,o){200==o.statusCode&&o.response.success&&(e.allproduct=o.response.result,r(null,o.response.result))})},function(r,o){t.getCategory(function(t,a){200==a.statusCode&&a.response.success&&(e.allcategory=a.response.result,o(null,r,a.response.result))})},function(e,r,a){t.getBundleTag(o.selected_id,function(t){200==t.statusCode&&t.response.success&&a(null,e,r,t.response.result)})},function(r,i,d,n){var d=d;t.getDetailSolution(o.selected_id,function(t,o){if(200==o.statusCode&&o.response.success){var u=0;e.details=o.response.result,(e.details.product_images.length>0||e.details.product_bundle_category.length>0)&&(s.each(e.details.product_images,function(t){e.slides.push({image:t.image_path,index:u}),u++}),e.details.category_id=e.details.product_bundle_category[0].category_id,e.details.category_label=e.details.product_bundle_category[0].category_label),c.compareproducts.length>0&&s.each(c.compareproducts,function(t){t.pb_id==e.details.pb_id&&(c.compareIs=!1)}),e.products=e.details.products,s.isNull(e.products)&&(e.details.upfront=0),s.map(e.products,function(e){e.product_detail&&(e.productType_id=e.product_detail.productType_id,e.product_category=e.product_detail.product_category,e.sell_price=e.product_detail.sell_price,e.category_id=e.product_detail.product_category[0].category_id,e.item_name=e.product_detail.item_name,e.category_label=e.product_detail.product_category[0].category_label)}),e.services=a("filter")(e.products,{productType_id:20}),e.hardware=a("filter")(e.products,{productType_id:17});var f=a("filter")(e.products,{productType_id:18});if(e.softwarePrice=s.map(f,function(e){return e.sell_price*e.quantity}),s.isNull(f)||(s.map(f,function(t){void 0!=t.product_category[0]&&e.softwares.push(t.product_category[0])}),s.each(f,function(t){s.each(e.softwares,function(e){t.product_id==e.product_id&&(t.category_label=e.category_label)})})),s.isNull(e.hardware)||(s.map(e.hardware,function(t){void 0!=t.product_category[0]&&e.hardwares.push(t.product_category[0])}),s.each(e.hardware,function(t){s.find(e.hardwares,function(e){t.p_id==e.product_id&&(t.category_label=e.category_label)})})),!s.isNull(e.services)){s.map(e.services,function(t){void 0!==t.product_category[0]&&e.service.push(t.product_category[0])}),s.each(e.services,function(t){s.find(e.service,function(e){t.p_id==e.product_id&&(t.category_id=e.category_id)})});var _=a("filter")(e.services,{category_id:87}),g=a("filter")(e.services,{category_id:90});e.hardwarePrice=s.map(e.hardware,function(e){return e.sell_price*e.quantity}),e.deploymentPrice=s.map(_,function(e){return e.sell_price*e.quantity}),e.upfront=s.sum(e.deploymentPrice)+s.sum(e.hardwarePrice)+s.sum(e.softwarePrice),e.weekly=31.111*e.upfront/1e3*12/52,e.supportPrice=s.map(g,function(e){return e.sell_price*e.quantity});var y=s.filter(e.hardware,function(e){return e.product_category.length>=1});p(function(){e.$apply(function(){e.hardwareCategory=y,e.deployment=_,e.support=g})},100),console.log("$scope.hardwareCategory;",e.hardwareCategory),e.spPrice=s.sum(e.supportPrice),e.details.software=f,e.details.hardware=y,e.details.support=g,e.details.upfront=e.upfront,e.details.weekly=e.weekly,e.details.tags=d,e.details.spPrice=e.spPrice,n(null,r,i,e.details)}p(function(){e.$apply(function(){e.software=f})},100)}else l.error(o.response.msg,"Error")})},function(r,a,c,i){t.getRelatedSolutions(o.selected_id,function(t,o){if(200==o.statusCode&&o.response.success){var d=o.response.result;i(null,r,a,c,o.response.result),s.each(d,function(t){"Hardware"==t.ref_product.product_type&&e.relatedProductHardware.push(t),"Software"==t.ref_product.product_type&&e.relatedProductSoftware.push(t)})}else l.error(o.response.msg,"Error")})},function(r,o,a,s,c){a.software&&async.each(a.software,function(e,r){t.getProductAttribute(e.product_id,function(t,o){o?200==o.statusCode&&o.response.success&&(e.attribute=o.response.result,o.response.result.attribute_values.length>0?e.comparable=1:e.comparable=0,r()):r()})},function(t){e.details=a,c(null,r,o,a,s,e.details,c)})},function(r,o,a,c,i,d){i.hardware&&async.each(a.hardware,function(e,r){t.getProductAttribute(e.product_id,function(t,o){if(o){if(200==o.statusCode&&o.response.success){e.attribute=o.response.result;var a=s.filter(o.response.result.attribute_values,{is_comparable:1});a.length>0?e.comparable=1:e.comparable=0,r()}}else r()})},function(t){var r=[],o=[];e.details=i,r.push(e.details.software),r.push(e.details.hardware),r=s.flattenDeep(r),o=s.find(r,{comparable:1}),s.isEmpty(o)&&s.isUndefined(o)?e.details.iscomparable=0:e.details.is_comparable=1,console.log("$scope.details;",e.details)})}]),e.openProductModal=function(t){var r=i.open({animation:!0,templateUrl:"./views/productCatalogue.modal.html",size:"md",controller:"detailControl",windowClass:"xd-modal",backdropClass:"modal-backdrop fade in",resolve:{product:function(){return t}}});r.result.then(function(t){e.selected=t})},e.next=function(){},e.openShareModal=function(){if(o.selected_id){var t=i.open({animation:!0,templateUrl:"./views/share.modal.html",size:"md",windowClass:"share-modal",controller:"ShareModalInstanceCtrl",resolve:{article:function(){return{bundle_name:e.details.bundle_name,product_images:e.details.product_images,bundle_description:e.details.bundle_description,products:e.details.products,upfront:e.upfront.toFixed(2),spPrice:e.spPrice.toFixed(2),opex:(36*e.upfront/1e3).toFixed(2),weekly:e.weekly.toFixed(2)}},param:function(){return"bundle"}}});t.result.then(function(){},function(){console.info("Modal dismissed at: "+new Date)})}}}function t(e,t,r){e.selected=r,e.cancel=function(){t.dismiss("cancel")}}angular.module("tessaApp").controller("detailSolutionCtrl",e).controller("detailControl",t),e.$inject=["$scope","APIFactory","$location","$stateParams","$filter","_","$rootScope","$uibModal","localStorageService","toastr","$state","$frontierAnalytics","$timeout"],t.$inject=["$scope","$uibModalInstance","product"]}();
...
!function(){"use strict";function e(e,t,r,n,o,u,a,i,c,s){return{authenticateAccount:function(e){return u.all("session").customPOST(e).then(function(e){return e},function(e){return e.data})},setUserToken:function(e){a.set("token",e)},getUserToken:function(){return a.get("token")},setCurrentUser:function(e){a.set("appuser",JSON.stringify(e))},getCurrentUser:function(){return a.get("appuser")},logout:function(){return u.all("session").customDELETE().then(function(e){return a.remove("Cart"),a.remove("label"),a.remove("hardtype"),a.remove("Payment"),a.remove("token"),a.remove("appuser"),a.remove("articlefilter"),s.removeItem("Articles"),s.removeItem("Bundles"),s.removeItem("Products"),t.$broadcast("app:reload"),c.signOut(),e},function(e){return e.data})},forgotPassword:function(e){return u.all("forgot_password").customPOST(e).then(function(e){return e},function(e){return e})},resendVerification:function(e){return u.all("resend_verification").customPOST(e).then(function(e){return e},function(e){return e})},isVerifiedContact:function(e){return u.all("users/"+e+"/verify").customGET().then(function(e){return e},function(e){return e})},verifyContact:function(e){return u.all("users/"+e+"/verify").customPOST().then(function(e){return e},function(e){return e})}}}function t(e,t,r,n,o,u,a){return{request:function(e){if(e.headers=e.headers||{},e.headers.accesskey=o,u.get("token")){var t=u.get("token");JSON.parse(u.get("user"));e.headers.Authorization="Bearer "+t}return e},response:function(e){if(u.get("token")){var t=u.get("token");a.isTokenExpired(t)&&(u.remove("Cart"),u.remove("label"),u.remove("hardtype"),u.remove("Payment"),u.remove("token"),u.remove("appuser"),r.path("/login"))}return e},responseError:function(t){return 401===t.status&&(e.$broadcast("unauthorized"),r.path("/login")),t}}}function r(e,t){var r=0;return{request:function(n){return 1===++r&&t.$broadcast("loading:progress"),n||e.when(n)},response:function(n){return 0===--r&&t.$broadcast("loading:finish"),n||e.when(n)},responseError:function(n){return 0===--r&&t.$broadcast("loading:finish"),e.reject(n)}}}angular.module("tessaApp").factory("authInterceptor",t).factory("AuthFactory",e).factory("httpInterceptor",r),t.$inject=["$rootScope","$q","$location","$injector","ACCESSKEY","localStorageService","jwtHelper"],e.$inject=["$http","$rootScope","_","API_URL","API_VERSION","Restangular","localStorageService","$q","$frontierAnalytics","$localForage"],r.$inject=["$q","$rootScope"]}();
