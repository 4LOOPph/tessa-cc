...
!function(){"use strict";function s(s,e,t,l,o,a){s.checkvalid2="Company Details",s.details={},s.navClass="big",s.lastScrollTop=0,s.direction="",s.tab=1,s.contactInfo=!1,s.ezefind=!1,s.ezeimpress=!1,s.proposalType=!1,s.secOthers=!1,s.others=!1,s.showDesign=!1,s.showPrototype=!1,s.design=!1,s.prototype=!1,s.others=!1,s.softwareImpress=!1,s.sdImpress=!1,s.stImpress=!1,s.stCustom=!1,s.siteInstall=!1,s.ptImpress=!1,s.spImpress=!1,s.spFind=!1,s.connectivity=!1,s.content=!1,s.renders=!1,s.graphic=!1,s.solcat=!1,s.visual=!1,s.emailtemplate=!1,s.$watch("companyForm.$valid",function(e,t){console.log("newVal:",e),s.checkValid=e}),s.setTab=function(e){var t=angular.element(document.getElementsByClassName("wiz-cnt")),l=angular.element(document.getElementsByClassName("wiz-cnt"));s.tab=e,t.scrollTo(l,0,1e3),s.testclass="blackbg"},s.isSet=function(e){return s.tab===e},s.showProposalType=function(){s.proposalType=!0},s.setForm=function(e){console.log("value:",e),s.myform=angular.copy(e)},s.$watch("myform",function(e){console.log("newVal:",e),s.sample=e}),s.activeOption=function(){s.isActiveOption=value,"Hardware"==value},s.scrollTo=function(s){l.hash(s),t()},s.getValue=function(e){console.log(e),s.value=e},s.addRequest=function(e){console.log(e),"ezeimpress"==e?(s.ezeimpress=!0,s.testclass="blackbg",s.ezefind=!1,s.design=!1,s.others=!1,s.prototype=!1):"ezefind"==e?(s.ezeimpress=!1,s.ezefind=!0,s.testclass="blackbg",s.design=!1,s.others=!1,s.prototype=!1):"prototype"==e?(s.ezeimpress=!1,s.ezefind=!1,s.design=!1,s.others=!1,s.prototype=!0,s.testclass="blackbg"):"design"==e?(s.ezeimpress=!1,s.ezefind=!1,s.design=!0,s.others=!1,s.prototype=!1,s.testclass="blackbg"):"others"==e?(s.ezeimpress=!1,s.ezefind=!1,s.design=!1,s.others=!0,s.prototype=!1,s.testclass="blackbg"):"renders"==e?(s.renders=!0,s.graphics=!1,s.visual=!1,s.solcat=!1,s.emailtemplate=!1,s.testclass="blackbg"):"graphics"==e?(s.renders=!1,s.graphics=!0,s.visual=!1,s.solcat=!1,s.emailtemplate=!1,s.testclass="blackbg"):"solcat"==e?(s.renders=!1,s.graphics=!1,s.visual=!1,s.solcat=!0,s.emailtemplate=!1,s.testclass="blackbg"):"visual"==e?(s.renders=!1,s.graphics=!1,s.visual=!0,s.solcat=!1,s.emailtemplate=!1,s.testclass="blackbg"):"email"==e?(s.renders=!1,s.graphics=!1,s.visual=!1,s.solcat=!1,s.emailtemplate=!0,s.testclass="blackbg"):"contact-info"==e&&(s.testclass="blackbg",s.contactInfo=!0)},s.innerForm=function(e){console.log(e),"sec-sw-impress"==e?(s.testclass="blackbg",s.softwareImpress=!0):"sec-sd-impress"==e?(s.testclass="blackbg",s.sdImpress=!0):"sec-st-impress"==e?(s.stImpress=!0,s.testclass="blackbg"):"sub-custom"==e?(s.stCustom=!0,s.testclass="blackbg"):"sec-si-impress"==e?(s.siteInstall=!0,s.testclass="blackbg"):"sec-pt-impress"==e?(s.ptImpress=!0,s.testclass="blackbg"):"sec-sp-impress"==e?(s.spImpress=!0,s.testclass="blackbg"):"sec-con-impress"==e?(s.connectivity=!0,s.testclass="blackbg"):"sec-cot-impress"==e?(s.content=!0,s.testclass="blackbg"):"sec-sp-find"==e&&(s.spFind=!0,s.testclass="blackbg")},s.innerShow=function(e){console.log(e),"secProposal"==e?s.proposalType=!0:"secOthers"==e&&(s.proposalType=!1)},s.hideOptions=function(){s.proposalType=!1,s.stCustom=!1},s.detail={},s.slider={value:2,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:"10mm"},{value:"40mm"},{value:"50mm"},{value:"60mm"},{value:"others"}]}},s.enterValidation=function(){return!0},s.exitValidation=function(){return!0},s.exitValidation=function(s){return"Jacob"===s.firstName},s.exitValidation=function(){var s=$q.defer();return a(function(){return s.resolve(!0)},2e3),s.promise};var c=document.getElementsByClassName("wiz-cnt");$(c).scroll(function(){s.st=$(this).scrollTop(),s.st>s.lastScrollTop?(console.log("dowm"),s.navClass="small"):(s.navClass="big",console.log("big")),s.lastScrollTop=s.st,s.$apply(),console.log(s.direction)})}angular.module("tessaApp").value("duScrollOffset",30).value("duScrollActiveClass").controller("ExperimentCtrl",s),s.$inject=["$scope","$window","$anchorScroll","$location","$document","$timeout"]}();
