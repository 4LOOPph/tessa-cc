...
!function(){"use strict";function e(e,s,t,n,a,o,r,i,l,u){e.requests=[],e.roles=[],e.samples=[],e.user=_.isEmpty(l.get("appuser"))?[]:JSON.parse(l.get("appuser"));e.user.roles=[],e.isLoading=!1,e.persons=[];var c=function(){async.waterfall([function(s){e.isLoading=!0,i.getAllReqInfo().then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result;var n=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(n,function(s,t){e.listName.toLowerCase()==t&&(e.items=s)})}),s()}})},function(s){i.getAllPersons().then(function(t){if(200==t.statusCode&&t.response.success){var n=_.find(t.response.result,{displayName:e.user.displayName});e.user.role_name=n.type_name,e.user.final_id=n.person_id,i.userRule({usertype:"scheduler"}).then(function(t){200==t.statusCode&&t.response.success&&(e.roles=angular.copy(t.response.result),e.user.roles=t.response.result,e.rolesgroup=_.groupBy(e.roles,"module_name")),s(),e.isLoading=!1})}})}])};e.value1=!0,e.value2="YES",e.toggle=function(s){"YES"===s?e.value2="NO":e.value2="YES"},e.gotoBottom=function(){a.hash("bottom"),o()},e.models=[{id:1,listName:"to do",image:"../images/icons/rd-status-icon--03.svg",items:[],datezz:"5 days",pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:2,listName:"in progress",image:"../images/icons/rd-status-icon--05.svg",items:[],datezz:"3 days",pri:"Low",req:"Adarna",assignee:"Bangs",dragging:!1},{id:3,listName:"blocked",image:"../images/icons/rd-status-icon--06.svg",items:[],datezz:"Overdue",pri:"High",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:5,listName:"for review",image:"../images/icons/rd-status-icon--07.svg",items:[],datezz:"5 days",pri:"Medium",req:"Adarna",assignee:"Bangs",dragging:!1},{id:4,listName:"completed",image:"../images/icons/rd-status-icon--08.svg",items:[],datezz:"Completed",pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1}],e.getSelectedItemsIncluding=function(e,s){return s.selected=!0,e.items.filter(function(e){return e.selected})},e.onDragstart=function(e,s){e.dragging=!0},c(),e.isAuthorize=function(s){var t=_.find(e.user.roles,{module_item_name:s});if(!_.isUndefined(t)||!_.isNull(t))return!(!t.isAuthorized||1!=t.isAuthorized)},e.onDrop=function(s,t,a,o){async.waterfall([function(s){e.isLoading=!0,s()},function(t){n(function(){e.isAuthorize(s)?a&&_.each(o,function(t){t.status_name.toLowerCase()==a.listName.toLowerCase()||(e.isAuthorize(a.listName.toLowerCase())?e.updateStatus(s,a,o):u.error("Anauthorize","Error"))}):u.error("Anauthorize","Error")},1e3)}])},e.logEvent=function(s,t){var n=[];e.samples.push(s),_.each(e.models,function(s){n=_.filter(s.items,{selected:!0}),_.isUndefined(n)&&(e.samples=[])}),t.selected=!t.selected,e.samples=_.uniqBy(e.samples),e.samples.length>1&&(_.each(e.samples,function(s,t){0==t&&(e.firstindex=s)}),_.each(e.models,function(s){s.listName==e.firstindex.listName&&_.some(s.items,function(e){e.selected=!1})}),e.samples.splice(0,1))},e.onMoved=function(e,s){e.items=e.items.filter(function(e){return!e.selected})};e.$watch("models",function(s){e.modelAsJson=angular.toJson(s,!0)},!0),e.manualupdateStatus=function(s,n){var a=r.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"manualstatusUpdateCtrl",resolve:{list:function(){return s},item:function(){return n},user_roles:function(){return e.user},status:function(){return e.models}}});a.result.then(function(e){console.log("response: ",e),"save"==e&&t.reload()})},e.updateStatus=function(s,n,a){var o=r.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"statusUpdateCtrl",resolve:{action:function(){return s},items:function(){return a},user_roles:function(){return e.user},list:function(){return n}}});o.result.then(function(e){"save"==e&&t.reload()})},e.cancelReq=function(){r.open({animation:!0,templateUrl:"./views/folder/Cancel-request-modal.html",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"})},e.isDisabledDate=function(e,s){return"day"===s&&(0===e.getDay()||6===e.getDay())}}angular.module("tessaApp").controller("ScrollCtrl",e),e.$inject=["$scope","$rootScope","$state","$timeout","$location","$anchorScroll","$uibModal","rfqFctry","localStorageService","toastr"]}();
...
!function(){"use strict";function e(e,s,t,a,l,o,i,r,n,u,d,c,m){e.cards=n[0],e.list=d,e.user=u,console.log("action;",r),console.log("items;",n),console.log("list;",d),console.log("$scope.user;",e.user),e.userRoles=_.find(e.user.roles,{module_item_name:r}),e.persons=[],e.details={},e.details.status_id=e.list.id,e.details.moved_by=e.user.final_id,e.details.request_index=0,e.details.remark=e.cards.remark,e.details.casenumber=e.cards.request_info.case_number,e.details.previousstatus=e.cards.status_name,e.details.newstatus=e.list.listName.toLowerCase(),e.details.role=e.userRoles.role_id,e.details.module=e.userRoles.module_id,e.details.module_item=e.userRoles.module_item_id,e.details.fullname=e.user.displayName,e.details.cardtitle=e.cards.request_info.title,c.getAllPersons().then(function(s){200==s.statusCode&&s.response.success&&(e.persons=s.response.result)}),e.update=function(){c.updateStatus(e.cards.request_id,e.details).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),t.close("save")):o.success(e.response.msg,"Error")})},e.getValue=function(s){console.log("item:",s),e.details.assignee_id=s.person_id,e.details.emailaddress=s.email},e.cancel=function(){t.dismiss("cancel")}}function s(e,s,t,a,l,o,i,r,n,u,d,c,m){e.details={},e.list=u,console.log("manualstatusUpdateCtrl"),console.log("item:",r),console.log("user_roles:",n),console.log("list:",u),console.log("status:",m),e.details.moved_by=n.final_id,e.details.request_index=0,e.details.remark=r.remark,e.details.casenumber=r.request_info.case_number,e.details.previousstatus=r.status_name,e.details.fullname=n.displayName,e.details.cardtitle=r.request_info.title,d.getAllPersons().then(function(s){200==s.statusCode&&s.response.success&&(e.persons=s.response.result)}),e.getAction=function(s){console.log("value:",s),_.each(m,function(e){e.listName=e.listName.toLowerCase()});var t=_.find(m,{listName:s.toLowerCase()}),a=_.find(n.roles,{module_item_name:s.toLowerCase()});console.log("validateroles:",a),e.details.role=a.role_id,e.details.module=a.module_id,e.details.module_item=a.module_item_id,e.details.status_id=t.id,e.details.newstatus=t.listName.toLowerCase()},e.getValue=function(s){console.log("item:",s),e.details.assignee_id=s.person_id,e.details.emailaddress=s.email},e.update=function(){d.updateStatus(r.request_id,e.details).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),t.close("save")):o.success(e.response.msg,"Error")})},e.cancel=function(){t.dismiss("cancel")}}angular.module("tessaApp").controller("statusUpdateCtrl",e).controller("manualstatusUpdateCtrl",s),e.$inject=["$scope","$state","$uibModalInstance","$timeout","$stateParams","toastr","APIFactory","action","items","user_roles","list","rfqFctry","localStorageService"],s.$inject=["$scope","$state","$uibModalInstance","$timeout","$stateParams","toastr","APIFactory","item","user_roles","list","rfqFctry","localStorageService","status"]}();
