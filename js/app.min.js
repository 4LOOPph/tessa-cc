...
!function(){"use strict";function e(e,t,a,r,i,n,o,s,l,c,u,p,d,h){function y(e,t){var a=[];return"Solution"==e?i.each(t,function(e){i.some(e.hardware,function(e){e.attributes.length>0&&i.some(e.attributes,function(e){a.push(e)})})}):"Hardware"==e&&(i.each(t,function(e){i.isUndefined(e.attributes)||i.some(e.attributes,function(e){a.push(e)})}),a=i.flattenDeep(a)),a=i.uniqBy(a,"attribute")}function f(e){return i.map(e,function(e){if("location"==e.type){var t=e.label.replace(/[\s]/g,"");return{label:t.toLowerCase(),type:e.type,index:e.sortindex}}if("configuration"==e.type){var a=e.label.replace(/[\s]/g,"");return{label:a.toLowerCase(),type:e.type,index:e.sortindex}}return e})}function m(t,a,r,n){e.index=[];var o=[];return"Hardware"==e.prodTypeLabel?i.isEmpty(r)?t:i.isEmpty(t)?t:a>0?(i.each(r,function(e,a){var n=i.filter(t,function(t){return i.some(t.attributes,function(t){return t.value==e.value})}),s=i.filter(t,function(t){return i.some(t.attributes,function(t){return"Orientation"==t.attribute&&(t.values=t.value.split(",")),i.some(t.values,function(t){return t==e.value})})});return i.isEmpty(n)?i.isEmpty(s)||(o=s):o=n,r.splice(a,1),!1}),a-=1,m(o,a,r,n)):n:i.isEmpty(r)?t:i.isEmpty(t)&&!i.isEmpty(r)?t:a>0?(i.each(r,function(e,a){var n=i.filter(t,function(t){return t.hardware.some(function(t){return i.some(t.attributes,function(t){return"Orientation"==t.attribute,t.value==e.value})})}),s=i.filter(t,function(t){return t.hardware.some(function(t){return i.some(t.attributes,function(t){return"Orientation"==t.attribute&&(t.values=t.value.split(",")),i.some(t.values,function(t){return t==e.value})})})}),l=i.filter(t,function(t){return i.some(t.tags,{tags:e.label})});return i.isEmpty(n)?i.isEmpty(l)?i.isEmpty(s)||(o=s):o=l:o=n,r.splice(a,1),!1}),a-=1,m(o,a,r,n)):n}function g(t,a){i.map(t,function(t,r){r==a?e.lam=i.uniqBy(t,function(e){return e.value}):"Orientation"==a&&(e.lam=e.orient)})}e.prodTypeLabel=i.isEmpty(l.get("label"))?"Solution":JSON.parse(l.get("label")),e.solutionTypes=i.isEmpty(l.get("solutiontype"))?"Eze Impress":JSON.parse(l.get("solutiontype")),e.hardwareType=i.isEmpty(l.get("hardtype"))?"Screen":JSON.parse(l.get("hardtype")),e.filterhide=!1,e.datas=[],e.count=0,e.txtSearch="",e.bundles=[],e.productDetails=[],e.seemore=!0,e.solutions=[],e.SolutionCategory=[],e.productscopy=[],e.ezewificopy=[],e.screens=[],e.Screens=[],e.ScreenSize=[],e.media=[],e.MediaPlayer=[],e.Mediacopy=[],e.bundleTags=[],e.searchcopy=[],e.filtercopy=[],e.pageNumber=1,e.limitWithPage=12,e.totalPages=0,e.typeselected=[],e.tagselected=[],e.productsAttributesValue=[],e.showdisplay=!0,e.location=[{_id:8,label:"Indoor",type:"location"},{_id:9,label:"Outdoor",type:"location"},{_id:10,label:"Semi Outdoor",type:"location"}],e.config=[{_id:11,label:"Wall Mounted",type:"configuration"},{_id:12,label:"Floor Mounted",type:"configuration"}],e.usages=[{_id:13,label:"24/7",type:"usages"},{_id:14,label:"16/7",type:"usages"}],e.orient=[{_id:15,value:"Landscape",type:"orientation"},{_id:16,value:"Portrait",type:"orientation"},{_id:17,value:"Custom",type:"orientation"}],e.loadmore=!1,e.showLoadMore=!1,e.dynamicPopover={vesa:"vesa.html",bezel:"bezel.html",usage:"usage.html",weight:"weight.html",mounting:"configuration.html",location:"location.html",dimensions:"dimensions.html",screensize:"screens.html",brightness:"brightness.html",screentype:"screentype.html",resolution:"resolution.html",orientation:"orientation.html",templateUrl7:"wifi.html",templateUrl8:"ram.html",orientation1:"ori.html",templateUrl9:"displaytechno.html",displaytechno:"displaytechno.html",displayinterface:"displayinterface.html",templateUrlStorage:"storage.html",templateUrlGraphics:"graphics.html",templateUrlResolution:"resolutions.html",cablelength:"cablelength.html",framerate:"framerate.html",opticalreso:"opticalreso.html",usbprotocol:"usbprotocol.html",usbspeed:"usbspeed.html"},e.sample={sam:"screens.html"},e.infiniteScrollData={},e.infiniteScrollData.numToAdd=10,e.infiniteScrollData.currentItems=10,e.resetInfScroll=function(){e.infiniteScrollData.currentItems=e.infiniteScrollData.numToAdd},e.addMoreItems=function(){e.loadmore=!0,e.limitWithPage+=12},e.repeatEnd=function(){e.showLoadMore=!0,c(function(){e.$apply(function(){e.loadmore=!1})},2e3)};var b=function(){var a=[];t.getProductBundle(function(t,r){a=i.filter(r.response.result,function(e){if(1==e.is_published&&0==e.is_archived)return e}),h.getItem("Bundles").then(function(t){var r=[];e.solutionsAttributes=[];i.isEqual(t.sort(),a.sort());t&&(e.EzeImpress=t,i.each(t,function(e){i.some(e.product_bundle_category,function(e){r.push(e)})}),e.bundlecategory=i.uniqBy(r,function(e){return e.category_label}),e.bundlecategory=i.sortBy(e.bundlecategory,"category_label"),e.productscopy=angular.copy(e.EzeImpress),i.isEmpty(e.solutionTypes)||e.activateTab(e.solutionTypes))})})},w=function(){h.getItem("Products").then(function(t){if(t){var a=[],r=[],n=[];e.displayattrib=[],e.hardwares=t,e.hardwarecopy=angular.copy(e.hardwares),e.hardwarecategory=[],i.each(e.hardwares,function(t){t.product_category.length>0&&e.hardwarecategory.push(t.product_category)}),e.hardwarecategory=i.flattenDeep(e.hardwarecategory),i.each(e.hardwares,function(e){e.attributes.length>0&&n.push(e.attributes)}),e.allattributes=i.flattenDeep(n),e.attributegroup=i.groupBy(e.allattributes,"attribute"),i.each(e.allattributes,function(e){r.push(e.attribute)}),r.unshift("Screen Size","Location","Mounting Option","Usages","Orientation","Brightness","Bezel Size"),r=i.uniqBy(r),i.map(e.attributegroup,function(e,t){a.push(t)});i.each(r,function(t,r){i.each(a,function(a){a==t&&e.displayattrib.push(t)})}),e.copydisplayattrib=angular.copy(e.displayattrib),e.displayattrib.length>5&&(e.limitnumbers=Math.ceil(e.displayattrib.length/5)),i.isEmpty(e.hardwareType)||e.activeHard(e.hardwareType)}})};e.$watch("EzeImpress",function(t){var a=[];e.solutionsAttributes=y("Solution",t),console.log("$scope.solutionsAttributes:",e.solutionsAttributes),i.each(e.copydisplayattrib,function(t){i.each(e.solutionsAttributes,function(e){t==e.attribute&&a.push(t)})}),e.displayattrib=a,console.log("results:",a)}),e.$watch("hardwares",function(t){var a=[],r=y("Hardware",t);i.each(e.hardwaredisplayatt,function(e){i.each(r,function(t){e==t.attribute&&a.push(e)})}),e.hardwaredisplayatt=a,e.displayattrib=a}),e.toggleSelectedType=function(t){var a=t,r=[];if("Hardware"==e.prodTypeLabel)e.tagselected.indexOf(a)==-1?e.tagselected.push(a):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=a._id}),r=f(e.tagselected),!i.isEmpty(e.txtSearch)&&e.searchmedia?e.hardwares=m(e.searchmedia,r.length,r,e.searchmedia):e.hardwares=m(e.copy_hardware,r.length,r,e.copy_hardware),e.filterhardware=angular.copy(e.hardwares);else{var n=[],o=[];if(i.each(e.productscopy,function(e){e.hardware?e.hardware.length>0&&i.each(e.hardware,function(e){n.push(e)}):e.hardware=[]}),i.each(e.copyscreen,function(e){i.isNull(e.attributes)||o.push(e.attributes)}),o=i.flattenDeep(o),e.ezehards=angular.copy(n),e.attrib=angular.copy(o),"Eze Impress"==e.solutionTypes){e.typeselected.indexOf(a)==-1?e.typeselected.push(a):e.typeselected=i.filter(e.typeselected,function(e){return e._id!=a._id}),i.map(e.productscopy,function(t){i.each(t.tags,function(t){i.isEmpty(t.tags)||e.bundleTags.push(t)})});e.typeselected.length;r=f(e.typeselected),i.each(e.EzeImpress,function(e){i.each(e.tags,function(e){e.tags=e.tags.replace(/[\[\](){}?*+\^$\\.|\-|\s]/g,"")})}),!i.isEmpty(e.txtSearch)&&e.searchcopy?(console.log("$scope.searchcopy;",e.searchcopy),console.log("typeselected;",r),e.EzeImpress=m(e.searchcopy,r.length,r,e.searchcopy)):e.EzeImpress=m(e.solutionscopy,r.length,r,e.solutionscopy),e.filtercopy=angular.copy(e.EzeImpress)}}},e.refresh=function(){c(function(){w(),b()},200)},e.uncheck=function(t,a){t.checked&&("Hardware"==e.prodTypeLabel?(i.each(e.tagselected,function(e){e._id==t._id&&(e.checked=!1)}),"MediaPlayer"==e.hardwareType?e.toggleSelectedType(t):e.toggleSelectedType(t)):(i.each(e.typeselected,function(e){e._id==t._id&&(e.checked=!1)}),e.toggleSelectedType(t)))},e.searchData=function(){if(s.$broadcast("loading:progress"),"Solution"==e.prodTypeLabel){c(function(){t(),s.$broadcast("loading:finish")},600);var t=function(){i.isEmpty(e.txtSearch)?i.isEmpty(e.filtercopy)?e.EzeImpress=e.solutionscopy:e.EzeImpress=e.filtercopy:(i.isEmpty(e.typeselected)?c(function(){e.EzeImpress=r("filter")(e.solutionscopy,e.txtSearch),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300):i.isEmpty(e.typeselected)||c(function(){e.EzeImpress=r("filter")(e.filtercopy,e.txtSearch),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300),e.searchcopy=angular.copy(e.EzeImpress))}}else{c(function(){t(),s.$broadcast("loading:finish")},600);var t=function(){i.isEmpty(e.txtSearch)?i.isEmpty(e.filterhardware)?e.hardwares=e.copy_hardware:e.hardwares=e.filterhardware:i.isEmpty(e.tagselected)?c(function(){e.hardwares=r("filter")(e.copy_hardware,e.txtSearch),e.searchcopyhardware=angular.copy(e.hardwares),u.trackEvent("Category Search","search",e.txtSearch,e.hardwares.length)},300):i.isEmpty(e.tagselected)||c(function(){e.hardwares=r("filter")(e.filterhardware,e.txtSearch),e.searchcopyhardware=angular.copy(e.hardwares),u.trackEvent("Category Search","search",e.txtSearch,e.hardwares.length)},300)}}},e.showmore=function(){"Solution"==e.prodTypeLabel?e.limitnumbers=e.limitnumbers+5:e.limitnumber=e.limitnumber+5,(e.limitnumbers>=e.displayattrib.length||e.limitnumber>=e.hardwaredisplayatt.length)&&(e.showdisplay=!1)},e.showless=function(){var t=angular.copy(e.limitnumbers),a=angular.copy(e.limitnumber);"Solution"==e.prodTypeLabel?(e.limitnumbers=Math.ceil(t-5),e.limitnumbers<=5&&(e.showdisplay=!0)):(e.limitnumber=Math.ceil(a-5),e.limitnumber<=5&&(e.showdisplay=!0))},e.clearfilter=function(){"Solution"==e.prodTypeLabel?(i.isEmpty(e.txtSearch)&&i.isEmpty(e.typeselected)||(e.txtSearch="",i.forEach(e.typeselected,function(e){e.checked=!1}),e.typeselected.splice(e.typeselected)),e.EzeImpress=angular.copy(e.solutionscopy),e.filtercopy=[]):i.isEmpty(e.txtSearch)&&i.isEmpty(e.tagselected)||(e.txtSearch="",i.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.hardwares=angular.copy(e.copy_hardware),e.filterhardware=[])},e.$on("$stateChangeSuccess",function(t,a,r,i,n){"main.productCatalogue"==a.name&&e.refresh()}),e.activeProd=function(t){e.limitWithPage=12,e.showdisplay=!0,e.filtercopy=[],e.filterhide=!1,e.count++,e.prodTypeLabel=t,"Hardware"==t?(1==e.count&&(e.hardwares=angular.copy(e.hardwarecopy)),i.isEmpty(e.txtSearch)&&i.isEmpty(e.typeselected)||(e.txtSearch="",i.forEach(e.typeselected,function(e){e.checked=!1}),e.typeselected.splice(e.typeselected),e.EzeImpress=e.solutionscopy),e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.hardwareType),i.isEmpty(e.hardwareType)||e.activeHard(e.hardwareType)):(e.limitnumbers=Math.ceil(e.copydisplayattrib.length/5),console.log("$scope.limitnumbers;",e.limitnumbers),1==e.count?e.refresh():e.count>1&&(e.EzeImpress=angular.copy(e.solutionscopy)),i.isEmpty(e.txtSearch)&&i.isEmpty(e.tagselected)||(e.txtSearch="",i.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.hardwares=angular.copy(e.copy_hardware)),i.isEmpty(e.solutionTypes)||e.activateTab(e.solutionTypes),e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.solutionTypes)),l.set("label",JSON.stringify(e.prodTypeLabel))},e.activateTab=function(t){e.clearfilter(),e.solutionTypes=t,"Eze Wifi"==t?e.filterhide=!1:e.filterhide=!0,e.EzeImpress=i.filter(e.productscopy,function(e){return e.category_label==t}),e.solutionscopy=angular.copy(e.EzeImpress),e.attributegroup=i.groupBy(e.allattributes,"attribute"),i.forEach(e.attributegroup,function(e,t){});i.each(e.attributegroup,function(e,t){var a=i.filter(e,{is_visible:1});i.isEmpty(a)}),e.seemore=!0},e.activeHard=function(t){e.clearfilter(),e.hardwaredisplayatt=[];var a=[];e.filterhide=!0,e.hardwareType=t,e.hardwares=i.filter(e.hardwarecopy,function(e){return i.some(e.product_category,function(e){return e.category_label==t})}),e.copy_hardware=angular.copy(e.hardwares),i.each(e.hardwares,function(e){e.attributes.length>0&&a.push(e.attributes)}),a=i.flattenDeep(a),i.each(a,function(t){e.hardwaredisplayatt.push(t.attribute),"Screen Size"==t.attribute&&e.hardwaredisplayatt.unshift("Screen Size")}),e.hardwaredisplayatt=i.uniqBy(e.hardwaredisplayatt),e.hardwaredisplayatt.length>5&&(e.limitnumber=Math.ceil(e.hardwaredisplayatt.length/5)),console.log("$scope.hardwaredisplayatt;",e.hardwaredisplayatt),e.groupall=i.groupBy(e.allattributes,"attribute")},e.solutionCount=function(t,a){return e.counts=0,e.array=[],i.isUndefined(a)?function(a){return i.some(a.hardware,function(a){return a.attributes.some(function(a){return a.value==t&&e.counts++,a.value==t})})}:function(e){return i.some(e.hardware,function(e){return e.attributes.some(function(e){return"Orientation"==e.attribute&&(e.values=e.value.split(",")),i.some(e.values,function(e){return e==t})})})}},e.hardwareCount=function(e,t){return i.isUndefined(t)?function(t){return i.some(t.attributes,function(t){return t.value==e})}:function(t){return i.some(t.attributes,function(t){return"Orientation"==t.attribute&&(t.values=t.value.split(",")),i.some(t.values,function(t){return t==e})})}},e.filterValues=function(t){"Solution"==e.prodTypeLabel?g(e.attributegroup,t):g(e.groupall,t)},e.solutionsEzeImpress=function(e){u.trackEvent("Productcatalogue","click","Solution",i.toString(e.pb_id))},e.solutionsEzeWifi=function(e){u.trackEvent("Productcatalogue","click","Solution",i.toString(e.pb_id))},e.hardwareScreens=function(e){u.trackEvent("Productcatalogue","click","Hardware",i.toString(e.p_id))},e.hardwareMediaplayer=function(e){u.trackEvent("Productcatalogue","click","Hardware",i.toString(e.p_id))},e.togglemodal=function(e){var t=n.open({animation:!0,templateUrl:"./views/share.modal.html",controller:"articleCtrl",size:"sm",resolve:{article:function(){return e}}});t.result.then(function(){o.reload()},function(){console.info("Modal dismissed")})}}angular.module("tessaApp").controller("productCtrl",e),e.$inject=["$scope","APIFactory","$location","$filter","_","$uibModal","$state","$rootScope","localStorageService","$timeout","$frontierAnalytics","$templateCache","serviceTest","$localForage"]}();
