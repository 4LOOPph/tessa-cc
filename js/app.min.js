...
!function(){"use strict";function e(e,t,s,o,n,a,r,i,l,u){e.currentDate=moment(new Date).format("YYYY-MM-DD"),console.log("$scope.currentDate:",e.currentDate),e.requests=[],e.roles=[],e.samples=[],e.user=_.isEmpty(l.get("appuser"))?[]:JSON.parse(l.get("appuser"));e.user.roles=[],e.isLoading=!1,e.persons=[];var c=function(){async.waterfall([function(t){e.isLoading=!0,i.getAllReqInfo().then(function(s){if(200==s.statusCode&&s.response.success){e.requests=s.response.result,console.log("$scope.requests;",e.requests);e.requests,e.requests.length;_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),t(),e.copyrequest=angular.copy(s.response.result)}})},function(t){i.getAllPersons().then(function(s){if(200==s.statusCode&&s.response.success){var o=_.find(s.response.result,{displayName:e.user.displayName});e.user.role_name=o.type_name,e.user.final_id=o.person_id,i.userRule({usertype:"scheduler"}).then(function(s){200==s.statusCode&&s.response.success&&(e.roles=angular.copy(s.response.result),e.user.roles=s.response.result,e.rolesgroup=_.groupBy(e.roles,"module_name")),t(),e.isLoading=!1})}})}])};e.isClick=function(e){console.log("value:",e)},e.sortBy=function(t,s){console.log("name:",t),console.log("value:",s),console.log("$scope.filtervalue:",e.filtervalue),console.log("$scope.filtername:",e.filtername),_.isUndefined(e.copyfilterRequest)?"Ascending"==t?i.filterByField({sortbyfield:s.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})})}}):i.filterByField({sortbyfield:"-"+s.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})})}}):"Ascending"==t?i.filterByField({sortbyfield:s.toString(),filterbyfield:e.filtername.toString()+"="+e.filtervalue.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})})}}):i.filterByField({sortbyfield:"-"+s.toString(),filterbyfield:e.filtername.toString()+"="+e.filtervalue.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})})}})},e.formatString=function(e){var t=e.split("."),s=parseInt(t[0]),o=parseInt(t[1]),n=parseInt(t[2]),a=new Date(s,o-1,n);return a},e.dayDiff=function(t,s){var o=t.replace(/-/g,"."),n=s.replace(/-/g,"."),a=new Date(e.formatString(n)),r=new Date(e.formatString(o)),i=Math.abs(r.getTime()-a.getTime()),l=Math.ceil(i/864e5);return l},e.sortDisplay=function(t){e.isLoading=!0;var s=_.filter(e.copyrequest,function(e){return"completed"==e.status_name});o(function(){var t=r.open({animation:!0,templateUrl:"./views/request.dashboard/filter.modal.html",windowClass:"xd-modal",controller:"optionCtrl",resolve:{complete_cards:function(){return s}}});e.isLoading=!1,t.result.then(function(t){e.isLoading=!0,o(function(){e.requests=t,e.isLoading=!1},500)},function(){console.log("dismiss:")})},500)},e.getFilter=function(t,s){if(console.log("name:",t),console.log("value:",s),e.copyfilterRequest=[],e.filtername=t,e.filtervalue=s,_.each(e.models,function(e){e.items=[]}),"All"==t&&_.isUndefined(s)){e.filtervalue=" ",e.requests=e.copyrequest;var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),e.copyfilterRequest=angular.copy(e.requests)}else i.filterByField({filterbyfield:t.toString()+"="+s.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=angular.copy(t.response.result),_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),e.copyfilterRequest=angular.copy(e.requests)}})},e.gotoBottom=function(){n.hash("bottom"),a()},e.models=[{id:1,listName:"to do",image:"../images/icons/rd-status-icon--03.svg",items:[],datezz:!1,pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:2,listName:"in progress",image:"../images/icons/rd-status-icon--05.svg",items:[],datezz:!0,pri:"Low",req:"Adarna",assignee:"Bangs",dragging:!1},{id:3,listName:"blocked",image:"../images/icons/rd-status-icon--06.svg",items:[],datezz:!1,pri:"High",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:5,listName:"for review",image:"../images/icons/rd-status-icon--07.svg",items:[],datezz:!1,pri:"Medium",req:"Adarna",assignee:"Bangs",dragging:!1},{id:4,listName:"completed",image:"../images/icons/rd-status-icon--08.svg",items:[],datezz:!1,pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1}],e.getSelectedItemsIncluding=function(e,t){return t.selected=!0,e.items.filter(function(e){return e.selected})},e.dragoverCallback=function(e,t,s,o){return e<10},_.each(e.models,function(e){"completed"==e.listName?(e.showupdate=!1,e.allow=["not"]):(e.showupdate=!0,e.allow=["can"])}),e.onDragstart=function(t,s){console.log("list:",t),e.sam=!0,"in progress"==t.listName?_.each(e.models,function(e){"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.place=!1,e.allow=["not"]):(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"to do"==t.listName?_.each(e.models,function(e){"for review"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"blocked"==t.listName?_.each(e.models,function(e){"to do"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):(_.each(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"for review"==t.listName&&(_.each(e.models,function(e){"blocked"==e.listName?(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0):"completed"==e.listName?(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0):(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1)}),console.log("$scope.models:",e.models)),t.dragging=!0},c(),e.isAuthorize=function(t){var s=_.find(e.user.roles,{module_item_name:t});if(!_.isUndefined(s)||!_.isNull(s))return!(!s.isAuthorized||1!=s.isAuthorized)},e.dragend=function(t,s){console.log("diri"),t.dragging=!1,_.each(e.models,function(e){e.place=!1}),e.logEvent(t,s)},console.log("$scope.models:",e.models),e.onDrop=function(t,s,n,a){_.each(e.models,function(e){e.place=!1}),a.length>1?(_.each(a,function(t){t.status_name.toLowerCase()!==n.listName.toLowerCase()?e.check=!0:e.check=!1}),e.check&&(e.isAuthorize(t)&&e.isAuthorize(n.listName.toLowerCase())?e.updateStatus(t,n,a):u.error("Anauthorize","Error"))):n&&_.each(a,function(s){s.status_name.toLowerCase()!==n.listName.toLowerCase()&&async.waterfall([function(t){e.isLoading=!0,t()},function(s){o(function(){e.isAuthorize(t)&&e.isAuthorize(n.listName.toLowerCase())?e.updateStatus(t,n,a):u.error("Anauthorize","Error")},1e3)}])})},e.logEvent=function(t,s){s.selected=!s.selected;_.each(e.models,function(e){_.some(e.items,function(e){e.request_id===s.request_id&&e.$$hashKey===s.$$hashKey||(e.selected=!1)})})},e.onMoved=function(e,t){e.items=e.items.filter(function(e){return!e.selected})};e.$watch("models",function(t){e.modelAsJson=angular.toJson(t,!0)},!0),e.manualupdateStatus=function(t,o){var n=r.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"manualstatusUpdateCtrl",resolve:{list:function(){return e.models},item:function(){return o},user_roles:function(){return e.user},status:function(){return e.models}}});n.result.then(function(e){console.log("response: ",e),"save"==e&&s.reload()})},e.updateStatus=function(t,o,n){var a=r.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"statusUpdateCtrl",resolve:{action:function(){return t},items:function(){return n},user_roles:function(){return e.user},list:function(){return o}}});a.result.then(function(t){"save"==t?s.reload():e.isLoading=!1})},e.cancelReq=function(){r.open({animation:!0,templateUrl:"./views/folder/Cancel-request-modal.html",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"})},e.isDisabledDate=function(e,t){return"day"===t&&(0===e.getDay()||6===e.getDay())}}function t(e,t,s,o){e.display=!1,e.detail={};var n=moment(new Date).format("YYYY-MM-DD hh:mm:ss");console.log("current;",n),console.log("complete_cards:",s),e.cancel=function(){t.dismiss("cancel")},e.confirm=function(){e.result=[],console.log("$scope.displayOption:",e.displayOption),"recent"==e.displayOption?e.result=_.filter(s,function(e){return e.date_created<=n}):(e.detail.date_from=moment(e.detail.date_from).format("YYYY-MM-DD hh:mm:ss"),e.detail.date_to=moment(e.detail.date_to).format("YYYY-MM-DD hh:mm:ss"),e.result=_.filter(s,function(t){return t.date_created>=e.detail.date_from&&t.date_created<=e.detail.date_to})),t.close(e.result)},e.getdisplayOption=function(t){console.log("value:",t),e.displayOption=t,"range"==t?e.display=!0:e.display=!1}}angular.module("tessaApp").controller("ScrollCtrl",e).controller("optionCtrl",t),e.$inject=["$scope","$rootScope","$state","$timeout","$location","$anchorScroll","$uibModal","rfqFctry","localStorageService","toastr"],t.$inject=["$scope","$uibModalInstance","complete_cards","$timeout"]}();
!function(){"use strict";function e(e,s,t,o,n){e.navClass="big",e.lastScrollTop=0,e.direction="",e.tab=1,e.contactInfo=!1,e.ezefind=!1,e.ezeimpress=!1,e.proposalType=!1,e.secOthers=!1,e.others=!1,e.showDesign=!1,e.showPrototype=!1,e.design=!1,e.prototype=!1,e.others=!1,e.softwareImpress=!1,e.sdImpress=!1,e.stImpress=!1,e.stCustom=!1,e.siteInstall=!1,e.ptImpress=!1,e.spImpress=!1,e.spFind=!1,e.connectivity=!1,e.content=!1,e.renders=!1,e.graphic=!1,e.solcat=!1,e.visual=!1,e.emailtemplate=!1;var l=(angular.element(document.getElementById("container")),angular.element(document.getElementById("contact-info")));e.toTheTop=function(){n.scrollTopAnimated(0,5e3).then(function(){console&&console.log("You just scrolled to the top!")})},e.toContactInfo=function(){n.scrollToElementAnimated(l)},e.setTab=function(s){e.tab=s},e.isSet=function(s){return e.tab===s},e.showProposalType=function(){e.proposalType=!0},e.activeOption=function(){e.isActiveOption=value,"Hardware"==value},e.scrollTo=function(e){o.hash(e),t()},e.getValue=function(s){console.log(s),e.value=s},e.addRequest=function(s){console.log(s),"ezeimpress"==s?(e.ezeimpress=!0,e.ezefind=!1,e.design=!1,e.others=!1,e.prototype=!1):"ezefind"==s?(e.ezeimpress=!1,e.ezefind=!0,e.design=!1,e.others=!1,e.prototype=!1):"prototype"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!1,e.others=!1,e.prototype=!0):"design"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!0,e.others=!1,e.prototype=!1):"others"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!1,e.others=!0,e.prototype=!1):"contact-info"==s?e.contactInfo=!0:"renders"==s?(e.renders=!0,e.graphics=!1,e.visual=!1,e.solcat=!1,e.emailtemplate=!1):"graphics"==s?(e.renders=!1,e.graphics=!0,e.visual=!1,e.solcat=!1,e.emailtemplate=!1):"solcat"==s?(e.renders=!1,e.graphics=!1,e.visual=!1,e.solcat=!0,e.emailtemplate=!1):"visual"==s?(e.renders=!1,e.graphics=!1,e.visual=!0,e.solcat=!1,e.emailtemplate=!1):"email"==s&&(e.renders=!1,e.graphics=!1,e.visual=!1,e.solcat=!1,e.emailtemplate=!0)},e.innerForm=function(s){console.log(s),"sec-sw-impress"==s?(e.testclass="blackbg",e.softwareImpress=!0):"sec-sd-impress"==s?(e.testclass="blackbg",e.sdImpress=!0):"sec-st-impress"==s?(e.stImpress=!0,e.testclass="blackbg"):"sub-custom"==s?(e.stCustom=!0,e.testclass="blackbg"):"sec-si-impress"==s?(e.siteInstall=!0,e.testclass="blackbg"):"sec-pt-impress"==s?(e.ptImpress=!0,e.testclass="blackbg"):"sec-sp-impress"==s?(e.spImpress=!0,e.testclass="blackbg"):"sec-con-impress"==s?(e.connectivity=!0,e.testclass="blackbg"):"sec-cot-impress"==s?(e.content=!0,e.testclass="blackbg"):"sec-sp-find"==s&&(e.spFind=!0,e.testclass="blackbg")},e.innerShow=function(s){console.log(s),"secProposal"==s?e.proposalType=!0:"secOthers"==s&&(e.proposalType=!1)},e.hideOptions=function(){e.proposalType=!1,e.stCustom=!1},e.detail={},e.slider={value:2,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:"10mm"},{value:"40mm"},{value:"50mm"},{value:"60mm"},{value:"others"}]}},e.enterValidation=function(){return!0},e.exitValidation=function(){return!0},e.exitValidation=function(e){return"Jacob"===e.firstName},e.exitValidation=function(){var e=$q.defer();return $timeout(function(){return e.resolve(!0)},2e3),e.promise};var i=document.getElementById("wizard-form");$(i).scroll(function(){e.st=$(this).scrollTop(),e.st>e.lastScrollTop?(console.log("down ni jul"),e.navClass="small"):(console.log("up ni jul"),e.navClass="big"),e.lastScrollTop=e.st,e.$apply(),console.log(e.direction)})}angular.module("tessaApp").controller("WizardCtrl",e),e.$inject=["$scope","$window","$anchorScroll","$location","$document"]}();
!function(){"use strict";function e(e,t,s,a){console.log("CaseDetailCtrl"),e.persons=[],e.details={},e.tab=1,e.display=!1,e.requests=[],e.emojiMessage={},a.case_id&&s.getCardDetail(a.case_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result[0],e.details.request_info.date_created=moment(e.details.request_info.date_created).format("YYYY-MM-DD"),e.details.request_info.expected_delivery_date=moment(e.details.request_info.expected_delivery_date).format("YYYY-MM-DD"))}),t.getAllPerson(function(t,s){200==s.statusCode&&s.response.success&&(e.persons=s.response.result)}),e.setTab=function(t){e.tab=t},e.isSet=function(t){return e.tab===t},e.name="sample",e.newUploader=function(){var t=$uibModal.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/caseDetail-uploader.html",size:"lg",controller:"assetsUploadModalCtrl"});t.result.then(function(t){t&&e.refreshAssets()})}}angular.module("tessaApp").controller("CaseDetailCtrl",e),e.$inject=["$scope","APIFactory","rfqFctry","$stateParams"]}();
!function(){"use strict";function e(e,s,t,a,i,l,o,r,n,d,u,c,m){function p(s,t){e.index=[];var a={};return s.length>0&&(_.each(s,function(t,i){var l=d,o=_.find(l.roles,{module_item_name:r});return a.status_id=u.id,a.moved_by=l.final_id,a.request_index=0,a.remark=t.remark,a.casenumber=t.request_info.case_number,a.previousstatus=t.status_name,a.newstatus=u.listName.toLowerCase(),a.role=o.role_id,a.module=o.module_id,a.module_item=o.module_item_id,a.fullname=l.displayName,a.cardtitle=t.request_info.title,a.assignee_id=e.details.assignee_id,a.emailaddress=e.details.emailaddress,c.updateStatus(t.request_id,a).then(function(e){200==e.statusCode&&e.response.success?console.log("sucess"):console.log("error")}),s.splice(i,1),!1}),t-=1,p(s,t))}e.cards=[],n.length>1?e.cards=n:e.cards=n[0],e.persons=[],e.details={},e.comment={},c.getAllPersons().then(function(s){200==s.statusCode&&s.response.success&&(e.persons=s.response.result,console.log("$scope.persons:",e.persons))}),e.update=function(){if(n.length>1){var s=p(e.cards,e.cards.length);s||(l.success("Records Successfully Updated","Success"),t.close("save"))}else e.list=u,e.user=d,e.userRoles=_.find(e.user.roles,{module_item_name:r}),e.details.status_id=e.list.id,e.details.moved_by=e.user.final_id,e.details.request_index=0,e.details.remark=e.cards.remark,e.details.casenumber=e.cards.request_info.case_number,e.details.previousstatus=e.cards.status_name,e.details.newstatus=e.list.listName.toLowerCase(),e.details.role=e.userRoles.role_id,e.details.module=e.userRoles.module_id,e.details.module_item=e.userRoles.module_item_id,e.details.fullname=e.user.displayName,e.details.cardtitle=e.cards.request_info.title,async.waterfall([function(s){c.updateStatus(e.cards.request_id,e.details).then(function(e){200==e.statusCode&&e.response.success?s():l.error(e.response.msg,"Error")})},function(s){e.comment.comment_body=e.details.comment_body,e.comment.commentor=e.user.displayName,e.comment.role=e.userRoles.role_id,e.comment.module=e.userRoles.module_id,e.comment.module_item=e.userRoles.module_item_id,e.comment.cardtitle=e.cards.request_info.title,c.makeComment(e.cards.request_id,e.user.final_id,e.comment).then(function(e){console.log("datas:",e),200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),t.close("save")):l.error(e.response.msg,"Error")})}])},e.getValue=function(s){e.values=s,e.details.assignee_id=s.person_id,e.details.emailaddress=s.email},e.cancel=function(){console.log("cancel"),t.close("cancel")}}function s(e,s,t,a,i,l,o,r,n,d,u,c,m){e.lists=_.filter(d,function(e){return e.listName!=r.status_name}),r&&("in progress"==r.status_name?_.each(e.lists,function(e){"completed"==e.listName?e.display=!1:e.display=!0}):"to do"==r.status_name?_.each(e.lists,function(e){"for review"==e.listName?e.display=!1:"completed"==e.listName?e.display=!1:e.display=!0}):"blocked"==r.status_name?_.each(e.lists,function(e){"to do"==e.listName?e.display=!1:"completed"==e.listName?e.display=!1:e.display=!0}):"for review"==r.status_name&&_.each(e.lists,function(e){"blocked"==e.listName?e.display=!0:"completed"==e.listName?e.display=!0:e.display=!1})),e.details={},e.details.moved_by=n.final_id,e.details.request_index=0,e.details.remark=r.remark,e.details.casenumber=r.request_info.case_number,e.details.previousstatus=r.status_name,e.details.fullname=n.displayName,e.details.cardtitle=r.request_info.title,u.getAllPersons().then(function(s){200==s.statusCode&&s.response.success&&(e.persons=s.response.result)}),e.getAction=function(s){console.log("value:",s),_.each(m,function(e){e.listName=e.listName.toLowerCase()});var t=_.find(m,{listName:s.toLowerCase()}),a=_.find(n.roles,{module_item_name:s.toLowerCase()});e.details.role=a.role_id,e.details.module=a.module_id,e.details.module_item=a.module_item_id,e.details.status_id=t.id,e.details.newstatus=t.listName.toLowerCase()},e.getValue=function(s){e.details.assignee_id=s.person_id,e.details.emailaddress=s.email},e.update=function(){u.updateStatus(r.request_id,e.details).then(function(e){200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),t.close("save")):l.success(e.response.msg,"Error")})},e.cancel=function(){e.isLoading=!1,t.close("cancel")}}angular.module("tessaApp").controller("statusUpdateCtrl",e).controller("manualstatusUpdateCtrl",s),e.$inject=["$scope","$state","$uibModalInstance","$timeout","$stateParams","toastr","APIFactory","action","items","user_roles","list","rfqFctry","localStorageService"],s.$inject=["$scope","$state","$uibModalInstance","$timeout","$stateParams","toastr","APIFactory","item","user_roles","list","rfqFctry","localStorageService","status"]}();
!function(){"use strict";function s(s,e,t,o,l){s.navClass="big",s.lastScrollTop=0,s.direction="",s.tab=1,s.contactInfo=!1,s.ezefind=!1,s.ezeimpress=!1,s.proposalType=!1,s.secOthers=!1,s.others=!1,s.showDesign=!1,s.showPrototype=!1,s.design=!1,s.prototype=!1,s.others=!1,s.softwareImpress=!1,s.sdImpress=!1,s.stImpress=!1,s.stCustom=!1,s.siteInstall=!1,s.ptImpress=!1,s.spImpress=!1,s.spFind=!1,s.connectivity=!1,s.content=!1,s.renders=!1,s.graphic=!1,s.solcat=!1,s.visual=!1,s.emailtemplate=!1,s.setTab=function(e){s.tab=e},s.isSet=function(e){return s.tab===e},s.showProposalType=function(){s.proposalType=!0},s.activeOption=function(){s.isActiveOption=value,"Hardware"==value},s.scrollTo=function(s){o.hash(s),t()},s.getValue=function(e){console.log(e),s.value=e},s.addRequest=function(e){console.log(e),"ezeimpress"==e?(s.ezeimpress=!0,s.ezefind=!1,s.design=!1,s.others=!1,s.prototype=!1):"ezefind"==e?(s.ezeimpress=!1,s.ezefind=!0,s.design=!1,s.others=!1,s.prototype=!1):"prototype"==e?(s.ezeimpress=!1,s.ezefind=!1,s.design=!1,s.others=!1,s.prototype=!0):"design"==e?(s.ezeimpress=!1,s.ezefind=!1,s.design=!0,s.others=!1,s.prototype=!1):"others"==e?(s.ezeimpress=!1,s.ezefind=!1,s.design=!1,s.others=!0,s.prototype=!1):"renders"==e?(s.renders=!0,s.graphics=!1,s.visual=!1,s.solcat=!1,s.emailtemplate=!1):"graphics"==e?(s.renders=!1,s.graphics=!0,s.visual=!1,s.solcat=!1,s.emailtemplate=!1):"solcat"==e?(s.renders=!1,s.graphics=!1,s.visual=!1,s.solcat=!0,s.emailtemplate=!1):"visual"==e?(s.renders=!1,s.graphics=!1,s.visual=!0,s.solcat=!1,s.emailtemplate=!1):"email"==e?(s.renders=!1,s.graphics=!1,s.visual=!1,s.solcat=!1,s.emailtemplate=!0):"contact-info"==e&&(s.contactInfo=!0,s.testclass="blackbg")},s.innerForm=function(e){console.log(e),"sec-sw-impress"==e?(s.testclass="blackbg",s.softwareImpress=!0):"sec-sd-impress"==e?(s.testclass="blackbg",s.sdImpress=!0):"sec-st-impress"==e?(s.stImpress=!0,s.testclass="blackbg"):"sub-custom"==e?(s.stCustom=!0,s.testclass="blackbg"):"sec-si-impress"==e?(s.siteInstall=!0,s.testclass="blackbg"):"sec-pt-impress"==e?(s.ptImpress=!0,s.testclass="blackbg"):"sec-sp-impress"==e?(s.spImpress=!0,s.testclass="blackbg"):"sec-con-impress"==e?(s.connectivity=!0,s.testclass="blackbg"):"sec-cot-impress"==e?(s.content=!0,s.testclass="blackbg"):"sec-sp-find"==e&&(s.spFind=!0,s.testclass="blackbg")},s.innerShow=function(e){console.log(e),"secProposal"==e?s.proposalType=!0:"secOthers"==e&&(s.proposalType=!1)},s.hideOptions=function(){s.proposalType=!1,s.stCustom=!1},s.detail={},s.slider={value:2,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:"10mm"},{value:"40mm"},{value:"50mm"},{value:"60mm"},{value:"others"}]}},s.enterValidation=function(){return!0},s.exitValidation=function(){return!0},s.exitValidation=function(s){return"Jacob"===s.firstName},s.exitValidation=function(){var s=$q.defer();return $timeout(function(){return s.resolve(!0)},2e3),s.promise};var i=document.getElementById("wizard-form");$(i).scroll(function(){s.st=$(this).scrollTop(),s.st>s.lastScrollTop?(console.log("down ni jul"),s.navClass="small"):(console.log("up ni jul"),s.navClass="big"),s.lastScrollTop=s.st,s.$apply(),console.log(s.direction)})}angular.module("tessaApp").controller("ExperimentCtrl",s),s.$inject=["$scope","$window","$anchorScroll","$location","$document"]}();
!function(){"use strict";var r=function(r){return function(n,t){return r.uniqBy(n,function(r){return r[t]})}},n=function(){return function(r,n){for(var t="test",u=0;u<r.length;u++);return t}};angular.module("tessaApp").filter("duplicates",["_",r]).filter("count",[n]).filter("ellipsis",function(){return function(r,n,t,u){if(!r)return"";if(t=parseInt(t,10),!t)return r;if(r.length<=t)return r;if(r=r.substr(0,t),n){var e=r.lastIndexOf(" ");e!=-1&&("."!=r.charAt(e-1)&&","!=r.charAt(e-1)||(e-=1),r=r.substr(0,e))}return r+(u||" …")}}).filter("propsFilter",function(){return function(r,n){var t=[];return angular.isArray(r)?r.forEach(function(r){for(var u=!1,e=Object.keys(n),i=0;i<e.length;i++){var a=e[i],f=n[a].toLowerCase();if(r[a].toString().toLowerCase().indexOf(f)!==-1){u=!0;break}}u&&t.push(r)}):t=r,t}}).filter("urlFilter",function(r){return function(n){return r.trustAsResourceUrl(n)}}).filter("unique",function(){return function(r,n){if(n===!1)return r;if((n||angular.isUndefined(n))&&angular.isArray(r)){var t=[],u=function(r){return angular.isObject(r)&&angular.isString(n)?r[n]:r};angular.forEach(r,function(r){for(var n=!1,e=0;e<t.length;e++)if(angular.equals(u(t[e]),u(r))){n=!0;break}n||t.push(r)}),r=t}return r}})}();
