...
!function(){"use strict";function e(e,i,o,t,c,s,n,r,d,a,m,v){console.log("assetsLightBoxModalCtrl: "),e.activeDevices=[],e.device={},e.mirrorFile=a,e.mirrorDevice=m,e.selectedFile=t,e.image_file=v,console.log("image_file: ",v),c.on("pair:init",function(){}),c.on("pair:sendCode",function(i){_.find(e.activeDevices,{deviceUUID:i.deviceUUID})||e.activeDevices.push(i)}),e.cancelLightBox=function(){_.isEmpty(e.mirrorDevice)?c.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}):c.emit("pair:closePresent",{deviceUUID:e.mirrorDevice.deviceUUID}),_.isEmpty(e.mirrorDevice)?!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(r,{action:"close",deviceUUID:e.device.deviceUUID},function(e){}):!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(r,{action:"close",deviceUUID:e.mirrorDevice.deviceUUID},function(e){}),i.dismiss("cancel")},e.selectLightBoxDevice=function(i){e.device=i,console.log("$scope.device: ",e.device),e.device&&(e.device.connected=!0,"audio/mp3"==t.asset_mimetype||"audio/mp4"==t.asset_mimetype?t.asset_type="audio":"video/mp4"==t.asset_mimetype||"video/x-flv"==t.asset_mimetype||"video/x-msvideo"==t.asset_mimetype||"video/x-ms-wmv"==t.asset_mimetype||"video/quicktime"==t.asset_mimetype||"video/3gpp"==t.asset_mimetype?t.asset_type="video":t.asset_type="none",t.deviceUUID=e.device.deviceUUID,t.url=window.location.origin+window.location.pathname+"presentation.html?s="+e.device.deviceUUID,e.device.asset_file=t,!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(r,{openplugin:window.location.origin+window.location.pathname,deviceUUID:e.device.deviceUUID},function(i){console.log("response: ",i),c.emit("pair:getCode",e.device)}))}}angular.module("tessaApp").controller("assetsLightBoxModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$sce","files","socket","$window","type","EXT_ID","$uibModal","mirrorFile","mirrorDevice","image_file"]}();
