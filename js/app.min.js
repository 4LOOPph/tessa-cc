...
!function(){"use strict";function t(t){t.tab=1,t.setTab=function(n){t.tab=n},t.isSet=function(n){return t.tab===n}}angular.module("tessaApp").controller("CaseDetailCtrl",t),t.$inject=["$scope"]}();
!function(){"use strict";function e(e,a,t,s){e.gotoBottom=function(){a.hash("bottom"),t()},e.models=[{listName:"to do",image:"../images/icons/rd-status-icon--03.svg",items:[],datezz:"5 days",pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{listName:"In Progress",image:"../images/icons/rd-status-icon--05.svg",items:[],datezz:"3 days",pri:"Low",req:"Adarna",assignee:"Bangs",dragging:!1},{listName:"Blocked",image:"../images/icons/rd-status-icon--06.svg",items:[],datezz:"Overdue",pri:"High",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{listName:"For Review",image:"../images/icons/rd-status-icon--07.svg",items:[],datezz:"5 days",pri:"Medium",req:"Adarna",assignee:"Bangs",dragging:!1},{listName:"Completed",image:"../images/icons/rd-status-icon--08.svg",items:[],datezz:"Completed",pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1}],e.getSelectedItemsIncluding=function(e,a){return a.selected=!0,e.items.filter(function(e){return e.selected})},e.onDragstart=function(e,a){e.dragging=!0,console.log("list:",e),console.log("event:",a),a.dataTransfer.setDragImage&&a.dataTransfer.setDragImage(img,0,0)},e.onDrop=function(e,a,t){return angular.forEach(a,function(e){e.selected=!1}),e.items=e.items.slice(0,t).concat(a).concat(e.items.slice(t)),!0},e.onMoved=function(e){e.items=e.items.filter(function(e){return!e.selected})},angular.forEach(e.models,function(e){for(var a=1;a<=3;++a)e.items.push({label:"Item "+e.listName+a})}),e.$watch("models",function(a){e.modelAsJson=angular.toJson(a,!0)},!0),e.updateStatus=function(){s.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"})},e.isDisabledDate=function(e,a){return"day"===a&&(0===e.getDay()||6===e.getDay())}}angular.module("tessaApp").controller("ScrollCtrl",e),e.$inject=["$scope","$location","$anchorScroll","$uibModal"]}();
