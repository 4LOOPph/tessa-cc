...
!function(){"use strict";function e(e,t,s,o,n,a,i,r,l,u){e.currentDate=moment(new Date).format("YYYY-MM-DD"),e.requests=[],e.roles=[],e.samples=[],e.user=_.isEmpty(l.get("appuser"))?[]:JSON.parse(l.get("appuser")),e.user.roles=[],e.isLoading=!1,e.persons=[];var c=function(){async.waterfall([function(t){e.isLoading=!0,r.getAllReqInfo().then(function(s){if(200==s.statusCode&&s.response.success){e.requests=s.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.expected_delivery_date=moment(e.expected_delivery_date).format("YYYY-MM-DD"),e.due_date=moment(e.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.due_date,e.currentDate);t.current=s});var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),t(),e.copyrequest=angular.copy(s.response.result)}})},function(t){console.log("diri1:",e.user),e.user.final_id=1,e.user.role_name="Scheduler",r.userRule({usertype:e.user.role_name}).then(function(t){200==t.statusCode&&t.response.success&&(e.roles=angular.copy(t.response.result),e.user.roles=t.response.result,e.rolesgroup=_.groupBy(e.roles,"module_name"),l.set("appuser",JSON.stringify(e.user)))}),e.isLoading=!1}])};e.sortBy=function(t,s){console.log("$scope.copyfilterRequest;",e.copyfilterRequest),console.log("name;",t),_.isEmpty(e.copyfilterRequest)?"Ascending"==t?(console.log("DIRI"),e.isLoading=!0,r.filterByField({sortbyfield:s.toString(),filtercomplete:!1}).then(function(t){if(200==t.statusCode&&t.response.success){_.each(t.response.result,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.expected_delivery_date=moment(e.expected_delivery_date).format("YYYY-MM-DD"),e.due_date=moment(e.due_date).format("YYYY-MM-DD")}),_.map(t.response.result,function(t){var s=e.dayDiff(t.due_date,e.currentDate);t.current=s}),e.requests=t.response.result;var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),e.isLoading=!1}else e.isLoading=!1})):(e.isLoading=!0,r.filterByField({sortbyfield:"-"+s.toString(),filtercomplete:!1}).then(function(t){if(200==t.statusCode&&t.response.success){_.each(t.response.result,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.expected_delivery_date=moment(e.expected_delivery_date).format("YYYY-MM-DD"),e.due_date=moment(e.due_date).format("YYYY-MM-DD")}),_.map(t.response.result,function(t){var s=e.dayDiff(t.due_date,e.currentDate);t.current=s}),e.requests=t.response.result;var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),e.isLoading=!1}else e.isLoading=!1})):(e.isLoading=!0,"Ascending"==t?r.filterByField({sortbyfield:s.toString(),filterbyfield:e.filtername.toString()+"="+e.filtervalue.toString(),filtercomplete:!1}).then(function(t){if(200==t.statusCode&&t.response.success){_.each(t.response.result,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.expected_delivery_date=moment(e.expected_delivery_date).format("YYYY-MM-DD"),e.due_date=moment(e.due_date).format("YYYY-MM-DD")}),_.map(t.response.result,function(t){var s=e.dayDiff(t.due_date,e.currentDate);t.current=s}),e.requests=t.response.result;var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),e.isLoading=!1}else e.isLoading=!1}):(e.isLoading=!0,r.filterByField({sortbyfield:"-"+s.toString(),filterbyfield:e.filtername.toString()+"="+e.filtervalue.toString(),filtercomplete:!1}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.expected_delivery_date=moment(e.expected_delivery_date).format("YYYY-MM-DD"),e.due_date=moment(e.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),e.isLoading=!1}else e.isLoading=!1})),e.isLoading=!1)},e.formatString=function(e){var t=e.split("."),s=parseInt(t[0]),o=parseInt(t[1]),n=parseInt(t[2]),a=new Date(s,o-1,n);return a},e.dayDiff=function(t,s){var o=t.replace(/-/g,"."),n=s.replace(/-/g,"."),a=new Date(e.formatString(n)),i=new Date(e.formatString(o)),r=Math.ceil(i.getTime()/864e5),l=Math.ceil(a.getTime()/864e5);return r-l},e.sortDisplay=function(t){var s=_.filter(e.copyrequest,function(e){return"completed"==e.status_name});console.log("cardcompletes:",s),s.length>0&&(e.isLoading=!0,o(function(){var t=i.open({animation:!0,templateUrl:"./views/request.dashboard/filter.modal.html",windowClass:"xd-modal",controller:"optionCtrl",resolve:{complete_cards:function(){return s}}});e.isLoading=!1,t.result.then(function(t){e.isLoading=!0;var s=_.groupBy(t,"status_name");_.each(e.models,function(t){_.map(s,function(e,s){t.listName.toLowerCase()==s&&(t.items=e)}),e.isLoading=!1},500)},function(){console.log("dismiss:")})},500))},e.getFilter=function(t,s){if(e.copyfilterRequest=[],e.filtername=t,e.filtervalue=s,_.each(e.models,function(e){e.items=[]}),"All"==t&&_.isUndefined(s)){e.isLoading=!0,e.filtervalue=" ",e.filtername=" ",e.copyfilterRequest=[],e.requests=e.copyrequest;var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),e.isLoading=!1}else e.isLoading=!0,r.filterByField({filterbyfield:t.toString()+"="+s.toString(),filtercomplete:!1}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=angular.copy(t.response.result),_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.expected_delivery_date=moment(e.expected_delivery_date).format("YYYY-MM-DD"),e.due_date=moment(e.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),e.isLoading=!1,e.copyfilterRequest=angular.copy(e.requests)}else e.isLoading=!1})},e.gotoBottom=function(){n.hash("bottom"),a()},e.models=[{id:1,listName:"to do",image:"../images/icons/rd-status-icon--03.svg",items:[],datezz:!1,pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:2,listName:"in progress",image:"../images/icons/rd-status-icon--05.svg",items:[],datezz:!0,pri:"Low",req:"Adarna",assignee:"Bangs",dragging:!1},{id:3,listName:"blocked",image:"../images/icons/rd-status-icon--06.svg",items:[],datezz:!1,pri:"High",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:5,listName:"for review",image:"../images/icons/rd-status-icon--07.svg",items:[],datezz:!1,pri:"Medium",req:"Adarna",assignee:"Bangs",dragging:!1},{id:4,listName:"completed",image:"../images/icons/rd-status-icon--08.svg",items:[],datezz:!1,pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1}],e.getSelectedItemsIncluding=function(e,t){return t.selected=!0,e.items.filter(function(e){return e.selected})},e.dragoverCallback=function(e,t,s,o){return e<10},_.each(e.models,function(e){"completed"==e.listName?(e.showupdate=!1,e.allow=["not"]):(e.showupdate=!0,e.allow=["can"])}),console.log("$scope.models:",e.models),e.onDragstart=function(t,s){e.sam=!0,"in progress"==t.listName?_.each(e.models,function(e){"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.place=!1,e.allow=["not"]):(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"to do"==t.listName?_.each(e.models,function(e){"for review"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"blocked"==t.listName?_.each(e.models,function(e){"to do"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):(_.each(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"for review"==t.listName&&_.each(e.models,function(e){"blocked"==e.listName?(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0):"completed"==e.listName?(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0):"to do"==e.listName?(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0):(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1)}),t.dragging=!0},c(),e.isAuthorize=function(t){var s=_.find(e.user.roles,{module_item_name:t});if(!_.isUndefined(s)||!_.isNull(s))return!(!s.isAuthorized||1!=s.isAuthorized)},e.dragend=function(t,s){t.dragging=!1,_.each(e.models,function(e){e.place=!1}),e.logEvent(t,s)},e.onDrop=function(t,s,n,a){_.each(e.models,function(e){e.place=!1}),a.length>1?(_.each(a,function(t){t.status_name.toLowerCase()!==n.listName.toLowerCase()?e.check=!0:e.check=!1}),e.check&&(e.isAuthorize(t)&&e.isAuthorize(n.listName.toLowerCase())?e.updateStatus(t,n,a):u.error("Anauthorize","Error"),e.isLoading=!1)):n&&_.each(a,function(s){s.status_name.toLowerCase()!==n.listName.toLowerCase()&&async.waterfall([function(t){e.isLoading=!0,t()},function(s){o(function(){e.isAuthorize(t)&&e.isAuthorize(n.listName.toLowerCase())?e.updateStatus(t,n,a):u.error("Anauthorize","Error"),e.isLoading=!1},1e3)}])})},e.logEvent=function(t,s){s.selected=!s.selected;_.each(e.models,function(e){_.some(e.items,function(e){e.request_id===s.request_id&&e.$$hashKey===s.$$hashKey||(e.selected=!1)})})},e.onMoved=function(e,t){e.items=e.items.filter(function(e){return!e.selected})};e.$watch("models",function(t){e.completecards=_.find(t,{listName:"completed"}),e.modelAsJson=angular.toJson(t,!0)},!0),e.manualupdateStatus=function(t,o){var n=i.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"manualstatusUpdateCtrl",resolve:{list:function(){return e.models},item:function(){return o},user_roles:function(){return e.user},status:function(){return e.models}}});n.result.then(function(e){"save"==e&&s.reload()})},e.updateStatus=function(t,o,n){var a=i.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"statusUpdateCtrl",resolve:{action:function(){return t},items:function(){return n},user_roles:function(){return e.user},list:function(){return o}}});a.result.then(function(t){"save"==t?s.reload():e.isLoading=!1})},e.cancelReq=function(){i.open({animation:!0,templateUrl:"./views/folder/Cancel-request-modal.html",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"})},e.isDisabledDate=function(e,t){return"day"===t&&(0===e.getDay()||6===e.getDay())},e.$on("$stateChangeSuccess",function(e,t,s,o,n){"main.requestWizard"==o.name&&r.removeCompanyContact()})}function t(e,t,s,o){e.display=!1,e.detail={};var n=moment(new Date).format("YYYY-MM-DD hh:mm:ss");e.cancel=function(){t.dismiss("cancel")},e.confirm=function(){e.result=[],"recent"==e.displayOption?e.result=_.filter(s,function(e){return e.date_created<=n}):(e.detail.date_from=moment(e.detail.date_from).format("YYYY-MM-DD"),e.detail.date_to=moment(e.detail.date_to).format("YYYY-MM-DD"),e.result=_.filter(s,function(t){return t.due_date>=e.detail.date_from&&t.due_date<=e.detail.date_to})),t.close(e.result)},e.getdisplayOption=function(t){e.displayOption=t,"range"==t?e.display=!0:e.display=!1}}angular.module("tessaApp").controller("ScrollCtrl",e).controller("optionCtrl",t),e.$inject=["$scope","$rootScope","$state","$timeout","$location","$anchorScroll","$uibModal","rfqFctry","localStorageService","toastr"],t.$inject=["$scope","$uibModalInstance","complete_cards","$timeout"]}();
!function(){"use strict";function e(e,s,t,o,i,n,a,l,c,r,d,p,u,m,f,g){function y(){console.log("MAKE");var s=e.details.columns,t=e.details.rows;e.cells=q(t,s)}function q(e,s){for(var t=[[]],o=0;o<e;o++){t[o]=[],t[o]=new Array(s);for(var i=0;i<s;i++)t[o][i]=""}return t}function h(e){for(var s=[],t=0;t<e.length;t++)s.push(e[t].case_number);var o=Math.max.apply(null,s);return o<=9?(o++,o):o<=99?(o++,o):o>=100?(o++,o):o>=1e3?(o++,o):o>=1e4?(o++,o):void 0}e.companies=[],e.casedetails=!1,e.user=_.isEmpty(c.get("appuser"))?[]:JSON.parse(c.get("appuser")),e.myStyle="table-landscape",e.orientation="Landscape",e.checkvalid2="Company Details",e.questions={},e.questions.requestType={},e.question={},e.persons=[],e.isLoading=!1,e.navClass="big",e.lastScrollTop=0,e.direction="",e.tab=1,e.contactInfo=!1,e.ezefind=!1,e.ezeimpress=!1,e.screenSize=!1,e.proposalType=!1,e.secOthers=!1,e.others=!1,e.showDesign=!1,e.showPrototype=!1,e.design=!1,e.prototype=!1,e.others=!1,e.softwareImpress=!1,e.sdImpress=!1,e.stImpress=!1,e.stCustom=!1,e.purpose=!1,e.siteInstall=!1,e.mdPlayer=!1,e.scMount=!1,e.ptImpress=!1,e.spImpress=!1,e.spFind=!1,e.connectivity=!1,e.content=!1,e.renders=!1,e.graphic=!1,e.solcat=!1,e.visual=!1,e.emailtemplate=!1,e.matrixConfig=!1,e.otherSec=!1,e.otherSec2=!1,e.secReview=!0,e.secFinale=!1,e.secSuccess=!1,e.deployedsite=0,e.deployedsolution=0,e.requestdetailsarray=[],e.requestdetails={},e.requestdetails.deployedsolution=0,e.requestdetails.deployedsite=0,l.getContactTemp().then(function(s){_.isNull(s)?e.person={}:e.person=s}),l.getCompanyTemp().then(function(s){_.isNull(s)?e.details={}:e.details=s}),e.audience=_.isEmpty(c.get("audience"))?"":c.get("audience"),e.objectives=_.isEmpty(c.get("objectives"))?"":c.get("objectives"),e.details={},e.sliders=[],e.singleDualslider=[],e.cells=[[]],e.sizes=[],e.sliders.slider={value:2,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:'32"'},{value:'42"'},{value:'52"'},{value:'62"'},{value:'72"'},{value:"others"}]}},e.siteinstallslider={value:2,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:"10mm"},{value:"40mm"},{value:"50mm"},{value:"60mm"},{value:"others"}]}},e.projectslider={value:2,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:"8wks"},{value:"9wks"},{value:"10wks"},{value:"11wks"},{value:"others"}]}},e.$watch("[details.columns,details.rows]",y,!0),e.$watch("details.rows",function(s,t){s>20&&(e.details.rows=t)}),e.$watch("details.columns",function(s,t){s>20&&(e.details.columns=t)}),e.pageNumber=0,e.limitWithPage=100;var v=function(){l.getCompanyInfo({startWith:e.pageNumber,limit:e.limitWithPage}).then(function(s){200==s.statusCode&&s.response.success&&(e.companies=s.response.result.result,e.companycopy=angular.copy(s.response.result))})};v(),e.getcontactPerson=function(s){e.person=s.originalObject},e.addmoreItems=function(s,t){t?(t.stopPropagation(),t.preventDefault(),e.limitWithPage+=100):(e.pageNumber=0,e.items=[]),v()},e.useBillingAddress=function(s){s?e.details&&(e.details.ship_name=e.details.bill_name,e.details.ship_address=e.details.bill_address,e.details.ship_city=e.details.bill_city,e.details.ship_state=e.details.bill_state,e.details.ship_zipcode=e.details.bill_zipcode,e.details.ship_country=e.details.bill_country):_.isUndefined(e.companycopy)?(e.details.ship_name="",e.details.ship_address="",e.details.ship_city="",e.details.ship_state="",e.details.ship_zipcode="",e.details.ship_country=""):(e.details.ship_name=e.companycopy.ship_name,e.details.ship_address=e.companycopy.ship_address,e.details.ship_city=e.companycopy.ship_city,e.details.ship_state=e.companycopy.ship_state,e.details.ship_zipcode=e.companycopy.ship_zipcode,e.details.ship_country=e.companycopy.ship_country)};var b=document.getElementsByClassName("wiz-cnt");$(b).scroll(function(){e.st=$(this).scrollTop(),e.st>e.lastScrollTop?e.navClass="small":e.navClass="big",e.lastScrollTop=e.st,e.$apply()}),y(),e.matrixrow=function(s){e.matrixrowsdetail={question_id:8,option_id:19,option_value:s}},e.matrixcolumn=function(s){e.matrixrowsdetail={question_id:8,option_id:20,option_value:s},console.log("$scope.matrixrowsdetail:",e.matrixrowsdetail)},e.getCompanyValue=function(s){console.log("value:",s),e.details=s,e.details.rows=3,e.details.columns=3,console.log("$scope.details:",e.details)},e.$watch("companyForm",function(s,t){e.checkValid=s}),e.addminusValue=function(s,t){"Site"==s?("minus"==t?e.requestdetails.deployedsite>0?e.requestdetails.deployedsite--:e.requestdetails.deployedsite=0:e.requestdetails.deployedsite++,e.deploysite(e.requestdetails.deployedsite)):("minus"==t?e.requestdetails.deployedsolution>0?e.requestdetails.deployedsolution--:e.requestdetails.deployedsolution=0:e.requestdetails.deployedsolution++,e.deploysolution(e.requestdetails.deployedsolution))},e.selectOrientation=function(s){if(e.orientation=s,"Landscape"==s){var t=21;e.myStyle="table-landscape"}else{var t=22;e.myStyle="table-portrait"}e.matrixrowsdetail={question_id:9,option_id:t},console.log("$scope.matrixrowsdetail:",e.matrixrowsdetail)},e.addRowsColumn=function(s){console.log("value:",s),console.log("$scope.details:",e.details),"rows"==s?(e.details.rows++,e.matrixrow(e.details.rows)):(e.details.columns++,e.matrixcolumn(e.details.columns))},e.minusRowsColumn=function(s){console.log("value11:",s),console.log("$scope.details:",e.details),"rows"==s?(e.details.rows>1?e.details.rows--:e.details.rows=1,e.matrixrow(e.details.rows)):(e.details.columns>1?e.details.columns--:e.details.columns=1,e.matrixcolumn(e.details.columns))},e.getValue=function(s){e.value=s},e.requestype=function(s){console.log("value;",s),e.requesttypes={},e.requestType=s,"Proposal"==s?e.questions.requestType.option_id=1:"Design"==s?e.questions.requestType.option_id=2:"Prototype"==s?e.questions.requestType.option_id=3:e.questions.requestType.option_id="others",e.requesttypes.request_id=0,e.requesttypes.question_id=1,e.requesttypes.option_id=e.questions.requestType.option_id,console.log("$scope.requesttypes:",e.requesttypes)},e.deploysite=function(s){e.deploysites={question_id:3,option_id:6,option_value:s},console.log("$scope.deploysites:",e.deploysites)},e.deploysolution=function(s){console.log("value:1",s),e.deploysolutions={question_id:4,option_id:7,option_value:s},console.log("$scope.deploysolutions:",e.deploysolutions)},e.requestdetail=function(s){e.desXp=s,"8"==s?e.requestdetaildesign="Proof of Concept":"9"==s?e.requestdetaildesign="Rollout":"10"==s&&(e.requestdetaildesign="Both"),e.requestdetails.request_id=0,e.requestdetails.question_id=5,e.requestdetails.option_id=s,console.log("$scope.requestdetails:",e.requestdetails)},e.proposaltype=function(s){"4"==s?e.proposType="Eze Find":"5"==s&&(e.proposType="Eze Impress"),e.proposaltypes={},e.proposaltypes.request_id=0,e.proposaltypes.question_id=2,e.proposaltypes.option_id=s,console.log("$scope.proposaltypes:",e.proposaltypes)},e.softwaredetail=function(s,t){"ezefind"==s?("11"==t?e.softwaresolution="Live table":"12"==t?e.softwaresolution="Digital ticket":"13"==t?e.softwaresolution="Compass":"14"==t&&(e.softwaresolution="Concierge"),e.softwaredetails={question_id:6,option_id:t}):("76"==t?e.softwaresolution="Eze Impress":"77"==t?e.softwaresolution="Magic Info Pro":"78"==t?e.softwaresolution="John Ryan":"79"==t&&(e.softwaresolution="App Space"),e.softwaredetails={question_id:27,option_id:t}),console.log("$scope.softwaredetails:",e.softwaredetails)},e.screenType=function(s){"94"==s?e.screentypes="Eze Impress":"95"==s?e.screentypes="Enhanced Pro":"96"==s?e.screentypes="Premium":"97"==s&&(e.screentypes="Custom"),e.screentypedetail={question_id:32,option_id:s},console.log("$scope.screentypedetail;",e.screentypedetail)},e.addSingleDualScreen=function(){e.singleDualslider.push({value:0,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:'32"'},{value:'42"'},{value:'52"'},{value:'62"'},{value:'72"'}]}})},e.screendetail=function(s){e.singleDualslider=[],"15"==s?e.screens="Single":"16"==s?e.screens="Dual":"17"==s?e.screens="Matrix":"18"==s&&(e.screens="BYO"),e.addSingleDualScreen(),e.screendetails=s,e.screen={},e.screen.screendetails=s,e.screendetails={question_id:7,option_id:s},console.log("$scope.screendetails:",e.screendetails)},e.screenmount=function(s){"27"==s?e.screenmounts="Table":"28"==s&&(e.screenmounts="Wall"),e.screenmountdetail={question_id:11,option_id:s}},e.mountlocation=function(s){"29"==s?e.mountlocations="Window facing":"30"==s?e.mountlocations="Near entrance":"31"==s?e.mountlocations="Waiting area":"32"==s?e.mountlocations="Near entrance":"33"==s&&(e.mountlocations="Other"),e.mountlocationdetail={question_id:12,option_id:s},console.log("$scope.mountlocationdetail:",e.mountlocationdetail)},e.mediaplayer=function(s){"34"==s?e.mediaplayers="Standard":"35"==s&&(e.mediaplayers="Premium"),e.mediaplayerdetail={question_id:13,option_id:s},console.log("$scope.mediaplayerdetail:",e.mediaplayerdetail)},e.setTab=function(s,t){if(console.log("objectives:",e.objectives),console.log("audience:",e.audience),e.request_card={},e.request_card.proposaltypes=e.proposaltypes,e.request_card.softwaredetails=e.softwaredetails,e.request_card.requesttypes=e.requesttypes,e.request_card.screendetails=e.screendetails,e.request_card.deploysites=e.deploysites,e.request_card.deploysolutions=e.deploysolutions,e.request_card.mountlocationdetail=e.mountlocationdetail,e.request_card.mediaplayerdetail=e.mediaplayerdetail,e.request_card.siteinstalldetail=e.siteinstalldetail,e.request_card.installlocationdetail=e.installlocationdetail,e.request_card.solutionsitedetail=e.solutionsitedetail,e.request_card.projecttimelinedetail=e.projecttimelinedetail,e.request_card.supportpackagedetail=e.supportpackagedetail,e.request_card.currentnetworkdetail=e.currentnetworkdetail,e.request_card.lanpreferencedetail=e.lanpreferencedetail,e.request_card.wanpreferencedetail=e.wanpreferencedetail,e.request_card.createcontentdetail=e.createcontentdetail,e.request_card.contentmanagementdetail=e.contentmanagementdetail,e.request_card.screenmountdetail=e.screenmountdetail,e.request_card.screentypedetail=e.screentypedetail,e.request_card.designtypedetail=e.designtypedetail,e.request_card.prototypespecification=e.prototypespecification,e.request_card.prototypePackagedetail=e.prototypePackagedetail,e.request_card.solcatdetail=e.solcatdetail,e.request_card.audienceobjectdetail=e.audienceobjectdetail,e.request_card.requestobjectdetail=e.requestobjectdetail,e.request_card.designexp=e.requestdetails,_.each(e.request_card,function(e){_.isUndefined(e)||(e.option_id=parseInt(e.option_id))}),e.checkValid.$valid){e.casedetails=!0;var o=angular.element(document.getElementsByClassName("wiz-cnt"));o.scrollTo(0,1e3),console.log("value;",t),console.log("$scope.managecontent;",e.managecontent),3==s?(console.log("newTab;",s),console.log("$scope.designtypes;",e.designtypes),console.log("$scope.protypeSpecific;",e.protypeSpecific),console.log("$scope.managecontent;",e.managecontent),_.isUndefined(e.managecontent)&&_.isUndefined(e.designtypes)&&!(e.files.length>0)&&_.isUndefined(e.protypeSpecific)&&_.isUndefined(e.requirementother)||(e.tab=s)):e.tab=s}},e.isSet=function(s){return e.tab===s},e.showProposalType=function(){e.proposalType=!0},e.setForm=function(s){console.log("value:",s),e.myform=angular.copy(s)},e.activeOption=function(){e.isActiveOption=value},e.scrollTo=function(e){o.hash(e),t()},e.addRequest=function(s){console.log("didi"),console.log(s),console.log("id:",s),"ezeimpress"==s?(e.ezeimpress=!0,e.testclass="blackbg",e.ezefind=!1,e.design=!1,e.others=!1,e.prototype=!1):"ezefind"==s?(e.ezeimpress=!1,e.ezefind=!0,e.testclass="blackbg",e.design=!1,e.others=!1,e.prototype=!1):"prototype"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!1,e.others=!1,e.prototype=!0,e.testclass="blackbg"):"design"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!0,e.others=!1,e.prototype=!1,e.testclass="blackbg"):"others"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!1,e.others=!0,e.prototype=!1,e.testclass="blackbg"):"renders"==s?(e.renders=!0,e.graphics=!1,e.visual=!1,e.solcat=!1,e.emailtemplate=!1,e.testclass="blackbg"):"graphics"==s?(e.renders=!1,e.graphics=!0,e.visual=!1,e.solcat=!1,e.emailtemplate=!1,e.testclass="blackbg"):"solcat"==s?(e.renders=!1,e.graphics=!1,e.visual=!1,e.solcat=!0,e.emailtemplate=!1,e.testclass="blackbg"):"visual"==s?(e.renders=!1,e.graphics=!1,e.visual=!0,e.solcat=!1,e.emailtemplate=!1,e.testclass="blackbg"):"email"==s?(e.renders=!1,e.graphics=!1,e.visual=!1,e.solcat=!1,e.emailtemplate=!0,e.testclass="blackbg"):"contact-info"==s&&(e.testclass="blackbg",e.contactInfo=!0)},e.uploadFiles=function(s){e.files=s},e.installLocation=function(s){"41"==s?e.installLocate="Near the screen":"42"==s?e.installLocate="In the server room":"43"==s?e.installLocate="Back of the screen":"44"==s&&(e.installLocate="Other"),e.installlocationdetail={question_id:15,option_id:s},console.log("$scope.installlocationdetail:",e.installlocationdetail)},e.solutionsite=function(s){"45"==s?e.solutionsit="Engagis":"47"==s&&(e.solutionsit="3rd Party"),e.solutionsitedetail={question_id:16,option_id:s},console.log("$scope.solutionsitedetail:",e.solutionsitedetail)},e.supportPack=function(s){"53"==s?e.supportpackage="Essential":"54"==s?e.supportpackage="Enterprise":"55"==s?e.supportpackage="3rd Party":"56"==s?e.supportpackage="DIY":"57"==s&&(e.supportpackage="Custom"),e.supportpackagedetail={question_id:18,option_id:s},console.log("$scope.supportpackagedetail:",e.supportpackagedetail)},e.currentnets=function(s){"58"==s?e.currentnetwork="With existing connection":"59"==s&&(e.currentnetwork="Requires new connection"),e.currentnetworkdetail={question_id:19,option_id:s},console.log("$scope.currentnetworkdetail:",e.currentnetworkdetail)},e.lanprefer=function(s){"60"==s?e.lanpreference="Wired":"61"==s&&(e.lanpreference="Wireless"),e.lanpreferencedetail={question_id:20,option_id:s},console.log("$scope.lanpreferencedetail:",e.lanpreferencedetail)},e.wanprefer=function(s){"62"==s?e.wanpreference="ASL":"63"==s&&(e.wanpreference="DSL"),e.wanpreferencedetail={question_id:21,option_id:s},console.log("$scope.wanpreferencedetail:",e.wanpreferencedetail)},e.createcont=function(s){"64"==s?e.createcontents="Use in-house resources":"65"==s?e.createcontents="We have an agency already":"66"==s&&(e.createcontents="We want a proposal from Engagis"),e.createcontent=s,e.createcontentdetail={question_id:22,option_id:s},console.log("$scope.createcontentdetail:",e.createcontentdetail)},e.contentmanage=function(s){"67"==s?e.contentmanagement="Use in-house resources":"68"==s&&(e.contentmanagement="We want a proposal from Engagis"),e.managecontent=s,e.contentmanagementdetail={question_id:23,option_id:s}},e.innerForm=function(s){if(e.screensized=[],e.singleDualslider.length>0&&_.each(e.singleDualslider,function(s){if(console.log("row:",s),'32"'==s.minValue)var t=23;else if('42"'==s.minValue)var t=24;else if('52"'==s.minValue)var t=25;else if('62"'==s.minValue)var t=26;e.screensized.push({question_id:10,option_id:t})}),e.screensized=_.uniqBy(e.screensized),e.siteinstallslider){if("10mm"==e.siteinstallslider.value)var t=36;else if("40mm"==e.siteinstallslider.value)var t=37;else if("50mm"==e.siteinstallslider.value)var t=38;else if("60mm"==e.siteinstallslider.value)var t=39;else if("others"==e.siteinstallslider.value)var t=40;e.siteinstalldetail={question_id:14,option_id:t}}if(e.projectslider){if("8wks"==e.projectslider.value)var t=48;else if("9wks"==e.projectslider.value)var t=49;else if("10wks"==e.projectslider.value)var t=50;else if("11wks"==e.projectslider.value)var t=51;else if("others"==e.projectslider.value)var t=52;e.projecttimelinedetail={question_id:17,option_id:t}}console.log(s),"sec-sw-impress"==s?(e.testclass="blackbg",e.softwareImpress=!0):"sec-sd-impress"==s?(e.testclass="blackbg",e.doneSub="sub-done",e.sdImpress=!0):"sec-st-impress"==s?(e.stImpress=!0,e.testclass="blackbg"):"sub-custom"==s?(e.stCustom=!0,e.testclass="blackbg"):"sec-si-impress"==s?(e.siteInstall=!0,e.testclass="blackbg"):"sec-pt-impress"==s?(e.ptImpress=!0,e.testclass="blackbg"):"sec-sp-impress"==s?(e.spImpress=!0,e.testclass="blackbg"):"sec-con-impress"==s?(e.connectivity=!0,e.testclass="blackbg"):"sec-cot-impress"==s?(e.content=!0,e.testclass="blackbg"):"sec-sp-find"==s?(e.spFind=!0,e.testclass="blackbg"):"sec-sm-find"==s?(e.scMount=!0,e.testclass="blackbg"):"sec-media-player"==s?(e.mdPlayer=!0,e.testclass="blackbg"):"sec-purpose"==s?(e.purpose=!0,e.testclass="blackbg"):"final-step"==s&&(e.secFinale=!0)},e.innerShow=function(s){console.log(s),"secProposal"==s?e.proposalType=!0:"secOthers"==s?e.proposalType=!1:"matrix-config"==s?(e.matrixConfig=!0,e.screenSize=!0):"screen-size"==s?(e.screenSize=!0,e.matrixConfig=!1):"other-sec"==s?e.otherSec=!0:"other-sec-2"==s&&(e.otherSec2=!0)},e.hideOptions=function(){e.proposalType=!1,e.stCustom=!1,e.matrixConfig=!1,e.screenSize=!1,e.otherSec=!1},e.addScreen=function(){e.sliders.push({value:0,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:'32"'},{value:'42"'},{value:'52"'},{value:'62"'},{value:'72"'}]}}),console.log("$scope.sliders1:",e.sliders)},e.removeScreen=function(s){e.sliders.splice(s,1),e.singleDualslider.splice(s,1)},e.enterValidation=function(){return!0},e.exitValidation=function(){return!0},e.exitValidation=function(e){return"Jacob"===e.firstName},e.exitValidation=function(){var e=$q.defer();return f(function(){return e.resolve(!0)},2e3),e.promise},e.confirmation=function(){console.log("$scope.reqinfo:",e.reqinfo),n.openConfirm({templateUrl:"templateId",scope:e,className:"ngdialog-theme-default",closeByNavigation:"true",closeByDocument:!0})},e.makenewRequest=function(){n.openConfirm({templateUrl:"make-newrequest",scope:e,className:"ngdialog-theme-default",closeByNavigation:"true",closeByDocument:!0})},e.cancelConfirm=function(){l.removeCompanyContact(),n.openConfirm({templateUrl:"confirm-cancel",scope:e,className:"ngdialog-theme-default",closeByNavigation:!0})},e.reqinfo={},e.reqinfo.priortype="Low",e.getPriortype=function(s){e.reqinfo.priortype=s,"Low"==s?e.reqinfo.priority_id=1:"Medium"==s?e.reqinfo.priority_id=2:"High"==s&&(e.reqinfo.priority_id=3)},e.getPriortype(e.reqinfo.priortype),e.reqinfo.due_date=new Date,e.successConfirm=function(){n.close(0),e.isLoading=!0,async.waterfall([function(s){l.getAllReqInfo().then(function(t){var o=h(t.response.result);e.generatedcaseNumber=angular.copy(o),s(null,e.generatedcaseNumber)})},function(s,t){l.saverequestInfo({case_number:s,due_date:e.reqinfo.due_date,expected_delivery_date:e.reqinfo.due_date,complexity:1,remark:e.reqinfo.notes,client_id:e.details.company_id,scheduler:e.user.final_id,priority_id:e.reqinfo.priority_id,request_type_id:1,contact_name:e.person.firstname+e.person.lastname,contact_number_home:e.person.contact_number2,contact_number_work:e.person.mobile,contact_email:e.person.email}).then(function(e){200==e.statusCode&&e.response.success&&t(null,s,e.response.result)})},function(s,t,o){var i=!0;t&&async.each(e.request_card,function(e,s){_.isUndefined(e)?(i=!1,s()):l.saverequestOption(t,e).then(function(e){e?200==e.statusCode&&e.response.success&&(i=!0,s()):(i=!1,s())})},function(e,n){console.log('bolean:"bolean:',i),o(null,s,t,i)})},function(s,t,o,i){o&&l.getPersonDetail(e.user.final_id).then(function(n){200==n.statusCode&&n.response.success&&(i(null,s,t,o,n.response.result),c.set("audience",e.audience),c.set("objectives",e.objectives),l.SaveCompanyTemp(e.details),l.SaveContactTemp(e.person))})},function(s,t,o,i,n){console.log("FILE"),!_.isEmpty(e.files)&&e.files.length>0?(console.log("NAA"),console.log("diri:",e.files),async.eachSeries(e.files,function(s,o){console.log("files:",s),g.upload({url:p+u+"file/"+e.user.final_id+"/upload/"+t,data:{file:s},method:"POST"}).then(function(e){200==e.data.statusCode&&e.data.response.success&&o(e)})},function(e){200==e.data.statusCode&&e.data.response.success&&n(null,s,t,o,i)})):(console.log("WALA MAN"),n(null,s,t,o,i))},function(s,t,o,i,a){console.log("diri"),l.saveRequestStatus(t,{status_id:1,moved_by:e.user.final_id,role:1,module:2,module_item:3,fullname:e.user.displayName,emailaddress:i.email,cardtitle:e.details.name,casenumber:s,remark:e.reqinfo.remark}).then(function(s){200==s.statusCode&&s.response.success&&(r.success(s.response.msg,"Success"),e.isLoading=!1,n.openConfirm({templateUrl:"success-modal",scope:e,className:"ngdialog-theme-default",closeByNavigation:!0,closeByDocument:!1,closeByEscape:!1,showClose:!1}))})}])},e.newRequest=function(){console.log("diri"),n.close(0),n.openConfirm({templateUrl:"confirm-new",scope:e,className:"ngdialog-theme-default",closeByNavigation:!0,closeByDocument:!0})},e.sameCompany=function(){d.reload(),console.log("$scope.audience;",e.audience),console.log("$scope.objectives;",e.objectives),e.setTab(2)},e.newCompany=function(){l.removeCompanyContact(),e.isLoading=!0,n.close(0),f(function(){d.reload(),e.isLoading=!1},2e3)},e.getObjective=function(s){e.audience=s,"151"==s?e.objectAudience="Customers":"152"==s?e.objectAudience="Employees":"153"==s?e.objectAudience="Visitors":"154"==s&&(e.objectAudience=e.objectad),e.audienceobjectdetail={question_id:54,option_id:s}},e.getobjectives=function(s){e.objectives=s,"155"==s?e.requestobject="Drive sales":"156"==s?e.requestobject="Educate":"157"==s?e.requestobject="Internal comms":"158"==s?e.requestobject="Advertising":"159"==s?e.requestobject="Brand awareness":"160"==s&&(e.requestobject=e.objectother),e.requestobjectdetail={question_id:55,option_id:s}},e.designType=function(s){console.log("$scope.files;",e.files),console.log("$scope.files;",e.files),"139"==s?e.designtypes="Renders":"140"==s?e.designtypes="Graphic design":"141"==s?e.designtypes="Solcat":"142"==s?e.designtypes="Visual Design":"143"==s&&(e.designtypes="Email template"),e.designtypedetail={question_id:47,option_id:s}},e.getSolcat=function(s){"145"==s?e.solcats="Standard":"146"==s&&(e.solcats="Custom"),e.solcatdetail={question_id:49,option_id:s},console.log("$scope.solcatdetail;",e.solcatdetail)},e.protoTypespec=function(s){"132"==s?e.protypeSpecific="Web":"133"==s?e.protypeSpecific="Native":"134"==s&&(e.protypeSpecific="Virtual Reality"),e.prototypespecification={question_id:44,option_id:s},console.log("$scope.prototypespecification:",e.prototypespecification)},e.getproPackage=function(s){"135"==s?e.protypePackage="Essential":"136"==s?e.protypePackage="Enhanced":"137"==s&&(e.protypePackage="Premium"),e.prototypePackagedetail={question_id:45,option_id:s}}}angular.module("tessaApp").controller("WizardCtrl",e).value("duScrollBottomSpy",!0).value("duScrollBottomSpy",!0),e.$inject=["$scope","$window","$anchorScroll","$location","$document","ngDialog","FileUploader","rfqFctry","localStorageService","toastr","$state","API_URL_2","API_VERSION","$localForage","$timeout","Upload"]}();
!function(){"use strict";function e(e,s,t,n,o,i,r,a,l,u){console.log("CaseDetailCtrl"),e.user=_.isEmpty(i.get("appuser"))?[]:JSON.parse(i.get("appuser")),console.log("$scope.user;",e.user),e.persons=[],e.details={},e.tab=1,e.display=!1,e.requests=[],e.emojiMessage={},n.case_id&&(t.getCardDetail(n.case_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result[0],e.details.request_info.date_created=moment(e.details.request_info.date_created).format("YYYY-MM-DD"),e.details.request_info.expected_delivery_date=moment(e.details.request_info.expected_delivery_date).format("YYYY-MM-DD"))}),t.getCaseQuestion(n.case_id).then(function(s){200==s.statusCode&&s.response.success&&(console.log("data:",s.response.result),e.requestType=_.find(s.response.result,{question_id:1}),"Proposal"==e.requestType.question_options.option_name&&(e.proposalType=_.find(s.response.result,{question_id:2}),e.solutionperSite=_.find(s.response.result,{question_id:3}),e.deployedSite=_.find(s.response.result,{question_id:4}),e.softwareapplication=_.find(s.response.result,{question_id:6}),e.screenDetail=_.find(s.response.result,{question_id:7}),e.distanceDMP=_.find(s.response.result,{question_id:14}),e.preferredDMP=_.find(s.response.result,{question_id:15}),e.preferredSolution=_.find(s.response.result,{question_id:16}),e.projectimeline=_.find(s.response.result,{question_id:17}),e.supportPackage=_.find(s.response.result,{question_id:18}),e.currentNetwork=_.find(s.response.result,{question_id:19}),e.lanpreference=_.find(s.response.result,{question_id:20}),e.wanpreference=_.find(s.response.result,{question_id:21}),e.contentCreated=_.find(s.response.result,{question_id:22}),e.contentManaged=_.find(s.response.result,{question_id:23}),e.screenType=_.find(s.response.result,{question_id:32}),console.log("$scope.screenType:",e.screenType)),console.log("$scope.requestType:",e.requestType))})),s.getAllPerson(function(s,t){200==t.statusCode&&t.response.success&&(e.persons=t.response.result,e.sample=[],_.each(e.persons,function(s){s.label=s.firstname,e.sample.push({label:s.firstname})}))}),e.setTab=function(s){e.tab=s},e.isSet=function(s){return e.tab===s},e.theTextArea2="Type an @",e.name="sample",e.getAssign=function(s){s&&t.getAssignee(e.details.request_id,{assignee_id:s.person_id,request_index:0,fullname:e.user.displayName,emailaddress:s.email,cardtitle:e.details.request_info.client_details.name,casenumber:e.details.case_number,assignee_name:s.firstname+s.lastname}).then(function(e){console.log("data:",e)})},e.newUploader=function(s){e.attachfiles=s,console.log("$scope.attachfiles:",e.attachfiles)},e.searchPeople=function(s){var t=[];if(null!=e.persons)return angular.forEach(e.persons,function(e){e.displayName.toUpperCase().indexOf(s.toUpperCase())>=0&&t.push(e)}),e.people=t,u.when(t)},e.getPeopleText=function(e){return"[~<i>"+(e.name||e.label)+"</i>]"}}angular.module("tessaApp").controller("CaseDetailCtrl",e),e.$inject=["$scope","APIFactory","rfqFctry","$stateParams","$uibModal","localStorageService","FileUploader","API_URL_2","API_VERSION","$q"]}();
