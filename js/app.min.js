...
!function(){"use strict";function e(e,s,t,l,o,n){e.navClass="big",e.lastScrollTop=0,e.direction="",e.tab=1,e.contactInfo=!1,e.ezefind=!1,e.ezeimpress=!1,e.proposalType=!1,e.secOthers=!1,e.others=!1,e.showDesign=!1,e.showPrototype=!1,e.design=!1,e.prototype=!1,e.others=!1,e.softwareImpress=!1,e.sdImpress=!1,e.stImpress=!1,e.stCustom=!1,e.siteInstall=!1,e.ptImpress=!1,e.spImpress=!1,e.spFind=!1,e.connectivity=!1,e.content=!1,e.renders=!1,e.graphic=!1,e.solcat=!1,e.visual=!1,e.emailtemplate=!1,e.setTab=function(s){var t=angular.element(document.getElementById("wizard-form")),l=angular.element(document.getElementById("request-review"));e.tab=s,t.scrollTo(l,0,1e3)},e.isSet=function(s){return e.tab===s},e.showProposalType=function(){e.proposalType=!0},e.activeOption=function(){e.isActiveOption=value,"Hardware"==value},e.scrollTo=function(e){l.hash(e),t()},e.getValue=function(s){console.log(s),e.value=s},e.addRequest=function(s){console.log(s);var t=angular.element(document.getElementById("wizard-form")),l=angular.element(document.getElementById("rdImpress")),a=angular.element(document.getElementById("design")),c=angular.element(document.getElementById("prototype")),r=angular.element(document.getElementById("others")),i=angular.element(document.getElementById("renders")),m=angular.element(document.getElementById("graphics")),p=angular.element(document.getElementById("solcat")),u=angular.element(document.getElementById("visual")),d=angular.element(document.getElementById("email"));"ezeimpress"==s?(e.ezeimpress=!0,t.scrollTo(l,0,1e3),e.testclass="blackbg",e.ezefind=!1,e.design=!1,e.others=!1,n(function(){o.scrollTo(section2,30,1e3)},500),e.prototype=!1):"ezefind"==s?(e.ezeimpress=!1,e.ezefind=!0,t.scrollTo(l,0,1e3),e.testclass="blackbg",e.design=!1,e.others=!1,e.prototype=!1):"prototype"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!1,e.others=!1,e.prototype=!0,t.scrollTo(c,0,1e3),e.testclass="blackbg"):"design"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!0,e.others=!1,e.prototype=!1,t.scrollTo(a,0,1e3),e.testclass="blackbg"):"others"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!1,e.others=!0,e.prototype=!1,t.scrollTo(r,0,1e3),e.testclass="blackbg"):"renders"==s?(e.renders=!0,e.graphics=!1,e.visual=!1,e.solcat=!1,e.emailtemplate=!1,t.scrollTo(i,0,1e3),e.testclass="blackbg"):"graphics"==s?(e.renders=!1,e.graphics=!0,e.visual=!1,e.solcat=!1,e.emailtemplate=!1,t.scrollTo(m,0,1e3),e.testclass="blackbg"):"solcat"==s?(e.renders=!1,e.graphics=!1,e.visual=!1,e.solcat=!0,e.emailtemplate=!1,t.scrollTo(p,0,1e3),e.testclass="blackbg"):"visual"==s?(e.renders=!1,e.graphics=!1,e.visual=!0,e.solcat=!1,e.emailtemplate=!1,t.scrollTo(u,0,1e3),e.testclass="blackbg"):"email"==s?(e.renders=!1,e.graphics=!1,e.visual=!1,e.solcat=!1,e.emailtemplate=!0,t.scrollTo(d,0,1e3),e.testclass="blackbg"):"contact-info"==s&&(e.testclass="blackbg",e.contactInfo=!0)},e.innerForm=function(s){console.log(s),"sec-sw-impress"==s?(e.testclass="blackbg",e.softwareImpress=!0):"sec-sd-impress"==s?(e.testclass="blackbg",e.sdImpress=!0):"sec-st-impress"==s?(e.stImpress=!0,e.testclass="blackbg"):"sub-custom"==s?(e.stCustom=!0,e.testclass="blackbg"):"sec-si-impress"==s?(e.siteInstall=!0,e.testclass="blackbg"):"sec-pt-impress"==s?(e.ptImpress=!0,e.testclass="blackbg"):"sec-sp-impress"==s?(e.spImpress=!0,e.testclass="blackbg"):"sec-con-impress"==s?(e.connectivity=!0,e.testclass="blackbg"):"sec-cot-impress"==s?(e.content=!0,e.testclass="blackbg"):"sec-sp-find"==s&&(e.spFind=!0,e.testclass="blackbg")},e.innerShow=function(s){console.log(s),"secProposal"==s?e.proposalType=!0:"secOthers"==s&&(e.proposalType=!1)},e.hideOptions=function(){e.proposalType=!1,e.stCustom=!1},e.detail={},e.slider={value:2,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:"10mm"},{value:"40mm"},{value:"50mm"},{value:"60mm"},{value:"others"}]}},e.enterValidation=function(){return!0},e.exitValidation=function(){return!0},e.exitValidation=function(e){return"Jacob"===e.firstName},e.exitValidation=function(){var e=$q.defer();return n(function(){return e.resolve(!0)},2e3),e.promise};var a=document.getElementById("wizard-form");$(a).scroll(function(){e.st=$(this).scrollTop(),e.st>e.lastScrollTop?(console.log("down ni jul"),e.navClass="small"):(console.log("up ni jul"),e.navClass="big"),e.lastScrollTop=e.st,e.$apply(),console.log(e.direction)})}angular.module("tessaApp").value("duScrollOffset",30).value("duScrollActiveClass","qtn-ctn").controller("ExperimentCtrl",e),e.$inject=["$scope","$window","$anchorScroll","$location","$document","$timeout"]}();
