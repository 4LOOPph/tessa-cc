...
!function(){"use strict";function e(e,t,r,a,o,i,c,l,s,n,u){function p(e){return o.map(e,function(e){if("location"==e.type){var t=e.label.replace(/[\s]/g,"");return{label:t.toLowerCase(),type:e.type,index:e.sortindex}}if("configuration"==e.type){var r=e.label.replace(/[\s]/g,"");return{label:r.toLowerCase(),type:e.type,index:e.sortindex}}return e})}function d(t){e.cablelength=a("filter")(t,{attribute:"Cable Length"}),console.log("$scope.cablelength:",e.cablelength),e.framerate=a("filter")(t,{attribute:"Frame Rate (Max)"}),console.log("$scope.framerate:",e.framerate),e.opticalreso=a("filter")(t,{attribute:"Optical Resolution"}),console.log("$scope.opticalreso:",e.opticalreso),e.usbprotocol=a("filter")(t,{attribute:"USB Protocol"}),console.log("$scope.usbprotocol:",e.usbprotocol),e.usbspeed=a("filter")(t,{attribute:"USB Speed"}),console.log("$scope.usbspeed:",e.usbspeed),e.ScreenSize=a("filter")(t,{attribute:"Screen Size"}),console.log("$scope.ScreenSize:",e.ScreenSize),e.Brightness=a("filter")(t,{attribute:"Brightness"}),console.log("$scope.Brightness:",e.Brightness),e.Bezel=a("filter")(t,{attribute:"Bezel Size"}),console.log("$scope.Bezel:",e.Bezel),e.Usage=a("filter")(t,{attribute:"Usage"}),console.log("$scope.Usage:",e.Usage),e.Displaytechno=a("filter")(t,{attribute:"Display Technology"}),console.log("$scope.Displaytechno:",e.Displaytechno),e.weight=a("filter")(t,{attribute:"Weight"}),console.log("$scope.weight:",e.weight),e.Ram=a("filter")(t,{attribute:"RAM"}),console.log("$scope.Ram:",e.Ram),e.Storage=a("filter")(t,{attribute:"Storage"}),console.log("$scope.Storage:",e.Storage),e.Graphics=a("filter")(t,{attribute:"Graphics"}),console.log("$scope.Graphics:",e.Graphics),e.Resolution=a("filter")(t,{attribute:"Maximum Resolution"}),console.log("$scope.Resolution:",e.Resolution),e.dimensions=a("filter")(t,{attribute:"Dimensions"}),console.log("$scope.dimensions:",e.dimensions),e.orientation=a("filter")(t,{attribute:"Orientation"}),console.log("$scope.orientation:",e.orientation),e.orientation=o.uniqBy(e.orientation,function(e){return e.value}),e.orientation=o.each(e.orientation,function(e){e.values=e.value.split(",")}),e.ori=[],o.each(e.orientation,function(t){o.map(t.values,function(t){o.each(e.orient,function(r){t==r.label&&e.ori.push(r)})})}),e.displayinterface=a("filter")(t,{attribute:"Display Interface"}),e.vesa=a("filter")(t,{attribute:"Vesa"}),e.screentype=a("filter")(t,{attribute:"Screen type"}),e.resolution=a("filter")(t,{attribute:"Resolution"})}function h(t,r,a,i){e.index=[];var c=[];return"Hardware"==e.prodTypeLabel?o.isEmpty(a)?t:o.isEmpty(t)?t:r>0?(o.each(a,function(e,r){return c=o.filter(t,function(t){return o.some(t.attributes,function(t){return t.value==e.value})}),a.splice(r,1),!1}),r-=1,h(c,r,a,i)):i:o.isEmpty(a)?t:o.isEmpty(t)&&!o.isEmpty(a)?t:r>0?(o.each(a,function(e,r){var i=o.filter(t,function(t){return t.hardware.some(function(t){return o.some(t.attributes,function(t){return t.value==e.value})})}),l=o.filter(t,function(t){return o.some(t.tags,{tags:e.label})});return o.isEmpty(i)?o.isEmpty(l)||(c=l):c=i,a.splice(r,1),!1}),r-=1,h(c,r,a,i)):i}e.prodTypeLabel=o.isEmpty(s.get("label"))?"Solution":JSON.parse(s.get("label")),e.solutionTypes=o.isEmpty(s.get("solutiontype"))?"EzeImpress":JSON.parse(s.get("solutiontype")),console.log("$scope.prodTypeLabel:",e.prodTypeLabel),e.filterhide=!1,e.datas=[],e.loadMore=function(){t.getProducts(0,10,function(t,r){200==r.statusCode&&r.response.success&&(e.datas=[],console.log("data:",r))})},e.loadMore(),e.count=0,e.txtSearch="",e.bundles=[],e.productDetails=[],e.seemore=!0,e.solutions=[],e.SolutionCategory=[],e.productscopy=[],e.ezewificopy=[],e.categoryWifi=[],e.screens=[],e.Screens=[],e.ScreenSize=[],e.media=[],e.MediaPlayer=[],e.Mediacopy=[],e.bundleTags=[],e.searchcopy=[],e.filtercopy=[],e.typeselected=[],e.tagselected=[],e.productsAttributesValue=[],e.hardwareType=o.isEmpty(s.get("hardtype"))?"Screens":JSON.parse(s.get("hardtype")),e.solutionTypes=o.isEmpty(s.get("solutiontype"))?"EzeImpress":JSON.parse(s.get("solutiontype")),e.location=[{_id:8,label:"Indoor",type:"location"},{_id:9,label:"Outdoor",type:"location"},{_id:10,label:"Semi Outdoor",type:"location"}],e.config=[{_id:11,label:"Wall Mounted",type:"configuration"},{_id:12,label:"Floor Mounted",type:"configuration"}],e.usages=[{_id:13,label:"24/7",type:"usages"},{_id:14,label:"16/7",type:"usages"}],e.orient=[{_id:15,label:"Landscape",type:"orientation"},{_id:16,label:"Portrait",type:"orientation"},{_id:17,label:"Custom",type:"orientation"}],e.dynamicPopover={vesa:"vesa.html",bezel:"bezel.html",usage:"usage.html",weight:"weight.html",mounting:"configuration.html",location:"location.html",dimensions:"dimensions.html",screensize:"screens.html",brightness:"brightness.html",screentype:"screentype.html",resolution:"resolution.html",orientation:"orientation.html",templateUrl7:"wifi.html",templateUrl8:"ram.html",orientation1:"ori.html",templateUrl9:"displaytechno.html",displaytechno:"displaytechno.html",displayinterface:"displayinterface.html",templateUrlStorage:"storage.html",templateUrlGraphics:"graphics.html",templateUrlResolution:"resolutions.html",cablelength:"cablelength.html",framerate:"framerate.html",opticalreso:"opticalreso.html",usbprotocol:"usbprotocol.html",usbspeed:"usbspeed.html"},e.sample={sam:"screens.html"},e.infiniteScrollData={},e.infiniteScrollData.numToAdd=10,e.infiniteScrollData.currentItems=10,e.resetInfScroll=function(){e.infiniteScrollData.currentItems=e.infiniteScrollData.numToAdd},e.addMoreItems=function(){e.infiniteScrollData.currentItems+=e.infiniteScrollData.numToAdd};var y=function(){async.waterfall([function(r){t.getProductBundle(function(t,i){var c=[],l=[];e.solutions=o.filter(i.response.result,function(e){if(1==e.is_published&&0==e.is_archived)return e}),l=o.flattenDeep(o.map(e.solutions,function(e){return void 0!=e.product_bundle_category[0]&&c.push(e.product_bundle_category[0]),e.products.length>0||(e.weekly=0),e.products})),e.bundlecategory=c,console.log("$scope.bundlecategory;",e.bundlecategory),o.each(l,function(e){e.product_detail&&(e.productType_id=e.product_detail.productType_id,e.sell_price=e.product_detail.sell_price,e.product_detail.product_category.length>0&&(e.category_id=e.product_detail.product_category[0].category_id,e.category_label=e.product_detail.product_category[0].category_label))});var s=o.groupBy(l,"pb_id");o.map(s,function(t,r){var i=a("filter")(t,{productType_id:18}),c=a("filter")(t,{productType_id:17}),l=a("filter")(t,{productType_id:20});if(parseInt(r)==parseInt(r)){if((c.length>0||i.length>0)&&(e.resulthardwaresum=o.sum(o.map(c,function(e){return e.sell_price*e.quantity})),e.softwaresum=o.sum(o.map(i,function(e){return e.sell_price*e.quantity}))),l.length>0){var s=a("filter")(l,{category_id:87}),n=a("filter")(l,{category_id:90});(s.length>0||n.length>0)&&(e.deploymentservice=o.sum(o.map(s,function(e){return e.sell_price*e.quantity})),e.supportservice=o.sum(o.map(n,function(e){return e.sell_price*e.quantity}))),e.servicesum=o.sum(o.map(l,function(e){return e.sell_price*e.quantity}))}void 0==e.deploymentservice&&void 0==e.supportservice?(e.deploymentservice=0,e.supportservice=0):(e.deploymentservice,e.supportservice);var u=e.deploymentservice+e.softwaresum+e.resulthardwaresum;e.weekly=12*(31.111*u/1e3+e.supportservice)/52}o.each(e.solutions,function(t){t.pb_id==parseInt(r)&&(t.weekly=e.weekly,t.software=i,t.hardware=c,t.support=n,t.upfront=u,t.spPrice=o.sum(o.map(n,function(e){return e.sell_price*e.quantity})))})}),o.each(e.solutions,function(e){e.product_bundle_category.length>0&&(e.category_label=e.product_bundle_category[0].category_label,e.category_id=e.product_bundle_category[0].category_id)}),r(null,e.solutions)})},function(e,t){var r=[];o.each(e,function(e){o.each(e.hardware,function(e){r.push(e)})}),t(null,e,r)},function(e,r,a){var o=[];async.each(r,function(e,r){t.getProductAttribute(e.product_id,function(e,t){t?200==t.statusCode&&t.response.success&&(o.push(t.response.result),r()):r()})},function(t,i){a(null,e,r,o)})},function(t,r,a,i){var c=o.groupBy(a,"p_id");o.each(r,function(e){o.map(c,function(t,r){r&&o.each(t,function(t){if(t.attribute_values.length>0){var a=o.find(t.attribute_values,{is_comparable:1});o.isUndefined(a)&&r?parseInt(r)==e.product_id&&(e.comparable=0,e.attributes=t.attribute_values):parseInt(r)==e.product_id&&(e.comparable=1,e.attributes=t.attribute_values)}else parseInt(r)==e.product_id&&(e.comparable=0)})})});var l=o.groupBy(r,"pb_id");o.each(t,function(e){o.map(l,function(t,r){if(e.pb_id==r&&e.hardware){var a=o.filter(t,{comparable:1});a.length>0?e.comparable=1:e.comparable=0,e.hardware=t}})}),e.EzeImpress=t,e.productscopy=angular.copy(e.EzeImpress),e.ezewificopy=angular.copy(e.categoryWifi)}])},f=function(){async.waterfall([function(r){t.getProduct(function(t,a){e.allproducts=a.response.result,e.hardware=o.filter(e.allproducts,function(e){return"Hardware"===e.product_type}),e.hardwarecategory=[];var i=o.filter(e.hardware,function(e){if(1==e.is_published&&0==e.is_archived)return e});o.each(i,function(t){t.product_category.length>0&&e.hardwarecategory.push(t.product_category)}),e.hardwarecategory=o.flattenDeep(e.hardwarecategory),console.log("$scope.hardwarecategory:",e.hardwarecategory),r(null,i)})},function(r,a){async.each(r,function(e,r){t.getProductAttribute(e.p_id,function(t,a){if(a){if(200==a.statusCode&&a.response.success&&e.p_id==a.response.result.p_id){var o=a.response.result.attribute_values;o&&o.length>0?e.attributes=a.response.result.attribute_values:e.attributes=[],r()}}else r()})},function(t,i){e.hardwares=r,e.hardwarecopy=angular.copy(e.hardwares),o.each(e.hardwares,function(e){var t=o.filter(e.attributes,{is_comparable:1});t.length>0?e.comparable=1:e.comparable=0}),console.log("$scope.hardwares;",e.hardwares),a(null,r,e.hardwares,a)})},function(t,r,a){var i=[];o.each(r,function(e){e.attributes.length>0&&i.push(e.attributes)}),e.allattributes=o.flattenDeep(i),e.allattributes=o.flattenDeep(e.allattributes),console.log("$scope.groupall:",e.groupall),d(e.allattributes)}])};e.toggleSelectedType=function(t){console.log("type:",t);var r=t,a=[];if("Hardware"==e.prodTypeLabel)e.tagselected.indexOf(r)==-1?e.tagselected.push(r):e.tagselected=o.filter(e.tagselected,function(e){return e._id!=r._id}),a=p(e.tagselected),!o.isEmpty(e.txtSearch)&&e.searchmedia?e.hardwares=h(e.searchmedia,a.length,a,e.searchmedia):e.hardwares=h(e.copy_hardware,a.length,a,e.copy_hardware),e.filterhardware=angular.copy(e.hardwares);else{console.log("DIRI");var i=[],c=[];if(o.each(e.productscopy,function(e){e.hardware?e.hardware.length>0&&o.each(e.hardware,function(e){i.push(e)}):e.hardware=[]}),o.each(e.copyscreen,function(e){o.isNull(e.attributes)||c.push(e.attributes)}),c=o.flattenDeep(c),e.ezehards=angular.copy(i),e.attrib=angular.copy(c),"Eze Impress"==e.solutionTypes){e.typeselected.indexOf(r)==-1?e.typeselected.push(r):e.typeselected=o.filter(e.typeselected,function(e){return e._id!=r._id}),o.map(e.productscopy,function(t){o.each(t.tags,function(t){o.isEmpty(t.tags)||e.bundleTags.push(t)})});e.typeselected.length;a=p(e.typeselected),o.each(e.EzeImpress,function(e){o.each(e.tags,function(e){e.tags=e.tags.replace(/[\[\](){}?*+\^$\\.|\-|\s]/g,"")})}),!o.isEmpty(e.txtSearch)&&e.searchcopy?e.EzeImpress=h(e.searchcopy,a.length,a,e.searchcopy):e.EzeImpress=h(e.solutionscopy,a.length,a,e.solutionscopy),e.filtercopy=angular.copy(e.EzeImpress)}}},e.refresh=function(){l.$broadcast("loading:progress"),n(function(){f(),y()},200),l.$broadcast("loading:finish")},e.uncheck=function(t,r){t.checked&&("Hardware"==e.prodTypeLabel?(o.each(e.tagselected,function(e){e._id==t._id&&(e.checked=!1)}),"MediaPlayer"==e.hardwareType?e.toggleSelectedType(t):e.toggleSelectedType(t)):(o.each(e.typeselected,function(e){e._id==t._id&&(e.checked=!1)}),e.toggleSelectedType(t)))},e.searchData=function(){if(l.$broadcast("loading:progress"),"Solution"==e.prodTypeLabel){n(function(){t(),l.$broadcast("loading:finish")},600);var t=function(){o.isEmpty(e.txtSearch)?o.isEmpty(e.filtercopy)?e.EzeImpress=e.solutionscopy:e.EzeImpress=e.filtercopy:(o.isEmpty(e.typeselected)?n(function(){console.log("$scope.solutionscopy;",e.solutionscopy),e.EzeImpress=a("filter")(e.solutionscopy,e.txtSearch),console.log("$scope.EzeImpress:",e.EzeImpress),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300):o.isEmpty(e.typeselected)||n(function(){e.EzeImpress=a("filter")(e.filtercopy,e.txtSearch),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300),e.searchcopy=angular.copy(e.EzeImpress))}}else{n(function(){t(),l.$broadcast("loading:finish")},600);var t=function(){o.isEmpty(e.txtSearch)?o.isEmpty(e.filterhardware)?e.hardares=e.copy_hardware:e.hardwares=e.filterhardware:o.isEmpty(e.tagselected)?n(function(){e.hardwares=a("filter")(e.copy_hardware,e.txtSearch),e.searchcopyhardware=angular.copy(e.hardwares),u.trackEvent("Category Search","search",e.txtSearch,e.hardwares.length)},300):o.isEmpty(e.tagselected)||n(function(){e.hardwares=a("filter")(e.filterhardware,e.txtSearch),e.searchcopyhardware=angular.copy(e.hardwares),u.trackEvent("Category Search","search",e.txtSearch,e.hardwares.length)},300)}}},e.clearfilter=function(){"Solution"==e.prodTypeLabel?(o.isEmpty(e.txtSearch)&&o.isEmpty(e.typeselected)||(e.txtSearch="",o.forEach(e.typeselected,function(e){e.checked=!1}),e.typeselected.splice(e.typeselected)),e.activateTab(e.solutionTypes)):o.isEmpty(e.txtSearch)&&o.isEmpty(e.tagselected)||(e.txtSearch="",o.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.activeHard(e.hardwareType))},e.$watch("prodTypeLabel",function(t){0==e.count&&e.activeProd(t)}),e.activeProd=function(t){console.log("hagas"),e.filterhide=!1,e.count++,e.prodTypeLabel=t,console.log("$scope.count:",e.count),"Hardware"==t?(e.count>=1&&f(),o.isEmpty(e.txtSearch)&&o.isEmpty(e.typeselected)||(e.txtSearch="",o.forEach(e.typeselected,function(e){e.checked=!1}),e.typeselected.splice(e.typeselected),e.EzeImpress=e.productscopy),e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.hardwareType)):(console.log("Solution"),1==e.count?e.refresh():e.count>1&&y(),o.isEmpty(e.txtSearch)&&o.isEmpty(e.tagselected)||(e.txtSearch="",o.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.hardwares=angular.copy(e.copy_hardware)),e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.solutionTypes)),s.set("label",JSON.stringify(e.prodTypeLabel))},e.activateTab=function(t){e.solutionTypes=t,"Eze Wifi"==t?e.filterhide=!1:e.filterhide=!0,console.log("name:",t),e.EzeImpress=o.filter(e.productscopy,function(e){return e.category_label==t}),e.solutionscopy=angular.copy(e.EzeImpress),console.log("$scope.EzeImpress:",e.EzeImpress),e.seemore=!0},e.activeHard=function(t){e.filterhide=!0,e.hardwareType=t,e.allattributes=[],e.hardwares=o.filter(e.hardwarecopy,function(e){return o.some(e.product_category,function(e){return e.category_label==t})}),e.copy_hardware=angular.copy(e.hardwares),o.each(e.hardwares,function(t){t.attributes.length>0&&e.allattributes.push(t.attributes)}),e.allattributes=o.flattenDeep(e.allattributes),e.groupall=o.groupBy(e.allattributes,"attribute"),d(e.allattributes)},e.solutionsEzeImpress=function(e){u.trackEvent("Productcatalogue","click","Solution",o.toString(e.pb_id))},e.solutionsEzeWifi=function(e){u.trackEvent("Productcatalogue","click","Solution",o.toString(e.pb_id))},e.hardwareScreens=function(e){u.trackEvent("Productcatalogue","click","Hardware",o.toString(e.p_id))},e.hardwareMediaplayer=function(e){u.trackEvent("Productcatalogue","click","Hardware",o.toString(e.p_id))},e.togglemodal=function(e){var t=i.open({animation:!0,templateUrl:"./views/share.modal.html",controller:"articleCtrl",size:"sm",resolve:{article:function(){return e}}});t.result.then(function(){c.reload()},function(){console.info("Modal dismissed")})}}angular.module("tessaApp").controller("productCtrl",e),e.$inject=["$scope","APIFactory","$location","$filter","_","$uibModal","$state","$rootScope","localStorageService","$timeout","$frontierAnalytics"]}();
...
!function(){"use strict";function e(e,t,i,a,r,l,s,c,n,o,g,u,d,f){t.refresh=function(){f.gallery.refresh()},t.angularGridoptions={cssGrid:!0,refreshOnImgLoad:!1,gridWidth:350,gutterSize:20},t.seemore=!0,t.date=new Date,s.user=r.isEmpty(o.get("User"))?[]:JSON.parse(o.get("User")),t.expFilter=r.isEmpty(o.get("articlefilter"))?"all":JSON.parse(o.get("articlefilter")),console.log("$scope.expFilter:",t.expFilter),t.selectedItem=[],t.articlesList=[],t.lists=[],t.tags=[],t.tagscopy=[],t.Portfolio=[],t.Article=[],t.selectedTag=[],t.tagselected=[],t.pageNumber=1,t.limitWithPage=10,t.totalPages=0,t.dynamicPopover={templateUrl:"myPopoverTemplate.html",backdrop:"static",keyboard:!1},t.pdf={file:null,thumbnail:""},t.loadmore=!1,t.showLoadMore=!1,t.addMoreItems=function(){t.loadmore=!0,t.pageNumber<t.totalPages&&(t.pageNumber=t.pageNumber+1),t.generateArticles()},t.repeatEnd=function(){t.showLoadMore=!0},t.generateArticles=function(){t.tags=[],t.tagscopy=[],t.lists=[],t.selectedTag=[],i.getArticles({startWith:t.pageNumber-1,limit:t.limitWithPage},function(e,i){if(200==i.statusCode&&i.response.success){t.totalPages=i.response.pagination.pages,r.each(i.response.result,function(e){e.name=e.title,e.type="Experience",e.tags.length>=1&&1==e.is_active&&t.articlesList.push(e)}),t.articlesList=r.map(r.orderBy(t.articlesList,"date_created")).reverse(),r.each(t.articlesList,function(e){t.tags.push(e.tags)}),t.tagss=r.flattenDeep(t.tags),t.tags=r.uniqBy(t.tagss,function(e){return e.tags}),r.each(t.articlesList,function(e){if(e.mediafiles.length>0&&(e.image=e.mediafiles[0].media_path),!r.isNull(e.thumbnail_media)){var t=e.article_thumbnail;if(t){if("video/mp4"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-flv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-msvideo"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-ms-wmv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/quicktime"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"}}}),t.tagscopy=angular.copy(t.tags),t.lists=angular.copy(t.articlesList);var a=c("filter")(t.tags,{tags:"Portfolio"}),l=c("filter")(t.tags,{tags:"Article"});a&&r.each(a,function(e){var i=r.find(t.lists,{article_id:e.article_id});t.Portfolio.push(i),r.each(t.articlesList,function(t){t.article_id==e.article_id&&(t.article_type=e.tags)})}),l&&r.each(l,function(e){var i=r.find(t.lists,{article_id:e.article_id});t.Article.push(i),r.each(t.articlesList,function(t){t.article_id==e.article_id&&(t.article_type=e.tags)})}),t.pageNumber>=t.totalPages?(t.loadmore=!1,t.showLoadMore=!1):t.loadmore=!1}})},t.clearAll=function(){console.log("clear:",t.tagselected),r.each(t.tagselected,function(e){e.checked=!1}),t.tagselected.splice(t.tagselected)},t.product=function(){o.remove("label"),o.remove("hardtype"),l.go("main.productCatalogue")},t.toggleSelectedTag=function(e){t.event=["Filter by Industry","click",e.tags,r.toString(e.tags_id)],t.tagselected.indexOf(e)==-1?t.tagselected.push(e):t.tagselected=r.filter(t.tagselected,function(t){return t.tags_id!=e.tags_id})},t.trackExperienceArticles=function(e){u.trackEvent("Experience","View",e.title,r.toString(e.article_id))},t.trackExperiencePortfolio=function(e){u.trackEvent("Experience","View",e.title,r.toString(e.article_id))},t.trackExperienceAll=function(e){u.trackEvent(e.type,"View",e.title,r.toString(e.article_id))},t.isTagSelected=function(e){return t.tagselected.indexOf(e)!==-1},t.isOnSelectedTag=function(){return function(e){if(!(t.tagselected.length>0))return!0;var i=!1,a=r.map(t.tagselected,"tags_id");r.forEach(e.tags,function(e){a.indexOf(e.tags_id)!==-1&&(i=!0)});return i}},t.filterArticle=function(e){if(t.expFilter=e,o.set("articlefilter",JSON.stringify(t.expFilter)),"all"==t.expFilter)t.articlesList=angular.copy(t.lists);else{t.articlesList=[];var i=c("filter")(t.tagss,{tags:t.expFilter});r.each(i,function(e){var i=r.find(t.lists,{article_id:e.article_id});t.articlesList.push(i)}),console.log("filter:",t.articlesList)}},t.$watch("expFilter",function(e){g(function(){if("all"==e)t.articlesList=angular.copy(t.lists);else{t.articlesList=[];var i=c("filter")(t.tagss,{tags:e});r.each(i,function(e){var i=r.find(t.lists,{article_id:e.article_id});t.articlesList.push(i)})}},600)}),t.$on("$stateChangeSuccess",function(e,i,a,r,l){"main.experience"==i.name&&(t.tagselected=[],t.generateArticles())})}angular.module("tessaApp").service("imageService",["$q","$http",function(e,t){this.loadImages=function(){return t.jsonp("https://api.flickr.com/services/feeds/photos_public.gne?format=json&jsoncallback=JSON_CALLBACK")}}]).controller("expCtrl",e),e.$inject=["$http","$scope","APIFactory","$location","_","$state","$rootScope","$filter","$uibModal","localStorageService","$timeout","$frontierAnalytics","imageService","angularGridInstance"]}();
