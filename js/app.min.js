...
!function(){"use strict";function e(e,t,s,o,n,a,r,i,u,l){e.currentDate=moment(new Date).format("YYYY-MM-DD"),e.requests=[],e.roles=[],e.samples=[],e.user=_.isEmpty(u.get("appuser"))?[]:JSON.parse(u.get("appuser"));e.user.roles=[],e.isLoading=!1,e.persons=[];var c=function(){async.waterfall([function(t){e.isLoading=!0,i.getAllReqInfo().then(function(s){if(200==s.statusCode&&s.response.success){e.requests=s.response.result,console.log("$scope.requests:",e.requests),_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),t(),e.copyrequest=angular.copy(s.response.result)}})},function(t){i.getAllPersons().then(function(s){if(200==s.statusCode&&s.response.success){var o=_.find(s.response.result,{displayName:e.user.displayName});e.user.role_name=o.type_name,e.user.final_id=o.person_id,e.user&&i.userRule({usertype:e.user.role_name}).then(function(t){200==t.statusCode&&t.response.success&&(e.roles=angular.copy(t.response.result),e.user.roles=t.response.result,e.rolesgroup=_.groupBy(e.roles,"module_name")),e.isLoading=!1}),t()}})}])};e.isClick=function(e){},e.sortBy=function(t,s){console.log("$scope.copyfilterRequest;",e.copyfilterRequest),console.log("name;",t),console.log("value;",s),_.isEmpty(e.copyfilterRequest)?"Ascending"==t?i.filterByField({sortbyfield:s.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})})}}):i.filterByField({sortbyfield:"-"+s.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})})}}):"Ascending"==t?i.filterByField({sortbyfield:s.toString(),filterbyfield:e.filtername.toString()+"="+e.filtervalue.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})})}}):i.filterByField({sortbyfield:"-"+s.toString(),filterbyfield:e.filtername.toString()+"="+e.filtervalue.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})})}})},e.formatString=function(e){var t=e.split("."),s=parseInt(t[0]),o=parseInt(t[1]),n=parseInt(t[2]),a=new Date(s,o-1,n);return a},e.dayDiff=function(t,s){var o=t.replace(/-/g,"."),n=s.replace(/-/g,"."),a=new Date(e.formatString(n)),r=new Date(e.formatString(o)),i=Math.abs(r.getTime()-a.getTime()),u=Math.ceil(i/864e5);return u},e.sortDisplay=function(t){var s=_.filter(e.copyrequest,function(e){return"completed"==e.status_name});console.log("cardcompletes:",s),s.length>0&&(e.isLoading=!0,o(function(){var t=r.open({animation:!0,templateUrl:"./views/request.dashboard/filter.modal.html",windowClass:"xd-modal",controller:"optionCtrl",resolve:{complete_cards:function(){return s}}});e.isLoading=!1,t.result.then(function(t){e.isLoading=!0,console.log("selectedItem:",t);var s=_.groupBy(t,"status_name");console.log("requestgroup;",s),_.each(e.models,function(t){_.map(s,function(e,s){t.listName.toLowerCase()==s&&(t.items=e)}),e.isLoading=!1},500)},function(){console.log("dismiss:")})},500))},e.getFilter=function(t,s){if(e.copyfilterRequest=[],e.filtername=t,e.filtervalue=s,_.each(e.models,function(e){e.items=[]}),"All"==t&&_.isUndefined(s)){e.filtervalue=" ",e.filtername=" ",e.copyfilterRequest=[],e.requests=e.copyrequest;var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})})}else i.filterByField({filterbyfield:t.toString()+"="+s.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=angular.copy(t.response.result),console.log("$scope.requests;",e.requests),_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),e.copyfilterRequest=angular.copy(e.requests)}})},e.gotoBottom=function(){n.hash("bottom"),a()},e.models=[{id:1,listName:"to do",image:"../images/icons/rd-status-icon--03.svg",items:[],datezz:!1,pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:2,listName:"in progress",image:"../images/icons/rd-status-icon--05.svg",items:[],datezz:!0,pri:"Low",req:"Adarna",assignee:"Bangs",dragging:!1},{id:3,listName:"blocked",image:"../images/icons/rd-status-icon--06.svg",items:[],datezz:!1,pri:"High",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:5,listName:"for review",image:"../images/icons/rd-status-icon--07.svg",items:[],datezz:!1,pri:"Medium",req:"Adarna",assignee:"Bangs",dragging:!1},{id:4,listName:"completed",image:"../images/icons/rd-status-icon--08.svg",items:[],datezz:!1,pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1}],e.getSelectedItemsIncluding=function(e,t){return t.selected=!0,e.items.filter(function(e){return e.selected})},e.dragoverCallback=function(e,t,s,o){return e<10},_.each(e.models,function(e){"completed"==e.listName?(e.showupdate=!1,e.allow=["not"]):(e.showupdate=!0,e.allow=["can"])}),e.onDragstart=function(t,s){e.sam=!0,"in progress"==t.listName?_.each(e.models,function(e){"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.place=!1,e.allow=["not"]):(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"to do"==t.listName?_.each(e.models,function(e){"for review"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"blocked"==t.listName?_.each(e.models,function(e){"to do"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):(_.each(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"for review"==t.listName&&_.each(e.models,function(e){"blocked"==e.listName?(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0):"completed"==e.listName?(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0):(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1)}),t.dragging=!0},c(),e.isAuthorize=function(t){var s=_.find(e.user.roles,{module_item_name:t});if(!_.isUndefined(s)||!_.isNull(s))return!(!s.isAuthorized||1!=s.isAuthorized)},e.dragend=function(t,s){t.dragging=!1,_.each(e.models,function(e){e.place=!1}),e.logEvent(t,s)},e.onDrop=function(t,s,n,a){_.each(e.models,function(e){e.place=!1}),a.length>1?(_.each(a,function(t){t.status_name.toLowerCase()!==n.listName.toLowerCase()?e.check=!0:e.check=!1}),e.check&&(e.isAuthorize(t)&&e.isAuthorize(n.listName.toLowerCase())?e.updateStatus(t,n,a):l.error("Anauthorize","Error"),e.isLoading=!1)):n&&_.each(a,function(s){s.status_name.toLowerCase()!==n.listName.toLowerCase()&&async.waterfall([function(t){e.isLoading=!0,t()},function(s){o(function(){e.isAuthorize(t)&&e.isAuthorize(n.listName.toLowerCase())?e.updateStatus(t,n,a):l.error("Anauthorize","Error"),e.isLoading=!1},1e3)}])})},e.logEvent=function(t,s){s.selected=!s.selected;_.each(e.models,function(e){_.some(e.items,function(e){e.request_id===s.request_id&&e.$$hashKey===s.$$hashKey||(e.selected=!1)})})},e.onMoved=function(e,t){e.items=e.items.filter(function(e){return!e.selected})};e.$watch("models",function(t){e.completecards=_.find(t,{listName:"completed"}),e.modelAsJson=angular.toJson(t,!0)},!0),e.manualupdateStatus=function(t,o){var n=r.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"manualstatusUpdateCtrl",resolve:{list:function(){return e.models},item:function(){return o},user_roles:function(){return e.user},status:function(){return e.models}}});n.result.then(function(e){console.log("response: ",e),"save"==e&&s.reload()})},e.updateStatus=function(t,o,n){var a=r.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"statusUpdateCtrl",resolve:{action:function(){return t},items:function(){return n},user_roles:function(){return e.user},list:function(){return o}}});a.result.then(function(t){"save"==t?s.reload():e.isLoading=!1})},e.cancelReq=function(){r.open({animation:!0,templateUrl:"./views/folder/Cancel-request-modal.html",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"})},e.isDisabledDate=function(e,t){return"day"===t&&(0===e.getDay()||6===e.getDay())}}function t(e,t,s,o){e.display=!1,e.detail={};var n=moment(new Date).format("YYYY-MM-DD hh:mm:ss");e.cancel=function(){t.dismiss("cancel")},e.confirm=function(){e.result=[],_.each(s,function(e){e.due_date=moment(e.due_date).format("DD-MM-YYYY")}),"recent"==e.displayOption?e.result=_.filter(s,function(e){return e.date_created<=n}):(e.detail.date_from=moment(e.detail.date_from).format("DD-MM-YYYY"),e.detail.date_to=moment(e.detail.date_to).format("DD-MM-YYYY"),e.result=_.filter(s,function(t){return t.due_date>=e.detail.date_from&&t.due_date<=e.detail.date_to})),t.close(e.result)},e.getdisplayOption=function(t){e.displayOption=t,"range"==t?e.display=!0:e.display=!1}}angular.module("tessaApp").controller("ScrollCtrl",e).controller("optionCtrl",t),e.$inject=["$scope","$rootScope","$state","$timeout","$location","$anchorScroll","$uibModal","rfqFctry","localStorageService","toastr"],t.$inject=["$scope","$uibModalInstance","complete_cards","$timeout"]}();
!function(){"use strict";function e(e,s,t,o,l,a){function n(){console.log("MAKE");var s=e.details.columns,t=e.details.rows;e.cells=c(t,s)}function c(e,s){for(var t=[[]],o=0;o<e;o++){t[o]=[],t[o]=new Array(s);for(var l=0;l<s;l++)t[o][l]=""}return t}e.deployedsite=0,e.deployedsolution=0,e.casedetails=!1,e.myStyle="table-landscape",e.orientation="Landscape",e.checkvalid2="Company Details",e.details={},e.navClass="big",e.lastScrollTop=0,e.direction="",e.tab=1,e.contactInfo=!1,e.ezefind=!1,e.ezeimpress=!1,e.screenSize=!1,e.proposalType=!1,e.secOthers=!1,e.others=!1,e.showDesign=!1,e.showPrototype=!1,e.design=!1,e.prototype=!1,e.others=!1,e.softwareImpress=!1,e.sdImpress=!1,e.stImpress=!1,e.stCustom=!1,e.siteInstall=!1,e.mdPlayer=!1,e.scMount=!1,e.ptImpress=!1,e.spImpress=!1,e.spFind=!1,e.connectivity=!1,e.content=!1,e.renders=!1,e.graphic=!1,e.solcat=!1,e.visual=!1,e.emailtemplate=!1,e.matrixConfig=!1,e.otherSec=!1,e.cells=[[]],e.sizes=[],e.details.rows=3,e.details.columns=3,e.$watch("[details.columns,details.rows]",n,!0),e.$watch("details.rows",function(e){console.log("newVal;",e)}),e.$watch("details.columns",function(e){console.log("newVal1111;",e)});var i=document.getElementsByClassName("wiz-cnt");$(i).scroll(function(){e.st=$(this).scrollTop(),e.st>e.lastScrollTop?e.navClass="small":e.navClass="big",e.lastScrollTop=e.st,e.$apply()}),n(),e.$watch("companyForm",function(s,t){console.log("newVal:",s),e.checkValid=s,console.log("$scope.checkValid:",e.checkValid)}),e.addminusValue=function(s,t){"Site"==s?"minus"==t?e.deployedsite>0?e.deployedsite--:e.deployedsite=0:e.deployedsite++:"minus"==t?e.deployedsolution>0?e.deployedsolution--:e.deployedsolution=0:e.deployedsolution++},e.selectOrientation=function(s){e.orientation=s,"Landscape"==s?e.myStyle="table-landscape":e.myStyle="table-portrait"},e.addRowsColumn=function(s){"rows"==s?e.details.rows++:e.details.columns++},e.minusRowsColumn=function(s){"rows"==s?e.details.rows>1?e.details.rows--:e.details.rows=1:e.details.columns>1?e.details.columns--:e.details.columns=1},e.contentmanage=function(s){console.log("value:",s),e.managecontent=s},e.createcont=function(s){console.log("value:",s),e.createcontent=s},e.setTab=function(s,t){if(console.log("$scope.checkValid:",e.checkValid),e.checkValid.$valid){e.casedetails=!0;var o=angular.element(document.getElementsByClassName("wiz-cnt"));e.tab=s,o.scrollTo(0,1e3)}},e.isSet=function(s){return e.tab===s},e.showProposalType=function(){e.proposalType=!0},e.setForm=function(s){console.log("value:",s),e.myform=angular.copy(s)},e.activeOption=function(){e.isActiveOption=value,"Hardware"==value},e.scrollTo=function(e){o.hash(e),t()},e.getValue=function(s){console.log(s),e.value=s},e.addRequest=function(s){console.log(s),"ezeimpress"==s?(e.ezeimpress=!0,e.testclass="blackbg",e.ezefind=!1,e.design=!1,e.others=!1,e.prototype=!1):"ezefind"==s?(e.ezeimpress=!1,e.ezefind=!0,e.testclass="blackbg",e.design=!1,e.others=!1,e.prototype=!1):"prototype"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!1,e.others=!1,e.prototype=!0,e.testclass="blackbg"):"design"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!0,e.others=!1,e.prototype=!1,e.testclass="blackbg"):"others"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!1,e.others=!0,e.prototype=!1,e.testclass="blackbg"):"renders"==s?(e.renders=!0,e.graphics=!1,e.visual=!1,e.solcat=!1,e.emailtemplate=!1,e.testclass="blackbg"):"graphics"==s?(e.renders=!1,e.graphics=!0,e.visual=!1,e.solcat=!1,e.emailtemplate=!1,e.testclass="blackbg"):"solcat"==s?(e.renders=!1,e.graphics=!1,e.visual=!1,e.solcat=!0,e.emailtemplate=!1,e.testclass="blackbg"):"visual"==s?(e.renders=!1,e.graphics=!1,e.visual=!0,e.solcat=!1,e.emailtemplate=!1,e.testclass="blackbg"):"email"==s?(e.renders=!1,e.graphics=!1,e.visual=!1,e.solcat=!1,e.emailtemplate=!0,e.testclass="blackbg"):"contact-info"==s&&(e.testclass="blackbg",e.contactInfo=!0)},e.innerForm=function(s){console.log(s),"sec-sw-impress"==s?(e.testclass="blackbg",e.softwareImpress=!0):"sec-sd-impress"==s?(e.testclass="blackbg",e.sdImpress=!0):"sec-st-impress"==s?(e.stImpress=!0,e.testclass="blackbg"):"sub-custom"==s?(e.stCustom=!0,e.testclass="blackbg"):"sec-si-impress"==s?(e.siteInstall=!0,e.testclass="blackbg"):"sec-pt-impress"==s?(e.ptImpress=!0,e.testclass="blackbg"):"sec-sp-impress"==s?(e.spImpress=!0,e.testclass="blackbg"):"sec-con-impress"==s?(e.connectivity=!0,e.testclass="blackbg"):"sec-cot-impress"==s?(e.content=!0,e.testclass="blackbg"):"sec-sp-find"==s?(e.spFind=!0,e.testclass="blackbg"):"sec-sm-find"==s?(e.scMount=!0,e.testclass="blackbg"):"sec-media-player"==s&&(e.mdPlayer=!0,e.testclass="blackbg")},e.innerShow=function(s){console.log(s),"secProposal"==s?e.proposalType=!0:"secOthers"==s?e.proposalType=!1:"matrix-config"==s?(e.matrixConfig=!0,e.screenSize=!0):"screen-size"==s?(e.screenSize=!0,e.matrixConfig=!1):"other-sec"==s&&(e.otherSec=!0)},e.hideOptions=function(){e.proposalType=!1,e.stCustom=!1,e.matrixConfig=!1,e.screenSize=!1,e.otherSec=!1},e.detail={},e.sliders=[],e.sliders.slider={value:2,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:'32"'},{value:'42"'},{value:'52"'},{value:'62"'},{value:'72"'}]}},console.log("$scope.sliders:",e.sliders),e.addScreen=function(){e.sliders.push({value:0,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:'32"'},{value:'42"'},{value:'52"'},{value:'62"'},{value:'72"'}]}}),console.log("$scope.sliders1:",e.sliders)},e.removeScreen=function(s){console.log("index:",s),e.sliders.splice(s,1)},e.enterValidation=function(){return!0},e.exitValidation=function(){return!0},e.exitValidation=function(e){return"Jacob"===e.firstName},e.exitValidation=function(){var e=$q.defer();return $timeout(function(){return e.resolve(!0)},2e3),e.promise},e.confirmation=function(){a.openConfirm({templateUrl:"templateId",scope:e,className:"ngdialog-theme-default"})}}angular.module("tessaApp").controller("WizardCtrl",e),e.$inject=["$scope","$window","$anchorScroll","$location","$document","ngDialog"]}();
