...
!function(){"use strict";function e(e,t,o,s,n,a,r,i,l,u){e.currentDate=moment(new Date).format("YYYY-MM-DD"),console.log("$scope.currentDate:",e.currentDate),e.requests=[],e.roles=[],e.samples=[],e.user=_.isEmpty(l.get("appuser"))?[]:JSON.parse(l.get("appuser")),console.log("$scope.user:",e.user);e.user.roles=[],e.isLoading=!1,e.persons=[];var c=function(){async.waterfall([function(t){e.isLoading=!0,i.getAllReqInfo().then(function(o){if(200==o.statusCode&&o.response.success){e.requests=o.response.result,console.log("$scope.requests;",e.requests);e.requests,e.requests.length;_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var o=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=o});var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,o){e.listName.toLowerCase()==o&&(e.items=t)})}),t(),e.copyrequest=angular.copy(o.response.result)}})},function(t){i.getAllPersons().then(function(o){if(200==o.statusCode&&o.response.success){var s=_.find(o.response.result,{displayName:e.user.displayName});e.user.role_name=s.type_name,e.user.final_id=s.person_id,e.user&&i.userRule({usertype:e.user.role_name}).then(function(t){200==t.statusCode&&t.response.success&&(e.roles=angular.copy(t.response.result),e.user.roles=t.response.result,e.rolesgroup=_.groupBy(e.roles,"module_name")),e.isLoading=!1}),t()}})}])};e.isClick=function(e){console.log("value:",e)},e.sortBy=function(t,o){console.log("name:",t),console.log("value:",o),console.log("$scope.filtervalue:",e.filtervalue),console.log("$scope.filtername:",e.filtername),_.isUndefined(e.copyfilterRequest)?"Ascending"==t?i.filterByField({sortbyfield:o.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var o=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=o});var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,o){e.listName.toLowerCase()==o&&(e.items=t)})})}}):i.filterByField({sortbyfield:"-"+o.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var o=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=o});var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,o){e.listName.toLowerCase()==o&&(e.items=t)})})}}):"Ascending"==t?i.filterByField({sortbyfield:o.toString(),filterbyfield:e.filtername.toString()+"="+e.filtervalue.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var o=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=o});var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,o){e.listName.toLowerCase()==o&&(e.items=t)})})}}):i.filterByField({sortbyfield:"-"+o.toString(),filterbyfield:e.filtername.toString()+"="+e.filtervalue.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var o=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=o});var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,o){e.listName.toLowerCase()==o&&(e.items=t)})})}})},e.formatString=function(e){var t=e.split("."),o=parseInt(t[0]),s=parseInt(t[1]),n=parseInt(t[2]),a=new Date(o,s-1,n);return a},e.dayDiff=function(t,o){var s=t.replace(/-/g,"."),n=o.replace(/-/g,"."),a=new Date(e.formatString(n)),r=new Date(e.formatString(s)),i=Math.abs(r.getTime()-a.getTime()),l=Math.ceil(i/864e5);return l},e.sortDisplay=function(t){var o=_.filter(e.copyrequest,function(e){return"completed"==e.status_name});o.length>0&&(e.isLoading=!0,s(function(){var t=r.open({animation:!0,templateUrl:"./views/request.dashboard/filter.modal.html",windowClass:"xd-modal",controller:"optionCtrl",resolve:{complete_cards:function(){return o}}});e.isLoading=!1,t.result.then(function(t){e.isLoading=!0,s(function(){e.requests=t,e.isLoading=!1},500)},function(){console.log("dismiss:")})},500))},e.getFilter=function(t,o){if(console.log("name:",t),console.log("value:",o),e.copyfilterRequest=[],e.filtername=t,e.filtervalue=o,_.each(e.models,function(e){e.items=[]}),"All"==t&&_.isUndefined(o)){e.filtervalue=" ",e.requests=e.copyrequest;var s=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(s,function(t,o){e.listName.toLowerCase()==o&&(e.items=t)})}),e.copyfilterRequest=angular.copy(e.requests)}else i.filterByField({filterbyfield:t.toString()+"="+o.toString()}).then(function(t){if(200==t.statusCode&&t.response.success){e.requests=angular.copy(t.response.result),_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var o=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=o});var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,o){e.listName.toLowerCase()==o&&(e.items=t)})}),e.copyfilterRequest=angular.copy(e.requests)}})},e.gotoBottom=function(){n.hash("bottom"),a()},e.models=[{id:1,listName:"to do",image:"../images/icons/rd-status-icon--03.svg",items:[],datezz:!1,pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:2,listName:"in progress",image:"../images/icons/rd-status-icon--05.svg",items:[],datezz:!0,pri:"Low",req:"Adarna",assignee:"Bangs",dragging:!1},{id:3,listName:"blocked",image:"../images/icons/rd-status-icon--06.svg",items:[],datezz:!1,pri:"High",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:5,listName:"for review",image:"../images/icons/rd-status-icon--07.svg",items:[],datezz:!1,pri:"Medium",req:"Adarna",assignee:"Bangs",dragging:!1},{id:4,listName:"completed",image:"../images/icons/rd-status-icon--08.svg",items:[],datezz:!1,pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1}],e.getSelectedItemsIncluding=function(e,t){return t.selected=!0,e.items.filter(function(e){return e.selected})},e.dragoverCallback=function(e,t,o,s){return e<10},_.each(e.models,function(e){"completed"==e.listName?(e.showupdate=!1,e.allow=["not"]):(e.showupdate=!0,e.allow=["can"])}),e.onDragstart=function(t,o){console.log("list:",t),e.sam=!0,"in progress"==t.listName?_.each(e.models,function(e){"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.place=!1,e.allow=["not"]):(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"to do"==t.listName?_.each(e.models,function(e){"for review"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"blocked"==t.listName?_.each(e.models,function(e){"to do"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):"completed"==e.listName?(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1):(_.each(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0)}):"for review"==t.listName&&(_.each(e.models,function(e){"blocked"==e.listName?(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0):"completed"==e.listName?(_.some(e.items,function(e){e.type="can"}),e.allow=["can"],e.place=!0):(_.some(e.items,function(e){e.type="not"}),e.allow=["not"],e.place=!1)}),console.log("$scope.models:",e.models)),t.dragging=!0},c(),e.isAuthorize=function(t){var o=_.find(e.user.roles,{module_item_name:t});if(!_.isUndefined(o)||!_.isNull(o))return!(!o.isAuthorized||1!=o.isAuthorized)},e.dragend=function(t,o){console.log("diri"),t.dragging=!1,_.each(e.models,function(e){e.place=!1}),e.logEvent(t,o)},console.log("$scope.models:",e.models),e.onDrop=function(t,o,n,a){_.each(e.models,function(e){e.place=!1}),a.length>1?(_.each(a,function(t){t.status_name.toLowerCase()!==n.listName.toLowerCase()?e.check=!0:e.check=!1}),e.check&&(e.isAuthorize(t)&&e.isAuthorize(n.listName.toLowerCase())?e.updateStatus(t,n,a):u.error("Anauthorize","Error"),e.isLoading=!1)):n&&_.each(a,function(o){o.status_name.toLowerCase()!==n.listName.toLowerCase()&&async.waterfall([function(t){e.isLoading=!0,t()},function(o){s(function(){e.isAuthorize(t)&&e.isAuthorize(n.listName.toLowerCase())?e.updateStatus(t,n,a):u.error("Anauthorize","Error"),e.isLoading=!1},1e3)}])})},e.logEvent=function(t,o){o.selected=!o.selected;_.each(e.models,function(e){_.some(e.items,function(e){e.request_id===o.request_id&&e.$$hashKey===o.$$hashKey||(e.selected=!1)})})},e.onMoved=function(e,t){e.items=e.items.filter(function(e){return!e.selected})};e.$watch("models",function(t){e.completecards=_.find(t,{listName:"completed"}),console.log("$scope.completecards:",e.completecards),e.modelAsJson=angular.toJson(t,!0)},!0),e.manualupdateStatus=function(t,s){var n=r.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"manualstatusUpdateCtrl",resolve:{list:function(){return e.models},item:function(){return s},user_roles:function(){return e.user},status:function(){return e.models}}});n.result.then(function(e){console.log("response: ",e),"save"==e&&o.reload()})},e.updateStatus=function(t,s,n){var a=r.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"statusUpdateCtrl",resolve:{action:function(){return t},items:function(){return n},user_roles:function(){return e.user},list:function(){return s}}});a.result.then(function(t){"save"==t?o.reload():e.isLoading=!1})},e.cancelReq=function(){r.open({animation:!0,templateUrl:"./views/folder/Cancel-request-modal.html",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"})},e.isDisabledDate=function(e,t){return"day"===t&&(0===e.getDay()||6===e.getDay())}}function t(e,t,o,s){e.display=!1,e.detail={};var n=moment(new Date).format("YYYY-MM-DD hh:mm:ss");console.log("current;",n),console.log("complete_cards:",o),e.cancel=function(){t.dismiss("cancel")},e.confirm=function(){e.result=[],console.log("$scope.displayOption:",e.displayOption),"recent"==e.displayOption?e.result=_.filter(o,function(e){return e.date_created<=n}):(e.detail.date_from=moment(e.detail.date_from).format("YYYY-MM-DD hh:mm:ss"),e.detail.date_to=moment(e.detail.date_to).format("YYYY-MM-DD hh:mm:ss"),e.result=_.filter(o,function(t){return console.log("row:",t),t.date_created>=e.detail.date_from&&t.date_created<=e.detail.date_to}),console.log("$scope.result:",e.result)),t.close(e.result)},e.getdisplayOption=function(t){e.displayOption=t,"range"==t?e.display=!0:e.display=!1}}angular.module("tessaApp").controller("ScrollCtrl",e).controller("optionCtrl",t),e.$inject=["$scope","$rootScope","$state","$timeout","$location","$anchorScroll","$uibModal","rfqFctry","localStorageService","toastr"],t.$inject=["$scope","$uibModalInstance","complete_cards","$timeout"]}();
!function(){function e(e,s,t,o,l){e.deployedsite=0,e.deployedsolution=0,e.casedetails=!1,e.checkvalid2="Company Details",e.details={},e.navClass="big",e.lastScrollTop=0,e.direction="",e.tab=1,e.contactInfo=!1,e.ezefind=!1,e.ezeimpress=!1,e.proposalType=!1,e.secOthers=!1,e.others=!1,e.showDesign=!1,e.showPrototype=!1,e.design=!1,e.prototype=!1,e.others=!1,e.softwareImpress=!1,e.sdImpress=!1,e.stImpress=!1,e.stCustom=!1,e.siteInstall=!1,e.ptImpress=!1,e.spImpress=!1,e.spFind=!1,e.connectivity=!1,e.content=!1,e.renders=!1,e.graphic=!1,e.solcat=!1,e.visual=!1,e.emailtemplate=!1,e.$watch("companyForm.$valid",function(s,t){console.log("newVal:",s),e.checkValid=s}),e.addminusValue=function(s,t){"Site"==s?"minus"==t?e.deployedsite>0?e.deployedsite--:e.deployedsite=0:e.deployedsite++:"minus"==t?e.deployedsolution>0?e.deployedsolution--:e.deployedsolution=0:e.deployedsolution++},e.setTab=function(s){e.casedetails=!0;var t=angular.element(document.getElementById("wizard-form")),o=angular.element(document.getElementById("request-review"));e.tab=s,t.scrollTo(o,0,1e3)},e.isSet=function(s){return e.tab===s},e.showProposalType=function(){e.proposalType=!0},e.setForm=function(s){console.log("value:",s),e.myform=angular.copy(s)},e.$watch("myform",function(s){console.log("newVal:",s),e.sample=s}),e.activeOption=function(){e.isActiveOption=value,"Hardware"==value},e.scrollTo=function(e){o.hash(e),t()},e.getValue=function(s){console.log(s),e.value=s},e.addRequest=function(s){console.log(s),"ezeimpress"==s?(e.ezeimpress=!0,e.testclass="blackbg",e.ezefind=!1,e.design=!1,e.others=!1,e.prototype=!1):"ezefind"==s?(e.ezeimpress=!1,e.ezefind=!0,e.testclass="blackbg",e.design=!1,e.others=!1,e.prototype=!1):"prototype"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!1,e.others=!1,e.prototype=!0,e.testclass="blackbg"):"design"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!0,e.others=!1,e.prototype=!1,e.testclass="blackbg"):"others"==s?(e.ezeimpress=!1,e.ezefind=!1,e.design=!1,e.others=!0,e.prototype=!1,e.testclass="blackbg"):"renders"==s?(e.renders=!0,e.graphics=!1,e.visual=!1,e.solcat=!1,e.emailtemplate=!1,e.testclass="blackbg"):"graphics"==s?(e.renders=!1,e.graphics=!0,e.visual=!1,e.solcat=!1,e.emailtemplate=!1,e.testclass="blackbg"):"solcat"==s?(e.renders=!1,e.graphics=!1,e.visual=!1,e.solcat=!0,e.emailtemplate=!1,e.testclass="blackbg"):"visual"==s?(e.renders=!1,e.graphics=!1,e.visual=!0,e.solcat=!1,e.emailtemplate=!1,e.testclass="blackbg"):"email"==s?(e.renders=!1,e.graphics=!1,e.visual=!1,e.solcat=!1,e.emailtemplate=!0,e.testclass="blackbg"):"contact-info"==s&&(e.testclass="blackbg",e.contactInfo=!0)},e.innerForm=function(s){console.log(s),"sec-sw-impress"==s?(e.testclass="blackbg",e.softwareImpress=!0):"sec-sd-impress"==s?(e.testclass="blackbg",e.sdImpress=!0):"sec-st-impress"==s?(e.stImpress=!0,e.testclass="blackbg"):"sub-custom"==s?(e.stCustom=!0,e.testclass="blackbg"):"sec-si-impress"==s?(e.siteInstall=!0,e.testclass="blackbg"):"sec-pt-impress"==s?(e.ptImpress=!0,e.testclass="blackbg"):"sec-sp-impress"==s?(e.spImpress=!0,e.testclass="blackbg"):"sec-con-impress"==s?(e.connectivity=!0,e.testclass="blackbg"):"sec-cot-impress"==s?(e.content=!0,e.testclass="blackbg"):"sec-sp-find"==s&&(e.spFind=!0,e.testclass="blackbg")},e.innerShow=function(s){console.log(s),"secProposal"==s?e.proposalType=!0:"secOthers"==s&&(e.proposalType=!1)},e.hideOptions=function(){e.proposalType=!1,e.stCustom=!1},e.detail={},e.slider={value:2,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:"10mm"},{value:"40mm"},{value:"50mm"},{value:"60mm"},{value:"others"}]}},e.enterValidation=function(){return!0},e.exitValidation=function(){return!0},e.exitValidation=function(e){return"Jacob"===e.firstName},e.exitValidation=function(){var e=$q.defer();return $timeout(function(){return e.resolve(!0)},2e3),e.promise};var a=document.getElementById("wizard-form");$(a).scroll(function(){e.st=$(this).scrollTop(),e.st>e.lastScrollTop?(console.log("down ni jul"),e.navClass="small"):(console.log("up ni jul"),e.navClass="big"),e.lastScrollTop=e.st,e.$apply(),console.log(e.direction)})}angular.module("tessaApp").controller("WizardCtrl",e),e.$inject=["$scope","$window","$anchorScroll","$location","$document"]}();
