...
!function(){"use strict";function e(e,s,t,n,a,o,i,r,l,u){e.requests=[],e.roles=[],e.samples=[],e.user=_.isEmpty(l.get("appuser"))?[]:JSON.parse(l.get("appuser"));e.user.roles=[],e.isLoading=!1,e.persons=[];var c=function(){async.waterfall([function(s){e.isLoading=!0,r.getAllReqInfo().then(function(t){if(200==t.statusCode&&t.response.success){e.requests=t.response.result;var n=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(n,function(s,t){e.listName.toLowerCase()==t&&(e.items=s)})}),s()}})},function(s){r.getAllPersons().then(function(t){if(200==t.statusCode&&t.response.success){var n=_.find(t.response.result,{displayName:e.user.displayName});e.user.role_name=n.type_name,e.user.final_id=n.person_id,r.userRule({usertype:"scheduler"}).then(function(t){200==t.statusCode&&t.response.success&&(e.roles=angular.copy(t.response.result),e.user.roles=t.response.result,e.rolesgroup=_.groupBy(e.roles,"module_name")),s(),e.isLoading=!1})}})}])};e.value1=!0,e.value2="YES",e.toggle=function(s){"YES"===s?e.value2="NO":e.value2="YES"},e.gotoBottom=function(){a.hash("bottom"),o()},e.models=[{id:1,listName:"to do",image:"../images/icons/rd-status-icon--03.svg",items:[],datezz:"5 days",pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:2,listName:"in progress",image:"../images/icons/rd-status-icon--05.svg",items:[],datezz:"3 days",pri:"Low",req:"Adarna",assignee:"Bangs",dragging:!1},{id:3,listName:"blocked",image:"../images/icons/rd-status-icon--06.svg",items:[],datezz:"Overdue",pri:"High",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:5,listName:"for review",image:"../images/icons/rd-status-icon--07.svg",items:[],datezz:"5 days",pri:"Medium",req:"Adarna",assignee:"Bangs",dragging:!1},{id:4,listName:"completed",image:"../images/icons/rd-status-icon--08.svg",items:[],datezz:"Completed",pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1}],e.getSelectedItemsIncluding=function(e,s){return s.selected=!0,e.items.filter(function(e){return e.selected})},e.onDragstart=function(e,s){e.dragging=!0},c(),e.isAuthorize=function(s){var t=_.find(e.user.roles,{module_item_name:s});if(!_.isUndefined(t)||!_.isNull(t))return!(!t.isAuthorized||1!=t.isAuthorized)},e.onDrop=function(s,t,a,o){o.length>1?(_.each(o,function(s){s.status_name.toLowerCase()!==a.listName.toLowerCase()?e.check=!0:e.check=!1}),e.check&&(e.isAuthorize(s)&&e.isAuthorize(a.listName.toLowerCase())?e.updateStatus(s,a,o):u.error("Anauthorize","Error"))):a&&_.each(o,function(t){t.status_name.toLowerCase()!==a.listName.toLowerCase()&&async.waterfall([function(s){e.isLoading=!0,s()},function(t){n(function(){e.isAuthorize(s)&&e.isAuthorize(a.listName.toLowerCase())?e.updateStatus(s,a,o):u.error("Anauthorize","Error")},1e3)}])})},e.logEvent=function(s,t){var n=[];e.samples.push(s),_.each(e.models,function(s){n=_.filter(s.items,{selected:!0}),_.isUndefined(n)&&(e.samples=[])}),t.selected=!t.selected,e.samples=_.uniqBy(e.samples),e.samples.length>1&&(_.each(e.samples,function(s,t){0==t&&(e.firstindex=s)}),_.each(e.models,function(s){s.listName==e.firstindex.listName&&_.some(s.items,function(e){e.selected=!1})}),e.samples.splice(0,1))},e.onMoved=function(e,s){e.items=e.items.filter(function(e){return!e.selected})};e.$watch("models",function(s){e.modelAsJson=angular.toJson(s,!0)},!0),e.manualupdateStatus=function(s,n){var a=i.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"manualstatusUpdateCtrl",resolve:{list:function(){return s},item:function(){return n},user_roles:function(){return e.user},status:function(){return e.models}}});a.result.then(function(e){console.log("response: ",e),"save"==e&&t.reload()})},e.updateStatus=function(s,n,a){var o=i.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"statusUpdateCtrl",resolve:{action:function(){return s},items:function(){return a},user_roles:function(){return e.user},list:function(){return n}}});o.result.then(function(s){"save"==s?t.reload():e.isLoading=!1})},e.cancelReq=function(){i.open({animation:!0,templateUrl:"./views/folder/Cancel-request-modal.html",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"})},e.isDisabledDate=function(e,s){return"day"===s&&(0===e.getDay()||6===e.getDay())}}angular.module("tessaApp").controller("ScrollCtrl",e),e.$inject=["$scope","$rootScope","$state","$timeout","$location","$anchorScroll","$uibModal","rfqFctry","localStorageService","toastr"]}();
!function(){"use strict";function e(e,t,s,a){console.log("CaseDetailCtrl"),e.persons=[],e.details={},e.tab=1,e.display=!1,e.requests=[],e.emojiMessage={},a.case_id&&s.getCardDetail(a.case_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result[0],e.details.request_info.date_created=moment(e.details.request_info.date_created).format("YYYY-MM-DD"),e.details.request_info.expected_delivery_date=moment(e.details.request_info.expected_delivery_date).format("YYYY-MM-DD"),console.log("$scope.details:",e.details))}),t.getAllPerson(function(t,s){200==s.statusCode&&s.response.success&&(e.persons=s.response.result)}),e.setTab=function(t){e.tab=t},e.name="sample",e.isSet=function(t){return e.tab===t},e.sam=function(){console.log("WEW")},e.newUploader=function(){var t=$uibModal.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/caseDetail-uploader.html",size:"lg",controller:"assetsUploadModalCtrl"});t.result.then(function(t){t&&e.refreshAssets()})}}angular.module("tessaApp").controller("CaseDetailCtrl",e),e.$inject=["$scope","APIFactory","rfqFctry","$stateParams"]}();
!function(){"use strict";function e(e,s,t,a,l,i,o,r,d,n,u,c,m){function f(s,t){e.index=[];var a={};return s.length>0&&(_.each(s,function(t,l){var i=n,o=_.find(i.roles,{module_item_name:r});return a.status_id=u.id,a.moved_by=i.final_id,a.request_index=0,a.remark=t.remark,a.casenumber=t.request_info.case_number,a.previousstatus=t.status_name,a.newstatus=u.listName.toLowerCase(),a.role=o.role_id,a.module=o.module_id,a.module_item=o.module_item_id,a.fullname=i.displayName,a.cardtitle=t.request_info.title,a.assignee_id=e.details.assignee_id,a.emailaddress=e.details.emailaddress,console.log("details:",a),console.log("row.request_id:",t.request_id),c.updateStatus(t.request_id,a).then(function(e){200==e.statusCode&&e.response.success?console.log("sucess"):console.log("error")}),s.splice(l,1),!1}),t-=1,f(s,t))}e.cards=[],d.length>1?e.cards=d:e.cards=d[0],e.persons=[],e.details={},c.getAllPersons().then(function(s){200==s.statusCode&&s.response.success&&(e.persons=s.response.result,console.log("$scope.persons:",e.persons))}),e.update=function(){if(d.length>1){var s=f(e.cards,e.cards.length);s||(i.success("Records Successfully Updated","Success"),t.close("save"))}else e.list=u,e.user=n,e.userRoles=_.find(e.user.roles,{module_item_name:r}),e.details.status_id=e.list.id,e.details.moved_by=e.user.final_id,e.details.request_index=0,e.details.remark=e.cards.remark,e.details.casenumber=e.cards.request_info.case_number,e.details.previousstatus=e.cards.status_name,e.details.newstatus=e.list.listName.toLowerCase(),e.details.role=e.userRoles.role_id,e.details.module=e.userRoles.module_id,e.details.module_item=e.userRoles.module_item_id,e.details.fullname=e.user.displayName,e.details.cardtitle=e.cards.request_info.title,c.updateStatus(e.cards.request_id,e.details).then(function(e){200==e.statusCode&&e.response.success?(i.success(e.response.msg,"Success"),t.close("save")):i.error(e.response.msg,"Error")})},e.getValue=function(s){e.values=s,e.details.assignee_id=s.person_id,e.details.emailaddress=s.email},e.cancel=function(){console.log("cancel"),t.close("cancel")}}function s(e,s,t,a,l,i,o,r,d,n,u,c,m){e.details={},e.list=n,e.details.moved_by=d.final_id,e.details.request_index=0,e.details.remark=r.remark,e.details.casenumber=r.request_info.case_number,e.details.previousstatus=r.status_name,e.details.fullname=d.displayName,e.details.cardtitle=r.request_info.title,u.getAllPersons().then(function(s){200==s.statusCode&&s.response.success&&(e.persons=s.response.result)}),e.getAction=function(s){console.log("value:",s),_.each(m,function(e){e.listName=e.listName.toLowerCase()});var t=_.find(m,{listName:s.toLowerCase()}),a=_.find(d.roles,{module_item_name:s.toLowerCase()});console.log("validateroles:",a),e.details.role=a.role_id,e.details.module=a.module_id,e.details.module_item=a.module_item_id,e.details.status_id=t.id,e.details.newstatus=t.listName.toLowerCase()},e.getValue=function(s){console.log("item:",s),e.details.assignee_id=s.person_id,e.details.emailaddress=s.email},e.update=function(){u.updateStatus(r.request_id,e.details).then(function(e){200==e.statusCode&&e.response.success?(i.success(e.response.msg,"Success"),t.close("save")):i.success(e.response.msg,"Error")})},e.cancel=function(){e.isLoading=!1,t.close("cancel")}}angular.module("tessaApp").controller("statusUpdateCtrl",e).controller("manualstatusUpdateCtrl",s),e.$inject=["$scope","$state","$uibModalInstance","$timeout","$stateParams","toastr","APIFactory","action","items","user_roles","list","rfqFctry","localStorageService"],s.$inject=["$scope","$state","$uibModalInstance","$timeout","$stateParams","toastr","APIFactory","item","user_roles","list","rfqFctry","localStorageService","status"]}();
var vegetables=[{id:"1",name:"Carrot"},{id:"2",name:"Potato"},{id:"3",name:"Broccoli"}];!function(){"use strict";function e(e){}angular.module("tessaApp").controller("ExperimentCtrl",e),e.$inject=["$scope"]}();
