...
!function(){"use strict";function e(e,i,o,t,c,s,n,a,r,d,l,m,v){console.log("assetsLightBoxModalCtrl: "),e.activeDevices=[],e.device={},e.mirrorFile=l,e.mirrorDevice=m,e.selectedFile=c,e.image_file=v,console.log("image_file: ",v),e.displayInstallPlugin=!1,e.displayInCompatiblePlugin=!1,s.on("pair:init",function(){}),s.on("pair:sendCode",function(i){_.find(e.activeDevices,{deviceUUID:i.deviceUUID})||e.activeDevices.push(i)}),DetectRTC.screen.getChromeExtensionStatus(function(i){"not-supported"===i?(DetectRTC.screen.chromeMediaSource="desktop",$timeout(function(){e.$apply(function(){e.displayInCompatiblePlugin=!0})},10)):"installed-enabled"!=i&&(DetectRTC.screen.chromeMediaSource="desktop",$timeout(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),e.cancelLightBox=function(){_.isEmpty(e.mirrorDevice)?s.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}):s.emit("pair:closePresent",{deviceUUID:e.mirrorDevice.deviceUUID}),_.isEmpty(e.mirrorDevice)?!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(r,{action:"close",deviceUUID:e.device.deviceUUID},function(e){}):!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(r,{action:"close",deviceUUID:e.mirrorDevice.deviceUUID},function(e){}),o.dismiss("cancel"),i.reload()},e.selectLightBoxDevice=function(i){e.device=i,console.log("$scope.device: ",e.device),e.device&&(e.device.connected=!0,"audio/mp3"==c.asset_mimetype||"audio/mp4"==c.asset_mimetype?c.asset_type="audio":"video/mp4"==c.asset_mimetype||"video/x-flv"==c.asset_mimetype||"video/x-msvideo"==c.asset_mimetype||"video/x-ms-wmv"==c.asset_mimetype||"video/quicktime"==c.asset_mimetype||"video/3gpp"==c.asset_mimetype?c.asset_type="video":c.asset_type="none",c.deviceUUID=e.device.deviceUUID,c.url=window.location.origin+window.location.pathname+"presentation.html?s="+e.device.deviceUUID,e.device.asset_file=c,!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(r,{openplugin:window.location.origin+window.location.pathname,deviceUUID:e.device.deviceUUID},function(i){console.log("response: ",i),s.emit("pair:getCode",e.device)}))}}angular.module("tessaApp").controller("assetsLightBoxModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","$sce","files","socket","$window","type","EXT_ID","$uibModal","mirrorFile","mirrorDevice","image_file"]}();
