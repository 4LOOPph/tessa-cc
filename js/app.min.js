...
!function(){"use strict";function e(e,a,t,n,r,l,o,s,c,u,i,d,m){e.seemore=!0,e.date=new Date,e.msg="hello",e.shows=!1,e.value="",l.user=n.isEmpty(c.get("User"))?[]:JSON.parse(c.get("User")),m.getItem("Cart").then(function(e){n.isNull(e)?l.cartItems=[]:l.cartItems=e}),e.seemore=!e.custom,m.getItem("allData").then(function(a){e.allproducts=a}),n.isEmpty(u.value)||(e.searchinput=u.value),e.signout=function(){i.logout().then(function(e){200==e.statusCode&&e.response.success&&(d.success(e.response.msg,"Success"),r.go("main.experience",null,{reload:!0}))})},e.clear=function(e){e?$("#searchBar").val($("#searchBar").val().slice(0,-1)):$("#searchBar").val("")},e.resetCart=function(){for(var a=e.customers.length;a--;){var t=e.customers[a];"expired"==t.status&&e.customers.splice(a,1)}},e.refreshDelay=function(t){e.search=t,e.allSearch=[],angular.isUndefined(t)||null==t||""==t?e.allSearch=[]:a.getAll(t).then(function(a){if(200==a.statusCode&&a.response.success){n.each(a.response.result.values,function(a){return"Services"==a.type?null:void e.allSearch.push(a)}),n.each(e.allSearch,function(e){"articles"==e.self&&(e.group="Experience"),"bundles"==e.self&&(e.group="Solutions"),"products"==e.self&&(e.group="Hardware")});var r=e.allSearch.slice();return t&&r.indexOf(t)===-1&&r.unshift(t),r}})},e.cartModal=function(){var a=s.open({animation:!0,templateUrl:"./views/cart.modal.html",size:"md",controller:"CartCtrl",windowClass:"xd-modal"});a.result.then(function(a){e.selected=a},function(){c.remove("Payment")})},e.openLoginModal=function(){s.open({animation:!0,templateUrl:"./views/login.modal.html",size:"xs",windowClass:"xd-modal",backdropClass:"modal-backdrop fade in"})},e.inputProductChanged=function(a){e.searchinput=a},e.sample=function(e){r.go("main.search",{value:e},{reload:!0}),document.activeElement.blur()},e.keysearch=function(){r.go("main.search",{value:e.searchinput},{reload:!0})},e.dataSelected=function(e){e&&(r.go("main.search",{value:e.originalObject},{reload:!0}),e.originalObject&&r.go("main.search",{value:e.originalObject},{reload:!0}),e.title&&r.go("main.search",{value:e.title},{reload:!0}))},e.clearInput=function(a){a?e.$broadcast("angucomplete-alt:clearInput",a):e.$broadcast("angucomplete-alt:clearInput")},e.$on("$destroy",function(a){a&&(e.searchinput="")})}angular.module("tessaApp").controller("headerCtrl",e),e.$inject=["$scope","APIFactory","$location","_","$state","$rootScope","$filter","$uibModal","localStorageService","$stateParams","AuthFactory","toastr","$localForage"]}();
