...
!function(){"use strict";function e(e,t,s,r,a,c,o,u,n,i,l){u.cartItems=[],e.attributevalues=[],e.SolutionPack=[],e.products=[],e.slides=[],e.relatedProductHardware=[],e.relatedProductSoftware=[],u.cartItems=c.isEmpty(n.get("Cart"))?[]:JSON.parse(n.get("Cart")),r.selected_id&&(async.waterfall([function(s){t.getProductDetail(r.selected_id,function(t,r){if(200==r.statusCode&&r.response.success){e.productDetails=r.response.result;var a=0;c.each(e.productDetails.product_images,function(t){e.slides.push({image:t.image_path,index:a}),a++}),s(null,r.response.result)}})},function(s,a){t.getProdCateg(r.selected_id,function(t,r){200==r.statusCode&&r.response.success&&(e.category=r.response.result,a(null,s,r.response.result))})},function(s,a,o){t.getProductBundle(function(t){200==t.statusCode&&t.response.success&&(o(null,s,a,t.response.result),c.each(t.response.result,function(t){c.each(t.products,function(s){s.product_id==r.selected_id&&e.SolutionPack.push(t)})}))})},function(s,a,c,o){t.getProductAttribute(r.selected_id,function(t,r){if(200==r.statusCode&&r.response.success){o(null,s,a,c,r.response.result),e.attributes=r.response.result,e.attributevalues=e.attributes.attribute_values;e.attributes.attribute_values}})}]),async.waterfall([function(s){t.getProduct(function(t,r){200==r.statusCode&&r.response.success&&(e.products=r.response.result,s(null,r.response.result))})},function(s,a){t.getRelatedProduct(r.selected_id,function(t,r){if(200==r.statusCode&&r.response.success){var a=r.response.result;c.each(a,function(t){c.each(s,function(e){e.p_id==t.main_id&&(t.img_default=e.img_default)}),"Hardware"==t.ref_product.product_type&&e.relatedProductHardware.push(t),"Software"==t.ref_product.product_type&&e.relatedProductSoftware.push(t)})}else i.error(r.response.msg,"Error")})}])),e.addToCart=function(t){if(t.upfront=e.productDetails.sell_price,t.quantity=1,u.cartItems.length>=0){var s=c.filter(u.cartItems,{p_id:t.p_id});s.length>0?(s[0].quantity++,c.each(u.cartItems,function(e){e.p_id==s[0].p_id&&(e.quantity=s[0].quantity)}),i.success("Quantity Added","Success"),n.set("Cart",JSON.stringify(u.cartItems))):(i.success("Successfully Added","Success"),u.cartItems.push(t),n.set("Cart",JSON.stringify(u.cartItems)))}},e.openDetail=function(e){l.go("main.productDetailsHardware",{selected_id:e},{reload:!0})},e.openShareModal=function(){if(r.selected_id){var t=o.open({animation:!0,templateUrl:"./views/share.modal.html",size:"md",windowClass:"share-modal",controller:"ShareModalInstanceCtrl",resolve:{article:function(){return{item_name:e.productDetails.item_name,img_default:e.productDetails.img_default,item_description:e.productDetails.item_description,sell_price:e.productDetails.sell_price.toFixed(2)}},param:function(){return"product"}}});t.result.then(function(){},function(){console.info("Modal dismissed at: "+new Date)})}}}function t(e,t,s){e.selected=s,e.cancel=function(){t.dismiss("cancel")}}angular.module("tessaApp").controller("hardwareDetailsCtrl",e).controller("hardwareCtrl",t),e.$inject=["$scope","APIFactory","$location","$stateParams","$filter","_","$uibModal","$rootScope","localStorageService","toastr","$state"],t.$inject=["$scope","$uibModalInstance","product"]}();
!function(){"use strict";function e(e,t,i,a,s,l,r,n,o,d){e.detail=[],e.relatedExperience=[],e.bundles=[],e.slides=[],o.selected_id&&(async.waterfall([function(e){n.getArticles(function(t){200==t.statusCode&&t.response.result&&e(null,t.response.result)})},function(t,i){n.getArticleDetail(o.selected_id,function(a){if(200==a.statusCode&&a.response.success){e.detail=a.response.result;var s=0;i(null,t,a.response.result),_.isEmpty(e.detail.mediafiles)||_.each(e.detail.mediafiles,function(e){if(e){if("video/mp4"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-flv"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-msvideo"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-ms-wmv"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/quicktime"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"}return e.index=s++}),_.each(e.detail.mediafiles,function(t){"image/png"==t.media_mimetype||"image/jpeg"==t.media_mimetype?(e.slides.push({media_mimetype:t.media_mimetype,image:t.media_path,index:s}),s++):"video/mp4"==t.media_mimetype&&(e.slides.push({media_mimetype:t.media_mimetype,image:t.media_path,url:t.url,index:s}),s++)})}})},function(e,t,i){n.getArticleTags(t.article_id,function(a){if(200==a.statusCode&&a.response.success){var s=[];_.map(a.response.result,function(e){"Article"!=e.tags&&"Portfolio"!=e.tags&&s.push(e)}),i(null,e,t,s)}})},function(t,i,a,s){var l=[],r=_.flattenDeep(_.map(t,function(e){return e.tags}));_.map(a,function(e){_.each(r,function(t){e.tags==t.tags&&l.push(t)})}),_.each(t,function(t){_.each(l,function(i){t.article_id==i.article_id&&e.relatedExperience.push(t)})});var o=_.uniq(e.relatedExperience);e.relatedExperiences=_.filter(o,function(e){return i.article_id!=e.article_id}),console.log("$scope.relatedExperiences:",e.relatedExperiences),n.getProductBundle(function(t){var a=t.response.result;i.article_features.length>0?_.each(i.article_features,function(t){var i=_.find(a,{pb_id:t.bundle_id});e.bundles.push(i)}):e.norelated="NO RELATED SOLUTIONS"})}]),e.openShareModal=function(){var t=d.open({animation:!0,templateUrl:"./views/share.modal.html",size:"md",backdrop:!1,windowClass:"sharemodal",controller:"ShareModalInstanceCtrl",resolve:{article:function(){return e.detail},param:function(){return"article"}}});t.result.then(function(){},function(){console.info("Modal dismissed at: "+new Date)})},e.select=function(e){r.hash("article_page"),t.go("main.articlePage",{selected_id:e},{reload:!0})})}angular.module("tessaApp").controller("ModalInstanceCtrl",e),e.$inject=["$scope","$state","sharerFactory","toastr","$window","$anchorScroll","$location","APIFactory","$stateParams","$uibModal"]}();
