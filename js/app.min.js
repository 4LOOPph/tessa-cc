...
!function(){"use strict";function e(e,t,n,a,s,r,l,u,i,o,c,p,d){e.seemore=!0,console.log("$state:",o),e.date=new Date,e.msg="hello",e.shows=!1,e.value="",r.user=a.isEmpty(i.get("User"))?[]:JSON.parse(i.get("User")),d.getItem("Cart").then(function(e){a.isNull(e)?r.cartItems=[]:r.cartItems=e}),e.seemore=!e.custom,a.isEmpty(o.value)||(e.searchinput=o.value,console.log("DILI isEmpty"));var h=function(){async.waterfall([function(e){t.getArticles({},function(t,n){a.each(n.response.result,function(e){e.type="Experience"}),a.each(n.response.result,function(e){e.name=e.title,e.id=e.article_id}),e(null,n.response.result)})},function(e,n){t.getProductBundle(function(t,s){a.each(s.response.result,function(e){e.type="Solutions"}),a.each(s.response.result,function(e){e.name=e.bundle_name,e.id=e.pb_id}),n(null,e,s.response.result)})},function(e,n,s){var r=[];t.getProductStatus("publish").then(function(t){r=a.filter(t.response.result,function(e){return"Hardware"==e.product_type}),a.each(r,function(e){e.type="Hardware"}),a.each(r,function(e){e.name=e.item_name,e.id=e.p_id}),s(null,e,n,r)})},function(e,n,s,r){var l=[];async.each(s,function(e,n){t.getProductAttribute(e.p_id,function(t,a){if(200==a.statusCode&&a.response.success&&e.p_id==a.response.result.p_id){var s=a.response.result.attribute_values;s&&s.length>0?e.attributes=a.response.result.attribute_values:e.attributes=null,n()}})},function(t,u){a.each(s,function(e){1==e.is_published&&0==e.is_archived&&l.push(e)}),r(null,e,n,s,l)})},function(e,t,n,s,u){var i=[];a.each(s,function(e){a.isNull(e.attributes)||i.push(e.attributes)}),i=a.flattenDeep(i),r.Brightness=l("filter")(i,{attribute:"Brightness"}),r.Bezel=l("filter")(i,{attribute:"Bezel Size"}),r.Usage=l("filter")(i,{attribute:"Usage"}),r.Brightness=a.uniqBy(r.Brightness,"value"),r.Bezel=a.uniqBy(r.Bezel,"value"),r.Usage=a.uniqBy(r.Usage,"value");var o=[];a.each(s,function(e){1==e.is_published&&0==e.is_archived&&o.push(e)}),a.each(t,function(e){1==e.is_published&&0==e.is_archived&&o.push(e)}),a.each(e,function(e){1==e.is_active&&o.push(e)}),u(null,s,t,e),r.allproducts=angular.copy(o)}])};h(),e.signout=function(){c.logout().then(function(e){200==e.statusCode&&e.response.success&&(p.success(e.response.msg,"Success"),s.go("main.experience",null,{reload:!0}))})},e.clear=function(e){e?$("#searchBar").val($("#searchBar").val().slice(0,-1)):$("#searchBar").val("")},e.resetCart=function(){for(var t=e.customers.length;t--;){var n=e.customers[t];"expired"==n.status&&e.customers.splice(t,1)}},e.refreshDelay=function(n){e.search=n,e.allSearch=[],angular.isUndefined(n)||null==n||""==n?e.allSearch=[]:t.getAll(n).then(function(t){if(200==t.statusCode&&t.response.success){a.each(t.response.result.values,function(t){return"Services"==t.type?null:void e.allSearch.push(t)}),a.each(e.allSearch,function(e){"articles"==e.self&&(e.group="Experience"),"bundles"==e.self&&(e.group="Solutions"),"products"==e.self&&(e.group="Hardware")});var s=e.allSearch.slice();return n&&s.indexOf(n)===-1&&s.unshift(n),s}})},e.cartModal=function(){var t=u.open({animation:!0,templateUrl:"./views/cart.modal.html",size:"md",controller:"CartCtrl",windowClass:"xd-modal"});t.result.then(function(t){e.selected=t},function(){i.remove("Payment")})},e.openLoginModal=function(){u.open({animation:!0,templateUrl:"./views/login.modal.html",size:"xs",windowClass:"xd-modal",backdropClass:"modal-backdrop fade in"})},e.inputProductChanged=function(t){e.searchinput=t},e.sample=function(e){s.go("main.search",{value:e},{reload:!0}),document.activeElement.blur()},e.keysearch=function(){s.go("main.search",{value:e.searchinput},{reload:!0})},e.dataSelected=function(e){e&&(s.go("main.search",{value:e.originalObject},{reload:!0}),e.originalObject&&s.go("main.search",{value:e.originalObject},{reload:!0}),e.title&&s.go("main.search",{value:e.title},{reload:!0}))},e.clearInput=function(t){t?e.$broadcast("angucomplete-alt:clearInput",t):e.$broadcast("angucomplete-alt:clearInput")},e.$on("$destroy",function(t){t&&(e.searchinput="")})}angular.module("tessaApp").controller("headerCtrl",e),e.$inject=["$scope","APIFactory","$location","_","$state","$rootScope","$filter","$uibModal","localStorageService","$stateParams","AuthFactory","toastr","$localForage"]}();
