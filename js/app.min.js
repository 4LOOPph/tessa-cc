...
!function(){"use strict";function e(e,t,s,n,o,r,a,i,l,u){e.currentDate=moment(new Date).format("YYYY-MM-DD"),console.log("$scope.currentDate:",e.currentDate),e.requests=[],e.roles=[],e.samples=[],e.user=_.isEmpty(l.get("appuser"))?[]:JSON.parse(l.get("appuser"));e.user.roles=[],e.isLoading=!1,e.persons=[];var c=function(){async.waterfall([function(t){e.isLoading=!0,i.getAllReqInfo().then(function(s){if(200==s.statusCode&&s.response.success){e.requests=s.response.result,e.copyrequest=angular.copy(s.response.result),console.log("$scope.requests:",e.requests);e.requests,e.requests.length;_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var n=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(n,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})}),t()}})},function(t){i.getAllPersons().then(function(s){if(200==s.statusCode&&s.response.success){var n=_.find(s.response.result,{displayName:e.user.displayName});e.user.role_name=n.type_name,e.user.final_id=n.person_id,i.userRule({usertype:"scheduler"}).then(function(s){200==s.statusCode&&s.response.success&&(e.roles=angular.copy(s.response.result),e.user.roles=s.response.result,e.rolesgroup=_.groupBy(e.roles,"module_name")),t(),e.isLoading=!1})}})}])};e.isClick=function(e){console.log("value:",e)},e.sortBy=function(t){var s=_.filter(e.copyrequest,function(e){return"completed"!==e.status_name});if("Ascending"==t)var n=_.orderBy(s,["request_info.title"],["asc"]);else var n=_.orderBy(s,["request_info.title"],["desc"]);e.requests=n,_.each(e.requests,function(e){"completed"==e.status_name?e.drag=!0:e.drag=!1,e.request_info.expected_delivery_date=moment(e.request_info.expected_delivery_date).format("YYYY-MM-DD"),e.request_info.due_date=moment(e.request_info.due_date).format("YYYY-MM-DD")}),_.map(e.requests,function(t){var s=e.dayDiff(t.request_info.due_date,e.currentDate);t.current=s});var o=_.groupBy(e.requests,"status_name");_.each(e.models,function(e){_.map(o,function(t,s){e.listName.toLowerCase()==s&&(e.items=t)})})},e.formatString=function(e){var t=e.split("."),s=parseInt(t[0]),n=parseInt(t[1]),o=parseInt(t[2]),r=new Date(s,n-1,o);return r},e.dayDiff=function(t,s){var n=t.replace(/-/g,"."),o=s.replace(/-/g,"."),r=new Date(e.formatString(o)),a=new Date(e.formatString(n)),i=Math.abs(a.getTime()-r.getTime()),l=Math.ceil(i/864e5);return l},e.value1=!0,e.value2="YES",e.sortDisplay=function(e){var t=a.open({animation:!0,templateUrl:"./views/request.dashboard/filter.modal.html",windowClass:"xd-modal",controller:"optionCtrl"});t.result.then(function(e){console.log("response: ",e),"save"==e&&s.reload()})},e.getFilter=function(t,s){"Requestor"==t?i.filterByField({filterbyfield:"requester ="+s.toString()}).then(function(t){200==t.statusCode&&t.response.success&&(e.requests=t.response.result)}):"Priority"==t?i.filterByField({filterbyfield:"priority_id ="+s.toString()}).then(function(t){200==t.statusCode&&t.response.success&&(e.requests=t.response.result)}):"Request"==t?i.filterByField({filterbyfield:"request_type_id ="+s.toString()}).then(function(t){200==t.statusCode&&t.response.success&&(e.requests=t.response.result)}):"Assignee"==t?i.filterByField({filterbyfield:"scheduler ="+s.toString()}).then(function(t){200==t.statusCode&&t.response.success&&(e.requests=t.response.result)}):e.requests=e.copyrequest},e.gotoBottom=function(){o.hash("bottom"),r()},e.models=[{id:1,listName:"to do",image:"../images/icons/rd-status-icon--03.svg",items:[],datezz:!1,pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:2,listName:"in progress",image:"../images/icons/rd-status-icon--05.svg",items:[],datezz:!0,pri:"Low",req:"Adarna",assignee:"Bangs",dragging:!1},{id:3,listName:"blocked",image:"../images/icons/rd-status-icon--06.svg",items:[],datezz:!1,pri:"High",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1},{id:5,listName:"for review",image:"../images/icons/rd-status-icon--07.svg",items:[],datezz:!1,pri:"Medium",req:"Adarna",assignee:"Bangs",dragging:!1},{id:4,listName:"completed",image:"../images/icons/rd-status-icon--08.svg",items:[],datezz:!1,pri:"Critical",req:"Bangs Garcia",assignee:"Ellen Adarna",dragging:!1}],e.getSelectedItemsIncluding=function(e,t){return t.selected=!0,e.items.filter(function(e){return e.selected})},e.dragoverCallback=function(e,t,s,n){return e<10},_.each(e.models,function(e){"completed"==e.listName?e.allow=["not"]:e.allow=["can"]}),e.onDragstart=function(t,s){console.log("list:",t),console.log("$scope.models:",e.models),e.sam=!0,"in progress"==t.listName&&_.each(e.models,function(e){"to do"==e.listName?(_.each(e.items,function(e){e.type="can"}),e.allowed=["can"],e.place=!0):"blocked"==e.listName?(_.each(e.items,function(e){e.type="can"}),e.allowed=["can"],e.place=!0):"for review"==e.listName?(_.each(e.items,function(e){e.type="can"}),e.allowed=["can"],e.place=!0):"in progress"==e.listName?(_.each(e.items,function(e){e.type="can"}),e.allowed=["can"],e.place=!0):(_.each(e.items,function(e){e.type="not"}),e.place=!1,e.allowed=["not"])}),t.dragging=!0},c(),e.isAuthorize=function(t){var s=_.find(e.user.roles,{module_item_name:t});if(!_.isUndefined(s)||!_.isNull(s))return!(!s.isAuthorized||1!=s.isAuthorized)},console.log("$scope.models:",e.models),e.dragend=function(t){console.log("diri"),t.dragging=!1,_.each(e.models,function(e){e.place=!1})},e.onDrop=function(t,s,o,r){_.each(e.models,function(e){e.place=!1}),console.log("items;",r),console.log("list;",o),r.length>1?(_.each(r,function(t){t.status_name.toLowerCase()!==o.listName.toLowerCase()?e.check=!0:e.check=!1}),e.check&&(e.isAuthorize(t)&&e.isAuthorize(o.listName.toLowerCase())?e.updateStatus(t,o,r):u.error("Anauthorize","Error"))):o&&_.each(r,function(s){s.status_name.toLowerCase()!==o.listName.toLowerCase()&&async.waterfall([function(t){e.isLoading=!0,t()},function(s){n(function(){e.isAuthorize(t)&&e.isAuthorize(o.listName.toLowerCase())?e.updateStatus(t,o,r):u.error("Anauthorize","Error")},1e3)}])})},e.logEvent=function(t,s){console.log("list:",t),console.log("item:",s),s.selected=!s.selected;_.each(e.models,function(e){_.some(e.items,function(e){e.request_id===s.request_id&&e.$$hashKey===s.$$hashKey||(e.selected=!1)})})},e.onMoved=function(e,t){e.items=e.items.filter(function(e){return!e.selected})};e.$watch("models",function(t){e.modelAsJson=angular.toJson(t,!0)},!0),e.manualupdateStatus=function(t,n){var o=a.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"manualstatusUpdateCtrl",resolve:{list:function(){return t},item:function(){return n},user_roles:function(){return e.user},status:function(){return e.models}}});o.result.then(function(e){console.log("response: ",e),"save"==e&&s.reload()})},e.updateStatus=function(t,n,o){var r=a.open({animation:!0,templateUrl:"./views/folder/Update-Status-modal.html",windowClass:"xd-modal",controller:"statusUpdateCtrl",resolve:{action:function(){return t},items:function(){return o},user_roles:function(){return e.user},list:function(){return n}}});r.result.then(function(t){"save"==t?s.reload():e.isLoading=!1})},e.cancelReq=function(){a.open({animation:!0,templateUrl:"./views/folder/Cancel-request-modal.html",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"})},e.isDisabledDate=function(e,t){return"day"===t&&(0===e.getDay()||6===e.getDay())}}function t(e,t){console.log("optionCtrl"),e.display=!1,e.$watch("myDate",function(e){console.log("newValue:",e)}),e.cancel=function(){t.dismiss("cancel")},e.getdisplayOption=function(t){console.log("value:",t),"range"==t?e.display=!0:e.display=!1}}angular.module("tessaApp").controller("ScrollCtrl",e).controller("optionCtrl",t),e.$inject=["$scope","$rootScope","$state","$timeout","$location","$anchorScroll","$uibModal","rfqFctry","localStorageService","toastr"],t.$inject=["$scope","$uibModalInstance"]}();
...
!function(){"use strict";function e(e,s,t,a,o,l,i,r,n,d,u,c,m){function f(s,t){e.index=[];var a={};return s.length>0&&(_.each(s,function(t,o){var l=d,i=_.find(l.roles,{module_item_name:r});return a.status_id=u.id,a.moved_by=l.final_id,a.request_index=0,a.remark=t.remark,a.casenumber=t.request_info.case_number,a.previousstatus=t.status_name,a.newstatus=u.listName.toLowerCase(),a.role=i.role_id,a.module=i.module_id,a.module_item=i.module_item_id,a.fullname=l.displayName,a.cardtitle=t.request_info.title,a.assignee_id=e.details.assignee_id,a.emailaddress=e.details.emailaddress,console.log("details:",a),console.log("row.request_id:",t.request_id),c.updateStatus(t.request_id,a).then(function(e){200==e.statusCode&&e.response.success?console.log("sucess"):console.log("error")}),s.splice(o,1),!1}),t-=1,f(s,t))}e.cards=[],n.length>1?e.cards=n:e.cards=n[0],e.persons=[],e.details={},e.comment={},c.getAllPersons().then(function(s){200==s.statusCode&&s.response.success&&(e.persons=s.response.result,console.log("$scope.persons:",e.persons))}),e.update=function(){if(n.length>1){var s=f(e.cards,e.cards.length);s||(l.success("Records Successfully Updated","Success"),t.close("save"))}else e.list=u,e.user=d,e.userRoles=_.find(e.user.roles,{module_item_name:r}),e.details.status_id=e.list.id,e.details.moved_by=e.user.final_id,e.details.request_index=0,e.details.remark=e.cards.remark,e.details.casenumber=e.cards.request_info.case_number,e.details.previousstatus=e.cards.status_name,e.details.newstatus=e.list.listName.toLowerCase(),e.details.role=e.userRoles.role_id,e.details.module=e.userRoles.module_id,e.details.module_item=e.userRoles.module_item_id,e.details.fullname=e.user.displayName,e.details.cardtitle=e.cards.request_info.title,async.waterfall([function(s){c.updateStatus(e.cards.request_id,e.details).then(function(e){console.log("data:",e),200==e.statusCode&&e.response.success?s():l.error(e.response.msg,"Error")})},function(s){e.comment.comment_body=e.details.comment_body,e.comment.commentor=e.user.displayName,e.comment.role=e.userRoles.role_id,e.comment.module=e.userRoles.module_id,e.comment.module_item=e.userRoles.module_item_id,e.comment.cardtitle=e.cards.request_info.title,c.makeComment(e.cards.request_id,e.user.final_id,e.comment).then(function(e){console.log("datas:",e),200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),t.close("save")):l.error(e.response.msg,"Error")})}])},e.getValue=function(s){e.values=s,e.details.assignee_id=s.person_id,e.details.emailaddress=s.email},e.cancel=function(){console.log("cancel"),t.close("cancel")}}function s(e,s,t,a,o,l,i,r,n,d,u,c,m){e.details={},e.list=d,e.details.moved_by=n.final_id,e.details.request_index=0,e.details.remark=r.remark,e.details.casenumber=r.request_info.case_number,e.details.previousstatus=r.status_name,e.details.fullname=n.displayName,e.details.cardtitle=r.request_info.title,u.getAllPersons().then(function(s){200==s.statusCode&&s.response.success&&(e.persons=s.response.result)}),e.getAction=function(s){console.log("value:",s),_.each(m,function(e){e.listName=e.listName.toLowerCase()});var t=_.find(m,{listName:s.toLowerCase()}),a=_.find(n.roles,{module_item_name:s.toLowerCase()});console.log("validateroles:",a),e.details.role=a.role_id,e.details.module=a.module_id,e.details.module_item=a.module_item_id,e.details.status_id=t.id,e.details.newstatus=t.listName.toLowerCase()},e.getValue=function(s){console.log("item:",s),e.details.assignee_id=s.person_id,e.details.emailaddress=s.email},e.update=function(){u.updateStatus(r.request_id,e.details).then(function(e){200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),t.close("save")):l.success(e.response.msg,"Error")})},e.cancel=function(){e.isLoading=!1,t.close("cancel")}}angular.module("tessaApp").controller("statusUpdateCtrl",e).controller("manualstatusUpdateCtrl",s),e.$inject=["$scope","$state","$uibModalInstance","$timeout","$stateParams","toastr","APIFactory","action","items","user_roles","list","rfqFctry","localStorageService"],s.$inject=["$scope","$state","$uibModalInstance","$timeout","$stateParams","toastr","APIFactory","item","user_roles","list","rfqFctry","localStorageService","status"]}();
!function(){"use strict";function o(o,e,n,l,s){o.companies=[],s.getCompany(function(e,n){o.companies=n.response.result,console.log("$scope.companies:",o.companies)}),angular.element(e).bind("scroll",function(){o.st=window.pageYOffset,o.st>o.lastScrollTop?(console.log("down ni jul"),o.navClass="small"):(console.log("up ni jul"),o.navClass="big"),o.lastScrollTop=o.st,o.$apply(),console.log(o.direction)}),o.navClass="big",o.lastScrollTop=0,o.direction="",o.tab=1,o.companyInfo=!1,o.isDisplay=!1,o.ezefind=!1,o.ezeimpress=!1,o.proposalType=!1,o.showProposalType=function(){o.proposalType=!0},o.setTab=function(e){o.tab=e},o.isSet=function(e){return o.tab===e},o.getValue=function(e){console.log(e),o.value=e},o.scrollTo=function(e){"contact-info"==e&&(o.isDisplay=!0),l.hash(e),n()},o.addRequest=function(e){console.log(e),"swFind"==e?(o.ezeimpress=!1,o.ezefind=!0):"rdImpress"==e&&(o.ezeimpress=!0,o.ezefind=!1),l.hash(e),n()},o.detail={},o.slider={value:2,options:{floor:0,showTicks:!0,showSelectionBar:!0,showTicksValues:!0,stepsArray:[{value:"10mm"},{value:"40mm"},{value:"50mm"},{value:"60mm"},{value:"others"}]}},o.enterValidation=function(){return!0},o.exitValidation=function(){return!0},o.exitValidation=function(o){return"Jacob"===o.firstName},o.exitValidation=function(){var o=$q.defer();return $timeout(function(){return o.resolve(!0)},2e3),o.promise},angular.element(e).bind("scroll",function(){o.st=window.pageYOffset,o.st>o.lastScrollTop?(console.log("down ni jul"),o.navClass="small"):(console.log("up ni jul"),o.navClass="big"),o.lastScrollTop=o.st,o.$apply(),console.log(o.direction)})}angular.module("tessaApp").controller("ExperimentCtrl",o),o.$inject=["$scope","$window","$anchorScroll","$location","APIFactory"]}();
!function(){"use strict";var r=function(r){return function(t,n){return r.uniqBy(t,function(r){return r[n]})}},t=function(){return function(r,t){for(var n="test",e=0;e<r.length;e++);return n}};angular.module("tessaApp").filter("duplicates",["_",r]).filter("count",[t]).filter("ellipsis",function(){return function(r,t,n,e){if(!r)return"";if(n=parseInt(n,10),!n)return r;if(r.length<=n)return r;if(r=r.substr(0,n),t){var u=r.lastIndexOf(" ");u!=-1&&("."!=r.charAt(u-1)&&","!=r.charAt(u-1)||(u-=1),r=r.substr(0,u))}return r+(e||" …")}}).filter("propsFilter",function(){return function(r,t){var n=[];return angular.isArray(r)?r.forEach(function(r){for(var e=!1,u=Object.keys(t),i=0;i<u.length;i++){var f=u[i],o=t[f].toLowerCase();if(r[f].toString().toLowerCase().indexOf(o)!==-1){e=!0;break}}e&&n.push(r)}):n=r,n}}).filter("urlFilter",function(r){return function(t){return r.trustAsResourceUrl(t)}})}();
